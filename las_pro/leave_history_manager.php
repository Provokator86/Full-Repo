...
$sql= 'SELECT * FROM leave_history WHERE i_manager_id="'. $_SESSION['user_id'].'"';
/*$condition	=	'';
if(isset($_POST['search']))
{
	if($_POST['year']>0)
	{
		$condition.=	' AND DATE_FORMAT(d_from,"%Y")="'.$_POST['year'].'"';
	}
	
	if($_POST['month']>0)
	{
		$condition.=	' AND DATE_FORMAT(d_from,"%m")="'.$_POST['month'].'"';
	}
}
