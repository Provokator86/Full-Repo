...
{
?>
<div class="cafe_details" id="div_user_business_list">
    <div class="cafe_left">
        <h2><a href="<?=base_url().'business/'.$v['id'].'/'.str_replace(' ','_',$v['name'])?>" style="color:#FA8717"><?=$v['name']?></a></h2>
...
<div class="paging_ajax">
    <table border="0" cellspacing="0" cellpadding="0" style=" margin:auto;" width="10%">
        <tr>
            ...
            {
            ?>
            <a onclick='autoload_ajax("<?=base_url().'profile/user_uploaded_business'?>","div_user_business_list",<?=$jsnArr?>,"business_page","<?=($business_page-1)?>");' style="cursor:pointer;">
