...
<div class="sign_up">
   ...
   custom_theme_widget: 'div_recaptcha'
    ...
    <h1><?=$user_merchant_registration_page_text[0]['title']?></h1>
    <div class="margin15"></div>
    <?php /*?><h2><?=$user_merchant_registration_page_text[0]['title']?></h2><?php */?>
    <div class="margin15"></div>
     <?=html_entity_decode($user_merchant_registration_page_text[0]['description'])?>
   ...
   <!-- <h3>take some time and fill out the form below</h3>-->
    ...
    <div class="signup_right">
         ...
         <div class="margin15"></div>
         <fb:login-button v="2"  onlogin="facebook_marchant_onlogin();" length="long" ><fb:intl>Login with Facebook</fb:intl></fb:login-button>-->
    </div>
    <div class="clear"></div>
</div>
...
/*
	...
	function facebook_marchant_onlogin() {
	 ...
	 function permissionHandler()
	   {	
			//document.location.href=document.location.href;
			document.location.href = base_url + 'user/facebook_regular_user_signup/4';
	   }
