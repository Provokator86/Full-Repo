...
$(document).ready(function() {
  show_red(<?php echo $review_data[0]['star_rating']; ?>);
  fix_pointer(<?php echo $review_data[0]['star_rating']; ?>);
});
</script>
<div class="edit_details">
    ...
    <h1>Update review for <?=$review_data[0]['name']?></h1>
    ...
    <div class="margin15"></div>
    <h5>take some time and Update the form below </h5>
    <div class="margin15"></div>
    <?
    $this->load->view('admin/common/message_page.tpl.php');
    ?>
    <form action="<?=base_url().'business/save_review_update/'.$review_id?>" method="post" name="frm_review" id="frm_review" enctype="multipart/form-data" onsubmit="ck_submit();return false;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td align="right" width="180">Review Title</td>
                <td><input type="text" id="review_title" name="review_title" value="<?=$review_data[0]['review_title']?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><textarea id="comment" name="comment" ><?=$review_data[0]['comment']?></textarea></td>
            </tr>
            <!--<tr>
