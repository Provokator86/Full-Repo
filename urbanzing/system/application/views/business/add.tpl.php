<div class="edit_details">
    <h1><?=$business_add_page_text[0]['title']?></h1>
    <div class="margin15"></div>
    <div class="margin15"></div>
   <?=html_entity_decode($business_add_page_text[0]['description'])?>
    <div class="margin15"></div>
   <!-- <h5>take some time and fill out the form below </h5>-->
    ...
    <div class="margin15"></div>
    <form action="<?=base_url().'business/save_business'?>" method="post" name="frm_business" id="frm_business" enctype="multipart/form-data">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td><input id="name" name="name" type="text" value="<?=$old_values['name']?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input id="address" name="address" type="text" value="<?=$old_values['address']?>"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><span style="font-size: 10px;">If you do not know the pincode of this business please choose 000000 from the pincode dropdown.</span>
                    <div id="div_zipcode">
            ...
            <tr>
                ...
                <td><input id="land_mark" name="land_mark" type="text" value="<?=$old_values['land_mark']?>"/></td>
            </tr>
            <tr>
                <td align="right">Phone Number <span>*</span></td>
                <td><input id="phone_number" name="phone_number" type="text" value="<?=$old_values['phone_number']?>"/></td>
            </tr>
            <tr>
                <td align="right">Website URL</td>
                <td><input id="website" name="website" type="text" value="<?=$old_values['website']?>"/></td>
            </tr>
            <tr>
                <td align="right">Contact Person</td>
                <td><input id="contact_person" name="contact_person" type="text" value="<?=$old_values['contact_person']?>"/></td>
            </tr>
            <tr>
                <td align="right">Contact Email</td>
                <td><input id="contact_email" name="contact_email" type="text" value="<?=$old_values['contact_email']?>"/></td>
            </tr>
            <tr class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
            ...
            <tr>
				...
				<!--style="display: <?=($old_values['business_category']==1)?'block':'none'?>; "-->
                    <div id="div_cuisine" class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="right" valign="top" width="155" >Cuisine</td>
                                <td><select id="cuisine_id" name="cuisine_id[]" style="height:80px; margin:0px;" multiple="multiple" size="10">
                                    <?=$cuisine_option?>
                                </select></td>
                            </tr>
                        </table>
            ...
            <tr>
                <td align="left" valign="top" width="100%" colspan="2">
                    <div id="div_other_cuisine" class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="right" width="155">Other Cuisine</td>
                                <td>
                                    <input id="other_cuisine" name="other_cuisine" type="text" value="<?=$old_values['other_cuisine']?>"/>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input id="hour_comment" name="hour_comment" type="text" value="<?=$old_values['hour_comment']?>"/>
            ...
            <tr>
                ...
                <td><input type="text" id="tags" name="tags" value="<?=$old_values['tags']?>" /></td>
            </tr>
            <tr>
                <td  height="30" align="right">Do you accept Credit Cards? </td>
                <td>
                    <input type="radio" id="credit_card" name="credit_card" <?=($old_values['credit_card']=='1')?' checked ':''?> value="1" /> Yes
                    <input type="radio" id="credit_card" name="credit_card" <?=($old_values['credit_card']=='0')?' checked ':''?> value="0"/> No
                </td>
            </tr>
            <tr class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                <td  height="30" align="right">Do you deliver? </td>
                <td>
                    <input type="radio" id="delivery" name="delivery" <?=($old_values['delivery']=='1')?' checked ':''?> value="1" /> Yes
                    <input type="radio" id="delivery" name="delivery" <?=($old_values['delivery']=='0')?' checked ':''?> value="0"/> No </td>
            </tr>
            <tr class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                <td  height="30" align="right">Do you serve Vegetarian?  </td>
                <td>
                    <input type="radio" id="vegetarian" name="vegetarian" <?=($old_values['vegetarian']=='1')?' checked ':''?> value="1" /> Yes
                    <input type="radio" id="vegetarian" name="vegetarian" <?=($old_values['vegetarian']=='0')?' checked ':''?> value="0"  /> No </td>
            </tr>
            <tr>
                <td  height="30" align="right">Parking available?  </td>
                <td><input type="radio" id="parking" name="parking" <?=($old_values['parking']=='1')?' checked ':''?> value="1" /> Yes
                    <input type="radio" id="parking" name="parking" <?=($old_values['parking']=='0')?' checked ':''?> value="0"/> No </td>
            </tr>
            <tr class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                <td  height="30" align="right">Do you take reservations?  </td>
                <td><input type="radio" id="take_reservation" name="take_reservation" <?=($old_values['take_reservation']=='1')?' checked ':''?> value="1" /> Yes
                    <input id="take_reservation" name="take_reservation" value="0" <?=($old_values['take_reservation']=='0')?' checked ':''?> type="radio" /> No </td>
            </tr>
            <tr>
                <td  height="30" align="right">Air Conditioned?   </td>
                <td><input type="radio" id="air_conditioned" name="air_conditioned" <?=($old_values['air_conditioned']=='1')?' checked ':''?> value="1" /> Yes
                    <input id="air_conditioned" name="air_conditioned" <?=($old_values['air_conditioned']=='0')?' checked ':''?> value="0" type="radio" /> No </td>
            </tr>
            <tr class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                <td  height="30" align="right">Do you serve alcohol?</td>
                <td><input type="radio" id="serving_alcohol" name="serving_alcohol" <?=($old_values['serving_alcohol']=='1')?' checked ':''?> value="1" /> Yes
                    <input id="serving_alcohol" name="serving_alcohol" value="0" <?=($old_values['serving_alcohol']=='0')?' checked ':''?> type="radio" /> No </td>
            </tr>
            <tr>
                <td align="left" valign="top" width="100%" colspan="2">
                    <div id="div_menu" class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                <td  align="right" width="155">Upload Menu</td>
                                <td align="left">
									<table  width="100%" border="0" cellspacing="0" cellpadding="0"> 
									<tr>
										<td>
            ...
            <tr>
                ...
                <td style="padding-top:10px;"><input class="button_02" type="submit" value="Submit >>" /> &nbsp;&nbsp;
                    <input class="button_02" type="button" value="Reset >>" onclick="window.location.href='<?=base_url().'business/reset_business'?>'" /></td>
            </tr>
        </table>
        <script type="text/javascript">
            function fun_business_category(cat)
            {
                ...
                if((cat*1)==1)
                {
                    /*document.getElementById('div_other_cuisine').style.display   = 'block';
                    document.getElementById('div_cuisine').style.display   = 'block';
