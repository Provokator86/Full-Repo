<div class="edit_details">
    <h1><?=$content_text[0]['title']?> <div class="back_btn"><a href="<?=base_url().'profile'?>">Back</a></div></h1>
    ...
    <div class="margin15"></div>
    <form action="<?=base_url().'business/save_business_edit'?>" method="post" name="frm_business" id="frm_business" enctype="multipart/form-data">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td align="left" valign="top" width="100%" colspan="2">
                    <div id="div_cuisine" class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="right" valign="top" width="115">Cuisine</td>
            ...
            <tr>
                <td align="left" valign="top" width="100%" colspan="2">
                    <div id="div_other_cuisine" class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="right" width="115">Other Cuisine</td>
                                <td>
                                    <input id="other_cuisine" name="other_cuisine" type="text" value="<?=$data['other_cuisine']?>"/>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <tr>
                ...
                <td><span style="font-size: 10px;">e.g. Closed on Sunday, Closed from 2:30pm to 5:30pm everyday</span><br/>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="radio" id="credit_card" name="credit_card" <?=($data['credit_card']!=1)?' checked ':''?> value="0"/> No
                </td>
            </tr>
            <tr class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                ...
                <td>
                    ...
                    <input type="radio" id="delivery" name="delivery" <?=($data['delivery']!=1)?' checked ':''?> value="0"/> No </td>
            </tr>
            <tr class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                ...
                <td>
                    ...
                    <input type="radio" id="vegetarian" name="vegetarian" <?=($data['vegetarian']!=1)?' checked ':''?> value="0"  /> No </td>
            </tr>
            <tr>
                ...
                <td><input type="radio" id="parking" name="parking" <?=($data['parking']==1)?' checked ':''?> value="1" /> Yes
                    <input type="radio" id="parking" name="parking" <?=($data['parking']!=1)?' checked ':''?> value="0"/> No </td>
            </tr>
            <tr class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                ...
                <td><input type="radio" id="take_reservation" name="take_reservation" <?=($data['take_reservation']==1)?' checked ':''?> value="1" /> Yes
                    <input id="take_reservation" name="take_reservation" value="0" <?=($data['take_reservation']!=1)?' checked ':''?> type="radio" /> No </td>
            </tr>
            <tr>
                ...
                <td><input type="radio" id="air_conditioned" name="air_conditioned" <?=($data['air_conditioned']==1)?' checked ':''?> value="1" /> Yes
                    <input id="air_conditioned" name="air_conditioned" <?=($data['air_conditioned']!=1)?' checked ':''?> value="0" type="radio" /> No </td>
            </tr>
            <tr class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                ...
                <td><input type="radio" id="serving_alcohol" name="serving_alcohol" <?=($data['serving_alcohol']==1)?' checked ':''?> value="1" /> Yes
                    <input id="serving_alcohol" name="serving_alcohol" value="0" <?=($data['serving_alcohol']!=1)?' checked ':''?> type="radio" /> No </td>
            </tr>
            <tr>
                <td align="left" valign="top" width="100%" colspan="2">
                    <div id="div_menu" class="show_area" style="display:<?=($data['business_category']==1)?'':'none'?>;">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                <td  align="right" width="115">Upload Menu</td>
                                <td>
            ...
            <tr>
                ...
                <td><span style="font-size: 10px;"></span><br />
            ...
            <tr>
                ...
                <td style="padding-top:10px;">
                    ...
                    <input class="button_02" type="button" value="Reset >>" onclick="window.location.href='<?=base_url().'business/reset_business_edit/'.$data['id']?>'" /></td>
            </tr>
        </table>
