...
<div class="left_cell">
	...
	<?php if($business_category == 1) { ?>
		...
		?>
			...
			<?=($search_session_value['menu']==1) ? 'Yes':'No'?><a style='cursor:pointer;' onclick="business_search_remove_session(<?=$search_session_value['menu']?> , 'menu');">
			<img src='<?=base_url()?>images/front/small_close.png'></a></li>
		<?php } else {?>
			<li style="background:none;"><a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax','div_search_business_list','menu=1');">Yes</a> | <a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax', 'div_search_business_list', 'menu=0');">No</a></li>
			<?php } ?>
		</ul>
		...
		<?php
			if(isset($search_session_value['credit_card']) && $search_session_value['credit_card']!='')
			{
		?>
			<li style="background:none;">
			<?=($search_session_value['credit_card']==1) ? 'Yes':'No'?><a style='cursor:pointer;' onclick="business_search_remove_session(<?=$search_session_value['credit_card']?> , 'credit_card');">
			<img src='<?=base_url()?>images/front/small_close.png'></a></li>
		<?php } else {?>	
		<li style="background:none;"><a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax','div_search_business_list','credit_card=1');">Yes</a> | <a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax', 'div_search_business_list', 'credit_card=0');">No</a></li>
		...
		?>
			<li style="background:none;">
			<?=($search_session_value['air_conditioned']==1) ? 'Yes':'No'?><a style='cursor:pointer;' onclick="business_search_remove_session(<?=$search_session_value['air_conditioned']?> , 'air_conditioned');">
			<img src='<?=base_url()?>images/front/small_close.png'></a></li>
		<?php } else {?>		
			<li style="background:none;"><a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax','div_search_business_list','air_conditioned=1');">Yes</a> | <a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax', 'div_search_business_list', 'air_conditioned=0');">No</a></li>
			<?php } ?>
		</ul>
		...
		?>
			<li style="background:none;">
			<?=($search_session_value['vegetarian']==1) ? 'Yes':'No'?><a style='cursor:pointer;' onclick="business_search_remove_session(<?=$search_session_value['vegetarian']?> , 'vegetarian');">
			<img src='<?=base_url()?>images/front/small_close.png'></a></li>
		<?php } else {?>
		
			<li style="background:none;"><a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax','div_search_business_list','vegetarian=1');">Yes</a> | <a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax', 'div_search_business_list', 'vegetarian=0');">No</a></li>
				<?php } ?>
		</ul>
		<?php } ?>
		...
		?>
			<li style="background:none;">
			<?=($search_session_value['take_reservation']==1) ? 'Yes':'No'?><a style='cursor:pointer;' onclick="business_search_remove_session(<?=$search_session_value['take_reservation']?> , 'take_reservation');">
			<img src='<?=base_url()?>images/front/small_close.png'></a></li>
		<?php } else {?>
			<li style="background:none;"><a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax','div_search_business_list','take_reservation=1');">Yes</a> | <a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax', 'div_search_business_list', 'take_reservation=0');">No</a></li>
			<?php } ?>
		</ul>
		<?php } ?>
		...
		?>
			<li style="background:none;">
			<?=($search_session_value['parking']==1) ? 'Yes':'No'?><a style='cursor:pointer;' onclick="business_search_remove_session(<?=$search_session_value['parking']?> , 'parking');">
			<img src='<?=base_url()?>images/front/small_close.png' alt=''></a></li>
		<?php } else {?>
			<li style="background:none;"><a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax','div_search_business_list','parking=1');">Yes</a> | <a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax', 'div_search_business_list', 'parking=0');">No</a></li>
			<?php } ?>
			
		</ul>
		
		<?php if($business_category == 1) { ?>
		<h3>Alcohol Served</h3>
		<ul>
		<?php
		...
		?>
			<li style="background:none;">
			<?=($search_session_value['alcohol']==1) ? 'Yes':'No'?><a style='cursor:pointer;' onclick="business_search_remove_session(<?=$search_session_value['alcohol']?> , 'alcohol');">
			<img src='<?=base_url()?>images/front/small_close.png' alt=''></a></li>
		<?php } else {?>
			<li style="background:none;"><a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax','div_search_business_list','alcohol=1');">Yes</a> | <a style='cursor:pointer;' onclick="autoload_ajax_no_jsn('<?=base_url()?>search/search_business_list_ajax', 'div_search_business_list', 'alcohol=0');">No</a></li>
			<?php } ?>
