<div class="right_cell">
	...
	<div class="club_result"<?php echo $bgstyle?>>
		...
		<div class="cell_06">
			...
			<?php if($v['business_category'] == 1 && (isset($v['price_from']) && $v['price_from']!='')) { ?>
	...
	<div class="paging">
		<table border="0" cellspacing="0" cellpadding="0" style=" margin:auto;" width="50%">
			<tr>
				...
				<td align="center"  valign="top">
					<strong><?=($page+1)?> / <?=ceil($rows[0]['tot_row'] / $toshow)?></strong>
				</td>
				<td align="center" width="10%">
		...
		<tr>
			...
			<td>
			<select style="width:45px;" name="pageNo" id="pageNo" onchange="changePageNo();">
