...
<div class="archieve">
                        ...
                        <tr>
                            <td align="left" style="padding-top:5px;">
                                <table width="30%" cellpadding="3" cellspacing="0" border="0">
                                    <tr>
                                        <td>
                                            <h4 class="archieve_header">Archive List </h4>
                                        </td>
                                    </tr>
                                </table>
								...
								<thead>
                                    <tr>
                                       <th  class="td_tab_main">Date</th>  
										<th class="td_tab_main">Feature Title</th>
						   ...
						   echo "</pre>";*/
                            ...
                            ?>
                                    <tr bgcolor="#e6e6e6">
                                      ...
                                      <td  class="columnDataGrey"><a href="<?=base_url()?>archive/show/<?=$value['id']?>/<?=$value['url']?>" target="_blank" style="text-decoration:underline;color:#0000FF"> <?=$value['title']?></a></td>
			...
			{
			 	window.location=base_url + 'archive/index/' + val;
