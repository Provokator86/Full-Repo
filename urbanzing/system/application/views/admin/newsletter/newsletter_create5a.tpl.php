							...
							<table width="100%">
								<tr>
									<td align="left" style="padding-top:10px;">
										<form name="frm" action="<?=base_url().'admin/newsletter/newsletter_create5a'.$nid?>" method="post" enctype="multipart/form-data">
											...
											<table width="90%" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" style="border-collapse :collapse" align="center">
												<tr>
													<td class="text1" height="30" bgcolor="#cccccc" align="left" style="color:#000000;"><strong>Manage Newsletter</strong></td>
													...
													<td colspan="2"align="left" valign="top">
														<table width="100%" cellpadding="0" cellspacing="0">
															...
															<tr>
																...
																<td width="96%" class="text1" style="padding-left:20px;"><a href="javascript:MM_openWindow('<?=base_url()?>admin/newsletter/newletter_campaign_preview', 'newsletter', 'scrollbars=yes,width=770,height=700,resizable=yes,toolbar=no');"><img src="<?=base_url()?>images/admin/previewMyCampaign.gif" border="0" /></a></td>
															</tr>
															<tr>
																<td colspan="2" align="left" class="text1" style="color:#000000;">The majority of web-based email clients such as Gmail, Hotmail and Yahoo! as well as Outlook Express 6.0, Outlook 2000-2003 and updated versions of Outlook 98 will strip out your JavaScript content automatically and disable any active scripting contained in the newsletter. A security warning may also be displayed, potentially damaging your relationship with the recipient.<br />
																<br /> <br /></td>
															</tr>
															<tr align="left">
																<td colspan="2">&nbsp;</td>
																	...
																	<table width="100%" border="0" cellspacing="20" cellpadding="0">
																		<tr>
																			...
																			<td align="left" width="50%">
																				<input type="submit" name="Btnnext" value="Next" class="button"/>
																			</td>
																		</tr>
																	</table>
																</td>
