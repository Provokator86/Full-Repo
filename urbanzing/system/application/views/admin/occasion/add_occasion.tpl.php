			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						<td align="center" valign="middle">
                            <form id="frm_admin_occasion" name="frm_admin_occasion" method="post" action="<?=base_url().'admin/occasion/insert_occasion'?>" enctype="multipart/form-data">
                            ...
                            <tr>
                              ...
                              <td align="left" valign="middle"><input id="occasion" name="occasion" type="text" class="textfield" style="width:200px;" value="" /></td>
                            </tr>
                            <tr>
                              <td align="right" valign="middle" class="field_title"><strong>Image:</strong></td>
                              <td align="left" valign="middle"><input type="file" name="img_name"></td>
                            </tr>
							  <tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
							  <tr>
                                ...
                                <td align="left" valign="middle"><input name="reset1" type="reset" class="button" value="Back" onclick="window.location.href='<?=base_url().'admin/occasion'?>';" /></td>
							  </tr>
							</table>
