			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						<td align="center" valign="middle">
                            <form id="frm_admin_cuisine" name="frm_admin_cuisine" method="post" action="<?=base_url().'admin/cuisine/update_cuisine'?>">
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
                            <tr>
                              <td width="140" align="right" valign="middle" class="field_title"><span style="color:#8B0000;">*</span>&nbsp;<strong>Cuisine  : </strong></td>
                              <td align="left" valign="middle"><input id="cuisine" name="cuisine" type="text" class="textfield" style="width:200px;" value="<?=$cuisine[0]['cuisine']?>" /></td>
                            </tr>
							  <tr>
							    <td align="right" valign="middle" class="field_title"><strong>Status :</strong></td>
							    <td align="left" valign="middle">
								
								<input type="radio" name="status" id="status" value="1" <?=($cuisine[0]['status']==1)?'checked':''?> />Active
								<input type="radio" name="status" id="status" value="0" <?=($cuisine[0]['status']==0)?'checked':''?>/>Inactive								</td>
						      </tr>
							</table>
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
							  <tr>
								...
								<input type="hidden" name="id" value="<?=$cuisine[0]['id']?>">
