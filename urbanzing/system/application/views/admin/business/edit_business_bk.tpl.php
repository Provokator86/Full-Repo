			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						...
						<div class="edit_details">
							...
							<input type="hidden" name="counter_menu_image" id="counter_menu_image"/>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="radio" id="credit_card" name="credit_card" <?=($data['credit_card']!=1)?' checked ':''?> value="0"/> No                </td>
            </tr>
            <tr  class="open_area"  style="display: <?=($data['business_category']==1)?'':'none'?>;">
			...
			<?php
				if($data['business_category']==1 && $data['is_featured']=='Y'){
			?>
            <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							?>
									<div style="display: block; margin-top: 5px;" id="menu_view_image_container_<?php echo $val['id']; ?>">
										...
										<img onclick="delete_menu_image('<?php echo $val['id']; ?>', 'menu_view_image_container_<?php echo $val['id']; ?>');" src="<?php echo base_url().'images/admin/trash.gif'; ?>" alt="Delete" style="cursor:pointer;" />
									</div>
							<?php
								}
							?>
            ...
            <?
              ...
              <tr>
                    <td>&nbsp;</td>
                    <td>
                        <img src="<?=base_url()?>images/uploaded/business/thumb/<?=$data['cover_image']?>" alt="" />
                        <input type="hidden" name="cover_image" id="cover_image" value="<?=$data['cover_image']?>"/>                    </td>
              </tr>
              <?
              }
              ?>
            <tr>
                ...
                <td style="padding-top:10px;">
                    ...
                    <input class="button_02" type="button" value="<< Back" onclick="window.location.href='<?=$redirect_url?>'" />					</td>
            </tr>
        </table>
...
/*                document.getElementById('div_other_cuisine').style.display   = 'none';
			...
			function delete_menu_image(id, container_name) {
				get_ajax_option_common('<?php echo base_url().'business/delete_menu_image';?>', id, container_name);
