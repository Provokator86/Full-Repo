                                ...
                                <table width="98%" style="border: 1px solid rgb(153, 153, 153);" cellpadding="3" cellspacing="0" >
                                    <tr>
                                        <td  class="td_tab_main" align="center" style="padding-left:0px;">
                                            <a style="color:#FFFFFF;font-weight:<?=($order_name=='m_name')?'bold':'normal'?>;" href="<?=base_url().'admin/message/outbox/m_name/'.(($order_name=='m_name' && $order_type=='asc')?'desc':'asc').'/'.$page ?> ">
                                            Name</a>
                                        </td>
                                        
                                        <td class="td_tab_main" align="center" style="padding-left:0px;">
                                            <a style="color:#FFFFFF;font-weight:<?=($order_name=='m_item_type')?'bold':'normal'?>;" href="<?=base_url().'admin/message/outbox/m_item_type/'.(($order_name=='m_item_type' && $order_type=='asc')?'desc':'asc').'/'.$page ?> ">
                                            Type</a>
                                        </td>
                                        <td class="td_tab_main" align="center" style="padding-left:0px;">
                                            <a style="color:#FFFFFF;font-weight:<?=($order_name=='m_date')?'bold':'normal'?>;" href="<?=base_url().'admin/message/outbox/m_date/'.(($order_name=='m_date' && $order_type=='asc')?'desc':'asc').'/'.$page ?> ">
                                            Date</a>
                                        </td>
