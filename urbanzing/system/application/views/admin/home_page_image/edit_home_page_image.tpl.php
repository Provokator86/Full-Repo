	...
	<tr>
      <td align="left" valign="middle" bgcolor="#FFFFFF" style="border:1px dotted #999999;" height="100%">
			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						<td align="center" valign="middle">
                            <form id="frm_admin_home_page_image" name="frm_admin_home_page_image" method="post" action="<?=base_url().'admin/home_page_image/update_home_page_image'?>" enctype="multipart/form-data">
							...
							<?php
							if($home_page_image[0]['img_name']){
							?>
                            <tr>
                              <td align="right" valign="middle" class="field_title">&nbsp;</td>
                              <td align="left" valign="middle">
							  <img src="<?=base_url().'images/uploaded/business/thumb/'.$home_page_image[0]['img_name']?>"> </td>
                            </tr>
							<?php } ?>
							<tr>
                              <td align="right" valign="middle" class="field_title"><span style="color:#8B0000;">*</span>&nbsp;<strong>Description  : </strong></td>
                              <td align="left" valign="middle"><textarea name="description" id="description" style="height:100px; width:300px;"><?=$home_page_image[0]['description']?></textarea></td>
                            </tr>
							<tr>
							  ...
							  <tr>
								...
								<input type="radio" name="status" id="status" value="1" <?=($home_page_image[0]['status']==1)?'checked':''?> />Active
								<input type="radio" name="status" id="status" value="0" <?=($home_page_image[0]['status']==0)?'checked':''?>/>Inactive								</td>
						      </tr>
							</table>
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
							  <tr>
								...
								<input type="hidden" name="id" value="<?=$home_page_image[0]['id']?>">
		...
		<script type="text/javascript">
			function ck_page()
			{
				var cntrlArr    = new Array('description');
				var cntrlMsg    = new Array('Enter home page image description');
