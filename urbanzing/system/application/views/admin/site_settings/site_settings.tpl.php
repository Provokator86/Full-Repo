                                ...
                                <td align="center" valign="middle">
                                    <form id="frm_admin_site_settings" name="frm_admin_site_settings" method="post" action="<?=base_url().'admin/site_settings/update_site_settings'?>" onsubmit="return change_admin_id_validate()">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="7">
                                            <tr>
                                                <td width="150" align="right" valign="middle" class="field_title"><strong>Max image file size : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Site name : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Site moto : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Admin email : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Paypal email : </strong></td>
                                            ...
                                            <!--<tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Paypal Currency : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Default language : </strong></td>
                                                <td align="left" valign="middle">
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Admin page limit : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="top" class="field_title"><strong>Default Currency : </strong></td>
                                                <td align="left" valign="middle">
                                             ...
                                             <tr>
                                                <td align="right" valign="top" class="field_title"><strong>Registration charge : </strong></td>
                                                <td align="left" valign="middle">
                                             ...
                                             <tr>
                                                <td align="right" valign="top" class="field_title"><strong>Conversion rate : </strong></td>
                                                <td align="left" valign="middle">
                                             ...
                                             <tr>
                                                <td align="right" valign="top" class="field_title"><strong>Paypal charge : </strong></td>
                                                <td align="left" valign="middle">
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Mail from name : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Mail from email : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Mail replay name : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Mail replay email : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>Mail Protocol : </strong></td>
                                                <td align="left" valign="middle">
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>SMTP Host : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>SMTP User : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>SMTP Password : </strong></td>
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>SMS Gateway Username : </strong></td>
                                                <td align="left" valign="middle"><input id="sms_gateway_username" name="sms_gateway_username" type="text" class="textfield" style="width:375px;" value="<?=(isset($site_settings[0]['sms_gateway_username']))?$site_settings[0]['sms_gateway_username']:''?>" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>SMS Gateway Password : </strong></td>
                                                <td align="left" valign="middle"><input id="sms_gateway_password" name="sms_gateway_password" type="text" class="textfield" style="width:375px;" value="<?=(isset($site_settings[0]['sms_gateway_password']))?$site_settings[0]['sms_gateway_password']:''?>" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right" valign="middle" class="field_title"><strong>SMS Gateway Sender ID : </strong></td>
                                                <td align="left" valign="middle"><input id="sms_gateway_senderid" name="sms_gateway_senderid" type="text" class="textfield" style="width:375px;" value="<?=(isset($site_settings[0]['sms_gateway_senderid']))?$site_settings[0]['sms_gateway_senderid']:''?>" /></td>
                                            </tr>
                                        </table>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="7">
                                            <tr>
