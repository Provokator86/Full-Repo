...
<table id="tbl_content_area" width="100%" border="0" cellspacing="0" cellpadding="5">
							...
							<table>
							    <tr>
									<td align="right" style="padding-right:50px;">
									   <input type="button" onclick="javascript:window.location='<?=base_url()?>admin/archive/save_to_archive'" value="Save  to archive">
                                ...
                                <table width="98%" style="border: 1px solid rgb(153, 153, 153);" cellpadding="3" cellspacing="0" >
                                    <tr>
                                       <td  class="td_tab_main" align="center" style="padding-left:0px;">Date</td>  
										<td class="td_tab_main" align="center" style="padding-left:0px;">Feature Title</td>
                            ...
                            ?>
                                    <tr>
                                       ...
                                       <td align="center" class="columnDataGrey"> <?=$value['title']?></td>
										...
										<td align="center" class="columnDataGrey"><a href="<?=base_url()?>archive/show/<?=$value['id']?>/<?=$value['url']?>" target="_blank"> show</a></td>
										<td align="center" class="columnDataGrey"><a href="<?=base_url()?>admin/archive/delete_archive/<?=$value['id']?>"> delete</a></td>
	...
	<tr><td height="1px;"></td></tr>
  	...
  	<script type="text/javascript">
			...
			{
			 	window.location=base_url + 'admin/archive/index/' + val;
