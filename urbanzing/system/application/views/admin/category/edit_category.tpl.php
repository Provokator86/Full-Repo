			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						<td align="center" valign="middle">
                            <form id="frm_category" name="frm_category" method="post" action="<?=base_url().'admin/category/update_category'?>">
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
								...
								<td align="left" valign="middle">
                                    <select style="width: 200px;" id="item_type" name="item_type" onchange='call_ajax_combo_change("<?=base_url().'admin/category/ajax_change_parent_event'?>",this.value,"div_parent");'>
							  ...
							  <tr>
								...
								<td align="left" valign="middle"><input id="name" name="name" type="text" class="textfield" style="width:200px;" value="<?=$category[0]['name']?>" /></td>
							  </tr>
							  <tr>
                            ...
                            <script type="text/javascript">
                                function ck_page()
                                {
                                    ...
                                    var cntrlMsg    = new Array('Please give Business type');
