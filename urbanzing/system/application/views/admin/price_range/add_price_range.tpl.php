			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						<td align="center" valign="middle">
                            <form id="frm_admin_price_range" name="frm_admin_price_range" method="post" action="<?=base_url().'admin/price_range/insert_price_range'?>">
                            ...
                            <tr>
							  ...
							  <input id="price_from" name="price_from" type="text" class="textfield" style="width:200px;" value=""  onKeyPress="return isNumberKey(event)"/></td>
                            </tr>
                            <tr>
                              <td align="right" valign="middle" class="field_title"><span style="color:#8B0000;">*</span>&nbsp;<strong>Price To  :</strong></td>
                              <td align="left" valign="middle"><input id="price_to" name="price_to" type="text" class="textfield" style="width:200px;" value="" onKeyPress="return isNumberKey(event)"/></td>
                            </tr>
                            <tr>
