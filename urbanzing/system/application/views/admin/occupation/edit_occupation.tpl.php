			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						<td align="center" valign="middle">
                            <form id="frm_admin_occupation" name="frm_admin_occupation" method="post" action="<?=base_url().'admin/occupation/update_occupation'?>">
                            ...
                            <tr>
                              ...
                              <td align="left" valign="middle"><input id="occupation" name="occupation" type="text" class="textfield" style="width:200px;" value="<?=$occupation[0]['occupation']?>" /></td>
                            </tr>
							  <tr>
							    <td align="right" valign="middle" class="field_title"><strong>Status :</strong></td>
							    <td align="left" valign="middle">
								
								<input type="radio" name="status" id="status" value="1" <?=($occupation[0]['status']==1)?'checked':''?> />Active
								<input type="radio" name="status" id="status" value="0" <?=($occupation[0]['status']==0)?'checked':''?>/>Inactive								</td>
						      </tr>
							</table>
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
							  <tr>
								...
								<input type="hidden" name="id" value="<?=$occupation[0]['id']?>">
