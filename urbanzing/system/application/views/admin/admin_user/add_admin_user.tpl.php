			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						<td align="center" valign="middle">
                            <form id="frm_admin_user" name="frm_admin_user" method="post" action="<?=base_url().'admin/admin_user/insert_admin_user'?>" onsubmit="return change_admin_id_validate()">
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
							  ...
							  <tr>
								...
								<td align="left" valign="middle"><input id="email" name="email" type="text" class="textfield" style="width:200px;" value="" /></td>
							  </tr>
                                                        <tr>
								<td width="140" align="right" valign="middle" class="field_title"><span style="color:#8B0000;">*</span>&nbsp;<strong>User name : </strong></td>
								<td align="left" valign="middle"><input id="username" name="username" type="text" class="textfield" style="width:200px;" value="" /></td>
							  </tr>
							  <tr>
								<td width="140" align="right" valign="middle" class="field_title"><span style="color:#8B0000;">*</span>&nbsp;<strong>Password : </strong></td>
                            ...
                            <script type="text/javascript">
                                function ck_page()
                                {
                                    var cntrlArr    = new Array('name','email','username','password','cpassword');
                                    var cntrlMsg    = new Array('Please give the admin name','Please give admin email address','Please give the admin user ID','Please give the admin password','Please rewrite admin password');
                                    if(ck_blank(cntrlArr,cntrlMsg)==true)
                                    {
                                        ...
                                        if(validateEmail(cntrlArr,cntrlMsg)==true)
                                        {
                                            ...
                                            cntrlMsg    = new Array('Two password does not match');
