			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						<td align="center" valign="middle">
                            <form id="frm_article" name="frm_article" method="post" action="<?=base_url().'admin/article/insert_article'?>" enctype="multipart/form-data">
                            ...
                            <tr>
                              ...
                              <tr>
								...
								<td align="left" valign="middle"><input id="title" name="title" type="text" class="textfield" style="width:200px;" value="" /></td>
							  </tr>
                            <tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
							  <tr>
                                ...
                                <td align="left" valign="middle"><input name="reset1" type="reset" class="button" value="Back" onclick="window.location.href='<?=base_url().'admin/article'?>';" /></td>
							  </tr>
							</table>
