      ...
      <td align="left" valign="middle" bgcolor="#FFFFFF" style="border:1px dotted #999999;" height="100%">
			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						<td align="center" valign="middle">
                            <form id="frm_admin_user_type" name="frm_admin_user_type" method="post" action="<?=base_url().'admin/user_type/insert_user_type'?>">
                            ...
                            <tr>
                              ...
                              <td align="left" valign="middle"><input id="user_type" name="user_type" type="text" class="textfield" style="width:200px;" value="" /></td>
                            </tr>
							  <!--<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
							  <tr>
                                ...
                                <td align="left" valign="middle"><input name="reset1" type="reset" class="button" value="Back" onclick="window.location.href='<?=base_url().'admin/user_type'?>';" /></td>
							  </tr>
							</table>
		<script type="text/javascript">
			function ck_page()
			{
				...
				var cntrlMsg    = new Array('Enter user type');
