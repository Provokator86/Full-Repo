			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						<td align="center" valign="middle">
                            <form id="frm_category" name="frm_category" method="post" action="<?=base_url().'admin/deal_category/insert_category'?>" >
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
							  <tr>
                                ...
                                <td align="left" valign="middle"><input name="reset1" type="reset" class="button" value="Back" onclick="window.location.href='<?=base_url().'admin/deal_category'?>';" /></td>
							  </tr>
							</table>
