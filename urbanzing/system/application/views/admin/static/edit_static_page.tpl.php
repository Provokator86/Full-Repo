			    ...
			    <table width="90%" border="0" cellspacing="0" cellpadding="10" style="border:1px solid #999999;">
					  <tr>
						<td align="center" valign="middle">
                            <form id="frm_article" name="frm_article" method="post" action="<?=base_url().'admin/static_page/edit_static_page'?>/<?=$id?>" enctype="multipart/form-data">
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
                           
                              <tr>
								<td width="140" align="right" valign="middle" class="field_title"><strong> Page Title : </strong></td>
								<td align="left" valign="middle"><input id="page_title" name="page_title" type="text" class="textfield" style="width:250px;" value="<?php echo $result['page_title']; ?>" />
								<br /><?php echo form_error('page_title'); ?></td>
							  </tr>
							  
                              <tr>
								<td width="140" align="right" valign="middle" class="field_title"><strong>  Title : </strong></td>
								<td align="left" valign="middle"><input id="title" name="title" type="text" class="textfield" style="width:250px;" value="<?php echo $result['title']; ?>" /><br /><?php echo form_error('title'); ?></td></td>
							  </tr>
							  <tr>
								<td width="140" align="right" valign="middle" class="field_title"><strong>  url : </strong></td>
								<td align="left" valign="middle">
								<input id="url" name="url" type="text" class="textfield" style="width:250px;" value="<?php echo $result['url']; ?>" />
								...
								<td align="left" valign="middle"><input id="meta_keywords" name="meta_keywords" type="text" class="textfield" style="width:250px;" value="<?php echo $result['meta_keywords']; ?>" /><br /><?php echo form_error('meta_keywords'); ?></td></td>
							  </tr>
							     <tr>
								<td width="140" align="right" valign="middle" class="field_title"><strong>  Meta Descriptions : </strong></td>
								<td align="left" valign="middle"><input id="meta_description" name="meta_description" type="text" class="textfield" style="width:250px;" value="<?php echo $result['meta_description']; ?>"/><br /><?php echo form_error('meta_description'); ?></td></td>
							  </tr>
                            <tr>
								<td width="140" align="right" valign="top" class="field_title"><strong>Page Content : </strong></td>
								<td align="left" valign="middle">
                                    <textarea id="page_content" name="page_content" cols="10" rows="20" value=""><?php echo html_entity_decode($result['page_content']); ?></textarea>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="7">
							  <tr>
								...
								<td width="80" align="left" valign="middle">
								    <input type="hidden" name="chk_submit" value="1" />
