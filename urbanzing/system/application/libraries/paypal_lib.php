...
class Paypal_lib {
	...
	var $return_field	= array('mc_gross','protection_eligibility','address_status','payer_id','tax','address_street','payment_date','payment_status','charset','address_zip','first_name','address_country_code','address_name','notify_version','custom','payer_status','business','address_country','address_city','quantity','payer_email','verify_sign','txn_id','payment_type','last_name','address_state','receiver_email','pending_reason','txn_type','item_name','mc_currency','item_number','residence_country','test_ipn','transaction_subject','handling_amount','payment_gross','shipping');
