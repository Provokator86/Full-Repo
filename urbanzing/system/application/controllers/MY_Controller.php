...
class MY_Controller extends Controller
{
	...
	public function __construct()
	{
		...
		$this->add_css(array('style', 'jquery.tabs', 'jquery.tabs-ie', 'thickbox','autocomplete'));
		$this->add_js(array('jquery-latest', 'jquery.history_remote.pack', 'jquery.tabs.pack', 'thickbox', 'jquery.form','jquery.autocomplete'));
		...
		//$this->data['fb_post_user'] = $fb_user;
		 ...
		 $this->data['FACEBOOKLOGIN'] = $fb_user ;
	}
