...
$tinybrowser['path']['image'] = '/images/uploaded/cms/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
//$tinybrowser['path']['media'] = '/project/useruploads/media/'; // Media files location
//$tinybrowser['path']['file']  = '/project/useruploads/files/'; // Other files location
