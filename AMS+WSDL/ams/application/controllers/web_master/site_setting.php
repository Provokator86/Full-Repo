...
class Site_setting extends MY_Controller implements InfController
{
    ...
    public function __construct()
    {
        ...
        try
        {
          parent::__construct();
          //Define Errors Here//
          $this->data['title']=addslashes(t("Site Setting"));//Browser Title
    ...
    public function index()
    {
        ...
        {
            $this->data['title']	=	addslashes(t("Site Setting"));//Browser Title
            $this->data['heading']	=	addslashes(t("Site Setting"));
    ...
    public function modify_information($i_id=0)
    {
        try
        {
            ...
            if($_POST)
            {
                ...
                $posted = $_POST;	         
                //pr($posted,1);
                $this->form_validation->set_rules('s_admin_email',addslashes(t('admin email')),'trim|required|valid_email');  				 
