...
$(document).ready(function(){    
    ...
    $("#frm_add_edit").submit(function(){
		...
		if(form_price=="")
		{
			markAsError($("#d_form_price"),'<?php echo addslashes(t("Please provide form price"))?>');
			b_valid=false;
		}
		else
		{
			if(priceReg.test(form_price)==false)
			{
				markAsError($("#d_form_price"),'<?php echo addslashes(t("Please enter valid integer or decimal number with 2 decimal places."))?>');
				b_valid=false;
			}
		}     
                ...
                <form role="form" id="frm_add_edit" name="frm_add_edit" action="" method="post" autocomplete="off"  enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">   
                            ...
                            <div class="col-md-5 ">
                                <div class="form-group">
                                    <label for="focusedInput">Form Price<span class="text-danger">*</span></label><br/>
                                    <input class="form-control" id="d_form_price" name="d_form_price" value="<?php echo $posted["d_form_price"];?>" type="text" />
                                    <span class="text-danger"></span>
                                </div>
                            </div>  
