...
File Name: category show_list.tpl.php 
Created By: ACS Dev 
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
						        <label class=""><?php echo addslashes(t("Parent Category"))?></label>
						        <select name="i_parent_id" id="i_parent_id" class="form-control" data-rel="chosen">
                                    <option value="">Select Category</option>
                                    <?php 
                                        echo makeOptionParentCategory('',$i_parent_id) ;
                                    ?>
                                </select>
					        </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class=""><?php echo addslashes(t("Sub Category"))?></label>
                                <input type="text" name="s_category" id="s_category" value="<?php echo $s_category?>" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
