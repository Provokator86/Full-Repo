            ...
            <div class="box-body">
                ...
                <form class="" id="frm_search_2" name="frm_search_2" method="get" action="" >
                    ...
                    <!--<div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
								<label for="focusedInput">Form ID</label>
								<select name="i_form_id" id="i_form_id" class="form-control" data-rel="chosen">
									<option value="">Select</option>
									<?php echo makeOptionFormsMaster($i_form_id);   ?>
								</select>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="btn_dwnld" name="btn_dwnld" class="btn btn-info"><?php echo addslashes(t("Download XML File"))?></button>
                    </div>
                </form>
            </div>   
        </div>
