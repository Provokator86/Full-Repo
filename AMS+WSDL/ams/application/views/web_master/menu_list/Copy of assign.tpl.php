...
<!--<link href="<?php echo r_path('css/custom_navigation/jquery-ui-1.8.21.custom.css')?>" rel="stylesheet" type="text/css">-->
<style type="text/css">
                              ...
                              <div class="projectRt rtcustom ui-widget-content">
                                    ...
                                    <div class="formfield clearfix">    
                                     ...
                                     <div class="rtcustom_header">
                                        <div class="rtcustom_header_lt"><h3><?php echo 'menu_name';?> : <?php echo $s_name;?></h3></div>
                                    ...
                                    <div class="rtcustom_header">
                                        <div class="rtcustom_header_lt"><h3><?php echo 'menu_name';?> : <?php echo $s_name;?></h3></div>
                                        <div class="rtcustom_header_rt"><button type="button" name="btn_save_cms_2" class="btn btn-primary btn_save_cms"><?php echo  addslashes("Save Menu")?></div>
                                    </div>                               
