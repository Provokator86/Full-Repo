<?php 
/***
File Name: customers show_list.tpl.php 
Created By: SWI Dev 
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
								...
								<input type="text" class="form-control" id="s_email" name="s_email" value="<?php echo $s_email;?>" />
                            </div>
                        </div>   
                        ...
                        <div class="col-md-3">     
                            <div class="form-group">
                                ...
                                <input type="text" name="s_company_name" id="s_company_name" value="<?php echo $s_company_name?>" class="form-control" />
                            </div>                       
                        </div>
                    </div>
<!--
