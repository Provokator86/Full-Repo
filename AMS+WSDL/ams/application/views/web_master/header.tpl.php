...
<!-- Sparkline -->
<script src="<?php echo r_path('js/jquery.sparkline.min.js')?>" type="text/javascript"></script>
<!-- jvectormap -->
<script src="<?php echo r_path('js/jquery-jvectormap-1.2.2.min.js')?>" type="text/javascript"></script>
<script src="<?php echo r_path('js/jquery-jvectormap-world-mill-en.js')?>" type="text/javascript"></script>
<!-- SlimScroll 1.3.0 -->
<script src="<?php echo r_path('js/jquery.slimscroll.min.js')?>" type="text/javascript"></script>
<!-- ChartJS 1.0.1 -->
<script src="<?php echo r_path('js/Chart.min.js')?>" type="text/javascript"></script>
