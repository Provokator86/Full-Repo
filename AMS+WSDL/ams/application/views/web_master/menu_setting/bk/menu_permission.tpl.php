...
<link type="text/css" href="<?php echo r_path('js/plugins/tagedit/css/jquery.tagedit.css')?>" rel="StyleSheet"  media="all"/>
<script type="text/javascript" src="<?php echo r_path('js/plugins/tagedit/jquery.autoGrowInput.js')?>"></script>
<script type="text/javascript" src="<?php echo r_path('js/plugins/tagedit/jquery.tagedit.js')?>"></script>
<script type="text/javascript" src="<?php echo r_path('js/jquery.multiFieldExtender-2.0.jajabor.js'); ?>"></script>
            ...
            if (thisObj.val() == '' && actionType != '')
            {
                switch (actionType) {
                    ...
                    case 'status' :
                        ...
                        break;
                    default :
                        link += actionType.toLowerCase().replace(/\s/g,'_')+'/';
                }
                $(this).val(link);
            }
    ...
    jQuery(function($) {
        $(document).ready(function() {
            ...
            $('.add_more_container').EnableMultiField({
                linkText: '<button class="btn btn-sm btn-primary"><i class="icon-plus-sign icon-white"></i> Add New</button>',
                removeLinkText: '<button class="btn btn-sm btn-danger"><i class="icon-minus-sign icon-white"></i> Remove</button>',
            ...
            <div class="row-fluid">
                <div class="box box-info">
                    <div class="box-header">
                        ...
                        <h3 class="box-title"><?php echo $heading . ' For ' . $controler_link; ?></h3>                
                    </div>
                    <form class="form-horizontal" id="frm_add_edit" name="frm_add_edit" action="" method="post" autocomplete="off" role="form" >                 
                        <div class="box-body">
                            <div id="div_err"><?php show_all_messages();?></div>
                            <div class="row-fluid add_more_container">
                                ...
                                <div class="col-md-3 button-list"></div>
                            </div>  
                        ...
                        <div class="box-footer">
                            <button type="submit" id="btn_save" name="btn_save" class="btn btn-sm btn-primary"><?php echo addslashes(t('Save changes')); ?></button>
                            <button type="button" id="btn_cancel" name="btn_cancel" class="btn btn-sm btn-danger"><?php echo addslashes(t('Cancel')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
