    ...
    jQuery(function($) {
        $(document).ready(function() {
            ...
            $("a[id^=delete_row_]").click(function() {
                ...
                showConfirmation("<?php echo addslashes(t('This menu wiil deleted permanently with submenu')); ?>", 101, extraData);
            });
        })
    });
    ...
    function callbackEventYes(modalObj, refId, extraData) {
        ...
        if (refId == 101) {
           // blockPage();
            $.ajax({
                type: "POST",
                url: admin_base_url + 'menu_setting/ajax_delete_sub_menu',
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="box box-info">
                        <div class="box-header">
                            ...
                            <h3 class="box-title"><?php echo addslashes(t("Add Sub Menu")) ?></h3>
                        </div>
                        <form class="form-horizontal" id="frm_2" name="frm_2" method="post" action="" role="form" >
                            <div class="box-body">
                                ...
                                <div class="row-fluid">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label><?php echo addslashes(t('Sub Menu Title')); ?></label>
                                ...
                                <div class="row-fluid">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label><?php echo addslashes(t('Menu Link')); ?></label>
                                            <input id="txt_menu_link" name="txt_menu_link" value="" type="text" class="form-control"/>
                                        </div>
                                    </div>
                                </div> 
                            </div>
                        ...
                        <div class="box-footer">
                            ...
                            <button type="button" id="btn_clear" name="btn_clear" class="btn btn-warning"><?php echo addslashes(t('Clear')) ?></button>
                        </div>
                    </div>
