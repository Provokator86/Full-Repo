                        ...
                        <div class="box box-warning">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-5 ">
                                        <div class="form-group">                                            
                                            <label for="focusedInput">Profile Image(150px X 185px)</label>
                                        ...
                                        <div class="col-md-3 col-md-3_1">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="franchise_id[]" data-rel="chosen" data-placeholder="Select Franchise">
                                                    <?php 
                                                    //if($user_role[$i]['i_region_id'] > 0 && $user_role[$i]['i_role_id'] == 10){
                                                    if($user_role[$i]['i_region_id'] > 0 && $user_role[$i]['i_franchise_id'] > 0){
