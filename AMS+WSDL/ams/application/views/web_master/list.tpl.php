  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <a href="#" class="btn btn-success" id="btn_delete_yes"><?php echo addslashes(t("Yes"))?></a>
            <a href="#" class="btn btn-danger" id="btn_delete_no" data-dismiss="modal"><?php echo addslashes(t("No"))?></a>
        </div>
	  </div>
	</div>
</div>
