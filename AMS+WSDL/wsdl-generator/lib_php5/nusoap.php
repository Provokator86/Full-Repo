...
class nusoap_server extends nusoap_base {
    ...
    */
    function configureWSDL($serviceName,$namespace = false,$endpoint = false,$style='rpc', $transport = 'http://schemas.xmlsoap.org/soap/http', $schemaTargetNamespace = false)
    {
		...
		// edit by SWI on 29 Dec for documentation link provide
		$this->wsdl->helpLink = 'http://1099.codeuridea.net/wsdl-generator/help/';
    ...
    */
    function webDescription(){
		...
		<style type="text/css">
			...
			background-color: #ccccff; width: 30%; margin-left: 20px; margin-top: 20px; }
		    .title {
		...
		<div class=content>
			...
			<div class=nav>
				...
				<p>View <a href="'.$this->helpLink.'">Documentation</a> for help.</p>
				<ul>';
