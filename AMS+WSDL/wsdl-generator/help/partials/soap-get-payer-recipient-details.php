	...
	<div class="SystemBlock">
		<div id="Node--730" class="Node node node-api-doc clearfix  Node--apiDoc ">
				...
				<div class="Node-content-field Node-apiDocsParams">
					<div class=" Field FieldName-fieldDocParams FieldType-textLong FieldLabel-above ">
						...
						<div class="Field-items">
							<div class="Field-items-item even ">
								<div class="parameter">
									<span class="param">Informations </span>
									<p><code>Array of Objects containing BatchPayer, BatchPayee</code></p>
								</div>
								<div class="parameter">
			...
			?>
										...
										<tbody>
											<tr>
												...
												<div class="container">
													...
													<div class="line alt2">
														<code class="jscript string tab-8">"informations"</code>
														<code class="jscript plain">: {</code>
														<code class="jscript plain"></code>
													</div>
													<div class="line alt2">
														<code class="jscript string tab-12">"FormType"</code>
														<code class="jscript plain">: </code>
														<code class="jscript string">'xxxx'</code>
														<code class="jscript plain">,</code>
													</div>
													<div class="line alt2">
														<code class="jscript string tab-12">"PayerName"</code>
														<code class="jscript plain">: </code>
														<code class="jscript string">'xxxx'</code>
														<code class="jscript plain">,</code>
													</div>
													<div class="line alt2">
														<code class="jscript string tab-12">"PayerEIN"</code>
														<code class="jscript plain">: </code>
														<code class="jscript string">'xxxx'</code>
														<code class="jscript plain">,</code>
													</div>
													<div class="line alt2">
														<code class="jscript string tab-12">"Payees"</code>
														<code class="jscript plain">: {</code>
														<code class="jscript plain"></code>
													</div>
													<div class="line alt2">
														<code class="jscript string tab-16">"Name:"</code>
														<code class="jscript plain">: </code>
														<code class="jscript string">'xxxx'</code>
														<code class="jscript plain">,</code>
													</div>
													<div class="line alt2">
														<code class="jscript string tab-16">"TIN:"</code>
														<code class="jscript plain">: </code>
														<code class="jscript string">'xxxx'</code>
														<code class="jscript plain">,</code>
													</div>
													<div class="line alt2">
														<code class="jscript plain tab-12">}, ...</code>
													</div>
													<div class="line alt2">
														<code class="jscript plain tab-8">}, ...</code>
													</div>
													<div class="line alt2">
														<code class="jscript plain tab-4">}, ...</code>
													</div>
				...
				<?php
					include_once 'error-pages/getPayerRecipientDetails-error-codes.php';
				?>
			</div>
		</div>
	</div>
