	...
	<div class="SystemBlock">
		<div id="Node--730" class="Node node node-api-doc clearfix  Node--apiDoc ">
											...
											<td class="code">
												<div class="container">
													...
													<div class="line number2 index1 alt1">
														...
														<code class="php string">'requestNewPassword'</code>
			...
			?>
											...
											<tr>
												...
												<div class="container">
													...
													<div class="line alt1">
														...
														<code class="jscript plain">: </code>
														<code class="jscript string">'New password has been sent to your registered email.'</code>
														<code class="jscript plain"></code>
													</div>
													<div class="line alt2">
														<code class="jscript plain tab-4">}, ...</code>
				...
				<?php
					include_once 'error-pages/requestNewPassword-error-codes.php';
				?>
			</div>
		</div>
	</div>
