	...
	<div class="SystemBlock">
		<div id="Node--730" class="Node node node-api-doc clearfix  Node--apiDoc ">
					...
					<div class=" Field FieldName-fieldDocParams FieldType-textLong FieldLabel-above ">
						...
						<div class="Field-items">
							<div class="Field-items-item even ">
								...
								<div class="parameter">
									<span class="param">newpassword </span>
									<p>New Password</p>
									<p><strong>Example Values</strong>: <code>xxxx</code></p>
								</div>
							</div>
											...
											<td class="code">
												<div class="container">
													...
													<div class="line number2 index1 alt1">
														...
														<code class="php string">'changePassword'</code>
													...
													<div class="line number2 index1 alt1">
														<code class="php string tab-28">'newpassword'</code><code class="php plain">=></code><code class="php string">'XXXX'</code><code class="php plain">)</code>
													</div>
													<div class="line number2 index1 alt1">
						...
						<div class="Field-items">
							<div class="Field-items-item even ">
								...
								<div class="parameter">
									...
									<p><strong>Example Values</strong>: <code class="php string">Password changed successfully</code></p>
								</div>
							</div>
						</div>
					</div>
			...
			?>
											...
											<tr>
												...
												<div class="container">
													...
													<div class="line alt1">
														...
														<code class="jscript plain">: </code>
														<code class="jscript string">'Password changed successfully'</code>
														<code class="jscript plain"></code>
													</div>
													<div class="line alt1">
				...
				<?php
					include_once 'error-pages/changePassword-error-codes.php';
				?>
			</div>
		</div>
	</div>
