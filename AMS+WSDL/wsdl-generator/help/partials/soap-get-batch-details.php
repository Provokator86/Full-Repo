	...
	<div class="SystemBlock">
		<div id="Node--730" class="Node node node-api-doc clearfix  Node--apiDoc ">
					...
					<div class=" Field FieldName-fieldDocParams FieldType-textLong FieldLabel-above ">
						...
						<div class="Field-items">
							<div class="Field-items-item even ">
								...
								<div class="parameter">
									<span class="param">batchid <span>optional</span></span>
									<p>Unique <code>Batch-ID</code>.</p>
									<p><strong>Example Values</strong>: <code>BATCH-xxxxxx</code></p>
								</div>
							</div>
						</div>
					</div>
											...
											<td class="code">
												<div class="container">
													...
													<div class="line number2 index1 alt1">
														...
														<code class="php string">'getBatchDetails'</code>
													...
													<div class="line number2 index1 alt1">
														<code class="php string tab-28">'batchId'</code><code class="php plain">=></code><code class="php string">'BATCH-1000000001'</code><code class="php plain"></code>
													</div>
													<div class="line number2 index1 alt1">
				...
				<div class="Node-content-field Node-apiDocsParams">
					<div class=" Field FieldName-fieldDocParams FieldType-textLong FieldLabel-above ">
						...
						<div class="Field-items">
							<div class="Field-items-item even ">
								<div class="parameter">
									<span class="param">Submitted-Date </span>
									<p><strong>Example Values</strong>: <code><?= date('m/d/Y') ?></code></p>
								</div>
								<div class="parameter">
									<span class="param">totalForms </span>
									<p><strong>Example Values</strong>: <code>xxx</code></p>
								</div>
								<div class="parameter">
									<span class="param">totalCost </span>
									<p><strong>Example Values</strong>: <code>9999.99</code></p>
								</div>
								<div class="parameter">
								...
								<div class="parameter">
									...
									<p><strong>Example Values</strong>: <code class="php string">Batch details shown successfully</code></p>
								</div>
							</div>
						</div>
					</div>
			...
			?>
											...
											<tr>
												...
												<div class="container">
													...
													<div class="line alt1">
														...
														<code class="jscript plain">: </code>
														<code class="jscript string">'Batch details shown successfully'</code>
														<code class="jscript plain"></code>
													</div>
													<div class="line alt2">
														<code class="jscript string tab-8">"dateSubmitted"</code>
														<code class="jscript plain">: </code>
														<code class="jscript string"><?= date('m/d/Y') ?></code>
														<code class="jscript plain">,</code>
													</div>
													<div class="line alt2">
														<code class="jscript string tab-8">"totalForms"</code>
														<code class="jscript plain">: </code>
														<code class="jscript string">999</code>
														<code class="jscript plain">,</code>
													</div>
													<div class="line alt2">
														<code class="jscript string tab-8">"totalCost"</code>
														<code class="jscript plain">: </code>
														<code class="jscript string">9999.99</code>
														<code class="jscript plain"></code>
													</div>
													<div class="line alt2">
														<code class="jscript plain tab-4">}, ...</code>
				...
				<?php
					include_once 'error-pages/getBatchDetails-error-codes.php';
				?>
			</div>
		</div>
	</div>
