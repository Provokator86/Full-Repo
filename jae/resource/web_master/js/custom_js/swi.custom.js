...
{    
    $.blockUI({css: { border: 'none', padding: '5px',  backgroundColor: 'none', '-webkit-border-radius': '10px', '-moz-border-radius': '10px', borderRadius:'5px', opacity: .5, color: '#fff', fontSize:'14px',fontWeight:'bold'},
        message: message ? message : '<img src="'+base_url+'resource/web_master/img/ajax-loader-7.gif">'
    }); 
}
function unblockDownload()
{
    $.unblockUI()
}
