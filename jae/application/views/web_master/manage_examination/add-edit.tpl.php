<?php 
/***
File Name: examination add-edit.tpl.php 
Created By: SWI Dev 
...
$(document).ready(function(){
    ...
    $("#frm_add_edit").submit(function(){
		...
		if($("#s_name").val()=='')
		{
			markAsError($("#s_name"),'Please provide name');
			b_valid = false;
		}
        //validating//
        if(!b_valid)
        ...
        <div class="box box-info">
            ...
            <input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>">
                    ...
                    <div class="row">                
	                    <div class="col-md-5 ">
		                    ...
		                    <label for="focusedInput">Name<span class="text-danger">*</span></label>
			                    <input class="form-control" id="s_name" name="s_name" value="<?php echo $posted["s_name"];?>" type="text" />
                 ...
                 <div class="box-footer">
                    ...
                    <input type="button" id="btn_cancel" name="btn_cancel" class="btn" value="Cancel">
                </div>
            </form>
        </div>
    </div>
