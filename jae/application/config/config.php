...
if(ENVIRONMENT == 'production')//For Live site (ENVIRONMENT defined at index.php)
{
    ...
    $config['base_url']    = "http://".$_SERVER['SERVER_NAME']."/jae/";
...
$config['TEXTFILEAMS'] 		= BASEPATH.'../uploaded/forms_txt_pages/';
...
// Salt has been changed 11 Sept 2017
$config['security_salt']	= "_swi#17_";///for encrypting Password : 314d54b67c78964df93b3f36133a51eb
...
// pdf create path
$config['qa_set_up_path'] 		= FCPATH.'uploaded/qaset/';
$config['qa_set_down_path'] 	= $config['base_url'].'uploaded/qaset/';

$config['admin_email'] = "info@jae.com";
