...
if(ENVIRONMENT == 'testing')//For codeuridea site (ENVIRONMENT defined at index.php)
{
    ...
    $db['default']['hostname'] = "108.179.221.35";
	$db['default']['username'] = "mcqsegme_jae_usr";
	$db['default']['password'] = "RQZs*-K&pnk*";
	$db['default']['database'] = "mcqsegme_jae"; 
...
$db['default']["EXAM"]		            	= $tableprefix."examinations";
$db['default']["EXAM_QUESTION_ANSWER"]		= $tableprefix."exam_question_answers";
