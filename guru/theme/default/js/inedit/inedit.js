     ...
     try{   
		...
		*/
        ...
        function setFormValues(obj)
        {
                ...
                */
                ...
                else if($(this).is("input[type='radio'],input[type='checkbox']"))
                {
                    ...
                    */
                    ...
                    if(!$.isPlainObject(values[id]) ///supplied defaultValue is string
                        && $(this).attr("value") == $.trim(values[id]) 
                    ...
                    else if(!$.isEmptyObject(values[id])) //object value has passed for multivalue
                    {
            ...
            //console.log("@setval",settings.defaultValuesDisplay);      
        }
        ...
        */
        ...
        {
            //showing the message
            self.showMessage(saveStatus.mode,saveStatus.message);
        ...
        try{
            ...
            function init(){
                if( !$(wSetting.mainWrapper).length )//the main wrapper doesnot exists
                    throw new Error("The main Wrapper does not exists.");
                else if(!$(wSetting.addMoreButton).length
                    || !$(wSetting.addMoreContainer).length
                )
                    throw new Error("The addMore Button or Container does not exists.");
