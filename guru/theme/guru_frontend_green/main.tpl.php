    ...
    <div class="inner_search">
        <div class="search_panel search_big_panel">
            <form name="top_search_form" id="top_search_form"  action="<?=site_url("search_engine");?>" method="post">
              ...
              <input id="search_type_value" name="search_type_value" type="text" class="textbox alignleft rightmar" value="Webdesign" onblur="if(this.value=='')this.value=this.defaultValue;" onfocus="if(this.value==this.defaultValue)this.value='';" />
              ...
              <select class="alignleft select_topbg" id="distance" name="distance">
                ...
                <option value="10" <?php if(@$posted['distance']=="10") echo "selected='selected'";?>>1-10 Km</option>
                <option value="50" <?php if(@$posted['distance']=="50") echo "selected='selected'";?>>10-50 Km</option>
                <option value="100" <?php if(@$posted['distance']=="100") echo "selected='selected'";?>>50-100 Km</option>
              </select>
             <input id="submit_search" class="alignleft leftmar rightmar" type="image" title="Search"  src="<?=base_url(get_theme_path())."/";?>images/search-button.png">
              <input id="keep_filter" name="keep_filter" type="checkbox" class="checkbox alignleft" value="1" /> Keep filter
          </form>
       </div>
    </div>
