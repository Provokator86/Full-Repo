...
<?php //if(!$view_data){?>
<?php if(!$viewer_data){?>
    <?php /*if(isset($user[0]['login_by_facebook'])):?>
    ...
    */
    ?>
    <div class="info aligncenter">
        <?php /*?><a href="<?=site_url(admin_base_url("cron/insert_user_friend_list_instant/".encrypt(get_userLoggedIn("id")))); ?>" class="grey_button">Add your FB friends</a><?php */?>
    ...
    <div class="info">
        ...
        <a href="javascrip:void(0);" onclick="return false;" class="grey_button">Ask</a>
    </div>
    <?
    }//end else
    else if(empty($chain_html))
