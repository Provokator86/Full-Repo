...
$(document).ready(function(){
    ...
    $("select[id^='action_cat_id_']").each(function(){
       var id=$(this).attr("rel");
       //var dd= $(this).find("option:selected").attr("value");
       //var dd= $(this).val();
       
       $(this).off("change").on("change",function(){
           var dd= $(this).find("option:selected").attr("value");
           
           $.post("<?=admin_base_url("option/ajax_changeCategory");?>"
           ,{"form_token":id,"cat_id":dd}
           ,function(data){
               if(data)
               {
...
<div class="tablePars">
    <div class="dataTables_filter" id="DataTables_Table_0_filter">
        ...
        <?=form_dropdown("cat_id",dd_category(),@$posted["cat_id"],'id="cat_id" class="show_cat" style="margin:10px"');?>
        <label>Option : <input type="text" id="s_suggestion" name="s_suggestion" value="<?=@$posted["s_suggestion"];?>"  aria-controls="DataTables_Table_0">
