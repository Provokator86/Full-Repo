        ...
        <div class="full_no_sidebar">
            ...
            {              
              ...
              <div class="border_bottom relative">
                    <p class="with162 alignleft no-bot-pad"><a class="skili_count" href="javascript:void(0);"><span><?=$v->i_endorse_count;?></span><?php /* ?><span class="plus">+</span><?php */?> <?=$v->s_skill_name;?></a></p>
