<div class="top_select clear">
  <p class="alignleft">
  <input type="checkbox" class="alignleft" id="all_chk_draft"/> Select all</p>
  <a href="javascript:void(0);" class="short_grey_button" id="all_delete_draft">Delete Selected</a>
...
if(!empty($draft)) {			
 ...
 ?>  
  <tr <?php echo $cls;?>>
	...
	<input type="checkbox" name="draft[]" id="chk_draft_<?=$ok?>" class="chk_draft_<?=$ov["i_id"];?>" value="<?=$ov["i_message_index_id"];?>" />
	</td>
