...
* @link model/jobs_model.php
* @link views/admin/jobs/
*/


class Jobs extends My_Controller implements InfController
{
    ...
    public function __construct()
    {
        ...
        try
        {
          ...
          $this->load->model("jobs_model","mod_rect");
    ...
    */
    public function show_list($order_name='',$order_by='desc',$start=NULL,$limit=NULL)
    {
        try
        {
            $this->data['heading']="Jobs";////Package Name[@package] Panel Heading
    ...
    public function add_information()           
    {
		...
		try
        {
            ...
            if($_POST)
            {
                ...
                $this->form_validation->set_rules('ta_content', 'job description', 'required');
                ...
                else///validated, now save into DB
                {
                    ...
                    $info["s_description"]		=	$posted["ta_content"];	
					$info["i_status"]	    	=	1  ;
    ...
    public function modify_information($i_id=0)
    {
        ...
        try
        {
            ...
            {	
				...
				$posted["ta_content"]	= trim($info["s_description"]);
				$posted["h_id"]= $i_id;
    ...
    */
    public function ajax_change_status()
    {
        try
        {
			...
			$i_rect				= $this->mod_common->common_edit_info($this->db->JOBS,$info,$arr_where); /*don't change*/                
