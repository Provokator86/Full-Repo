...
* @link InfModel.php 
* @link MY_Model.php
* @link controllers/Auto_sms.php
* @link views/admin/auto_sms/
*/


class Auto_sms_model extends MY_Model implements InfModel
{
    private $conf;
        ...
        try
        {
          ...
          if($rs->num_rows()>0)
          {
              foreach($rs->result() as $row)
              {
                  ...
                  $s_desc                       =   strip_tags(get_unformatted_string($row->s_content));
        ...
        try
        {
          ...
          if($rs->num_rows()>0)
          {
              foreach($rs->result() as $row)
              {
                  ...
                  $s_desc               =   get_unformatted_string($row->s_content);
