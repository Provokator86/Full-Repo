...
$(document).ready(function(){
       ...
       $("ul[class='select'] a,ul[class='link'] a,ul[id='login_info'] a,ul[class=sub2] a,div[class=view_all] a,li[class=quick_links] a").each(function(i){
...
<div id="header">
  ...
  <!--<div id="logo"><img src="images/admin/logo_bak.jpg" alt="###SITE_NAME_UC###" title="###SITE_NAME_UC###" /></div>-->
  <div id="logo" class="view_all"><a id="general_0" href="<?php echo admin_base_url().'dashboard' ?>"><img src="images/admin/logo.png" alt="###SITE_NAME_UC###" title="###SITE_NAME_UC###" /></a></div>
  <div id="toplink">
...
<div id="footer">
  ...
  <p>&copy; 2012 Copyright ###SITE_NAME_LC###</p>
