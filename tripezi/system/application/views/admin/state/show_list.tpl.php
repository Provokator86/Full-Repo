...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view the states presnt in the database.Admin can also add state here, if he need to add a new state.</div>
	<div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="35%">
            <input id="txt_state" name="txt_state" value="<?php echo $txt_state;?>" type="text" size="35" />
            </td>           
