    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <tr>
          <td>Status :</td>
          <td><input rel="" type="text" name="txt_status_title" id="txt_status_title" size="24" value="<?php echo ($posted["txt_status_title"]);?>"  />
          <input name="chk_box_status" id="chk_box_status" type="checkbox" <?php echo ($posted["txt_status_title"])?'checked':''; ?> />
