...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view the FAQ and also can add new FAQ and edit FAQ.</div>
	<div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_question" name="txt_question" value="<?php echo $txt_question;?>" type="text" size="28" />
