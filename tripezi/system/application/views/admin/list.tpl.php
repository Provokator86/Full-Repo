                               ...
                               if(msg=="ok") 
                               {
                                   if(i_status)
                                    {      
                                        ...
                                        $("a[id='"+temp_id+"'] > img").attr({'src':'images/admin/inactive.png','title':'Inactive','alt':'Inactive'});
                                    ...
                                    else
                                    {
                                        ...
                                        $("a[id='"+temp_id+"'] > img").attr({'src':'images/admin/active.png','title':'Active','title':'Active'}); 
