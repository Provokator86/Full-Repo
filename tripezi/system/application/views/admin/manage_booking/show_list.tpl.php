...
function cancellationApproval(enc_booking_id,status,cur_obj)
{
     jQuery(function($) {
         
         
         
          $("#dialog-confirm #dialog_msg").html('<strong>THe status will be change permanently.</strong> Are you sure?');       
                ...
                'Ok': function() {
                    ...
                    $.blockUI({ message: 'Just a moment please...' });
                       ...
                       $.ajax({
                                                type: "POST",
                                                async: false,
                                                url: base_url+'admin/manage_booking/ajax_cancellation',
                                                ...
                                                success: function(msg){
                                                    ...
                                                    if(msg='ok')
                                                    {
                                                        ...
                                                        if(status=='reject')
                                                        {
                                                            $(cur_obj).parent().html('<strong>Amount paid</strong>') ;     
                                                        }
                                                        else if(status=='approve')
                                                        {
                                                            $(cur_obj).parent().html('<strong>Cancelled and Approved by admin</strong>') ;     
                                                        }
            ...
            <td colspan="3">
                <select name="opt_status" id="opt_status">
                    <option value="">Select Status</option>
                     <?php echo makeOptionNoEncrypt($arr_booking_status,$opt_status); ?>
                </select>
            </td>
          </tr>
