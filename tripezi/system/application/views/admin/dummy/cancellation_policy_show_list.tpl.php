...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can view the cancellation policy presnt in the database.Admin can also add cancellation policy here, if he need to add a new cancellation policy.</div>
    <div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="15%">Cancellation Policy:</td>
