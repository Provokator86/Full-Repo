    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td><input id="txt_charge" name="txt_charge" value="<?php echo $posted["txt_charge"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr>
         <tr>
          <td>Description *:</td>
          <td><textarea cols="47" rows="5" name="ta_description" id="ta_description"></textarea></td>
          <td>&nbsp;</td>
        </tr>          
