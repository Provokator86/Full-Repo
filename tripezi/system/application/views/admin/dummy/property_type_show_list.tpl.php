...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can view the property type presnt in the database.Admin can also add property type here, if he need to add a new property type.</div>
    <div class="clr"></div>
