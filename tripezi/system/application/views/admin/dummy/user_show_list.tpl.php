      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_last_name" name="txt_last_name" value="<?php echo $txt_last_name;?>" type="text" size="28"  readonly="yes" />
            ...
            <input id="txt_email" name="txt_email" value="<?php echo $txt_created_on;?>" type="text" size="28"   />
