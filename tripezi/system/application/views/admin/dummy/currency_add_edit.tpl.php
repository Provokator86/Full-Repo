...
$("#frm_add_edit").submit(function(){
    ...
    else if(!pattern.test($("#txt_title").val()))
    {
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td>Country Code *:</td>
          <td><input id="txt_code" name="txt_code" value="<?php echo $posted["txt_code"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr> 
        ...
        <tr>
          <td>Country Rate *:</td>
          <td><input id="txt_rate" name="txt_rate" value="<?php echo $posted["txt_rate"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr> 
     
        <tr>
          <td>Country Symbol *:</td>
          <td><input id="txt_symbol" name="txt_symbol" value="<?php echo $posted["txt_symbol"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr>          
