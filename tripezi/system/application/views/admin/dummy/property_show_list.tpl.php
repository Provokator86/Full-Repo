...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can manage properties .</div>
    <div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_owner_id" name="txt_owner_id" value="<?php echo $txt_owner_id;?>" type="text" size="28" />
