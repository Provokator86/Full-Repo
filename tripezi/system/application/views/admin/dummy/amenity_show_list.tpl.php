...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can view the amenities presnt in the database.Admin can also add amenities here, if he need to add a new Amenity.</div>
    <div class="clr"></div>
