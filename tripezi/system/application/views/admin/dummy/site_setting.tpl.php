            ...
            <div id="myaccount">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="s_twitter_address" name="s_twitter_address" value="<?php echo $posted["s_twitter_address"];?>" 
                            type="text" size="50" />                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <td colspan="2" class="caption_txt">From here Admin can set the Twitter address.</td></tr>
                     ...
                     <tr>
                        ...
                        <td>
                            <input id="s_linkedin_address" name="s_linkedin_address" value="<?php echo $posted["s_linkedin_address"];?>" 
                            type="text" size="50" />                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="s_sms_key" name="s_sms_key" value="<?php echo $posted["s_sms_key"];?>" 
                            type="text" size="50" />                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                    <td>&nbsp;</td>
                    <td colspan="2" class="caption_txt">From here Admin can set the Sms gateway key.</td></tr>
                    
                    
                    <tr>
                        <td>Google map key*:</td>
                        <td>
                            <input id="s_google_key" name="s_google_key" value="<?php echo $posted["s_google_key"];?>" 
                            type="text" size="50" />                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                    <td>&nbsp;</td>
                    <td colspan="2" class="caption_txt">From here Admin can set the Google key.</td></tr>
