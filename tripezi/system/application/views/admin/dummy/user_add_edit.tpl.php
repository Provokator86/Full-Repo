...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
    ...
    <div class="info_box">From here Admin can edit information about user.</div>
    <div class="clr"></div>
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          ...
          <td>
		  <img src="images/admin/user_acc_thumb.jpg" /><a href="javascript:void(0);">Delete image</a><br/>
		  <input id="txt_linkedin" name="txt_linkedin" value="<?php echo $posted["txt_linkedin"];?>" type="file" size="30" />	  
        ...
        <tr>
          ...
          <td>
          <textarea name="txt_about" id="txt_about" cols="100" rows="20"><?php echo $posted["txt_about"]; ?></textarea>
          </td>
          <td>&nbsp;</td>
        </tr> 
