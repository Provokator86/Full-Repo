...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can view the countries presnt in the database.Admin can also add countries here, if he need to add a new Country.</div>
    <div class="clr"></div>
