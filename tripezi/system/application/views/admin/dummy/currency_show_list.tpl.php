...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can view the currency presnt in the database.Admin can also add currency here, if he need to add a new currency.</div>
    <div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_currency_code" name="txt_currency_code" value="<?php echo $txt_currency_code;?>" type="text" size="28" />
