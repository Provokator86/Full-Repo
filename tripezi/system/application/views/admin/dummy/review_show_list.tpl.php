...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can manage reviews and rating .</div>
    <div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_user_name" name="txt_user_name" value="<?php echo $txt_user_name;?>" type="text" size="25" />
