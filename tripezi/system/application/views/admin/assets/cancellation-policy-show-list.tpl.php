...
* Modified Date 
* Purpose
*  View For Property type List Showing
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view the cancellation policy presnt in the site. Admin can also add or cancellation policy.</div>
	<div class="clr"></div>
    ...
    <div id="tabcontent">
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="20%">Cancellation policy name :</td>
            <td width="23%">
