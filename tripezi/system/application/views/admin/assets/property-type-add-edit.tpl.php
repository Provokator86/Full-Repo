...
* 
* Purpose:
*  View For property type Add & Edit
* 
* @package Manage Assets
* @subpackage Manage Property type
* 
...
$("#frm_add_edit").submit(function(){
    ...
    $("#div_err").hide("slow"); 
	 ...
	 if($.trim($("#txt_property").val())=="") 
		{
			s_err +='Please provide property type name.<br />';
			b_valid=false;
		}
    /////////validating//////
    if(!b_valid)
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          ...
          <td><input id="txt_property" name="txt_property" value="<?php echo $posted["txt_property"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr>          
