...
* 
* Purpose:
*  View For cancellation policy Add & Edit
* 
...
$("#frm_add_edit").submit(function(){
    ...
    //txt_cancel_charge
	 if($.trim($("#txt_policy").val())=="") 
		{
			s_err +='Please provide cancellation policy name.<br />';
			b_valid=false;
		}
	if($.trim($("#txt_cancel_charge").val())=="") 
		{
			s_err +='Please provide cancellation charge.<br />';
			b_valid=false;
		}
	else if(!pattern.test($("#txt_cancel_charge").val()))	
	{
		s_err +='Please provide proper cancellation charge.<br />';
		b_valid=false;
	}	
	if($.trim($("#ta_description").val())=="") 
		{
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
	...
	<div class="info_box">From here Admin can add and edit the name of cancellation policy .</div>
	<div class="clr"></div>
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td>Cancellation Policy Name *:</td>
          <td>
		  <input id="txt_policy" name="txt_policy" value="<?php echo $posted["txt_policy"];?>" type="text" size="50" />
		  </td>
          <td>&nbsp;</td>
        </tr>  
		...
		<tr>
          ...
          <td>
		  <input id="txt_cancel_charge" name="txt_cancel_charge" value="<?php echo $posted["txt_cancel_charge"];?>" type="text" size="50" />
		  </td>
          <td>&nbsp;</td>
        </tr> 
		...
		<tr>
          ...
          <td>
		  <textarea name="ta_description" id="ta_description" cols="47" rows="5"><?php echo $posted["ta_description"] ?></textarea>
		  </td>
          <td>&nbsp;</td>
        </tr>       
