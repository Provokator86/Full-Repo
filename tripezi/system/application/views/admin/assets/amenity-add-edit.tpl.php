...
$("#frm_add_edit").submit(function(){
    ...
    $("#div_err").hide("slow"); 
	 ...
	 if($.trim($("#txt_amenity").val())=="") 
		{
			s_err +='Please provide amenity name.<br />';
			b_valid=false;
		}
    /////////validating//////
    if(!b_valid)
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td>Amenity Name *:</td>
          <td><input id="txt_amenity" name="txt_amenity" value="<?php echo $posted["txt_amenity"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr>          
