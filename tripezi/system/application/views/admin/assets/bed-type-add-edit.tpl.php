...
* 
* Purpose:
*  View For bed type Add & Edit
* 
* @package Manage Assets
* @subpackage Manage Bed type
* 
...
$("#frm_add_edit").submit(function(){
    ...
    $("#div_err").hide("slow"); 
	 ...
	 if($.trim($("#txt_bed").val())=="") 
		{
			s_err +='Please provide bed type name.<br />';
			b_valid=false;
		}
    /////////validating//////
    if(!b_valid)
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
	...
	<div class="info_box">From here Admin can add and edit the name of bed type .</div>
	<div class="clr"></div>
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td>Bed Type Name *:</td>
          <td><input id="txt_bed" name="txt_bed" value="<?php echo $posted["txt_bed"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr>          
