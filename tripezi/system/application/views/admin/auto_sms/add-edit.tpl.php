...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
	...
	<div class="info_box">From here Admin can edit the contents of the autosms. Admin should not edit and delete the contents of enclosed under brackets [ ]</div>
	<div class="clr"></div>
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td valign="top">SMS Body *:</td>
          <td>
          <textarea name="ta_content" id="ta_content" cols="50" rows="10"><?php echo $posted["ta_content"]; ?></textarea>
          </td>
          <td>&nbsp;</td>
        </tr> 
