...
* Modified Date:
* Purpose:
*  View For currency List Showing
* @package General
* @subpackage currency
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can manage the curreny rate for different currencies with respect to USD as USD has been set default currency .</div>
	<div class="clr"></div>
    ...
    <div id="tabcontent">
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="15%">Currency Code :</td>
            <td width="40%">
            	<input id="txt_currency" name="txt_currency" value="<?php echo $txt_currency;?>" type="text" size="28" />
            </td>
			 <td width="15%"></td>
            <td width="25%">
            </td>
