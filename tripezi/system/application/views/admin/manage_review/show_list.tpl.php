...
<div id="right_panel">
    ...
    <h2><?php echo $heading;?></h2>
                 ...
                 <div class="info_box">From here Admin can can view review & rating for the properties .</div>     
    <div id="tab_search">
    ...
    <div id="tabcontent">
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="12%">Reviewed by :</td>
            <td width="23%">
            <input id="txt_name" name="txt_name" value="<?php echo $txt_name;?>" type="text" size="25"/>
            </td>
            <td width="12%">comment :</td>
            <td>
            <input id="txt_comment" name="txt_comment" value="<?php echo $txt_comment;?>" type="text" size="25"/>
            </td>			
			<td width="12%">Property Name :</td>
            <td>
            <input id="txt_property" name="txt_property" value="<?php echo $txt_property;?>" type="text" size="25"/>
            </td>
          </tr>
		  
          <tr>
            <td width="15%">Review Date From :</td>
            <td width="23%">
            <input id="txt_date_from" name="txt_date_from" value="<?php echo $txt_date_from;?>" type="text" size="28" readonly="yes"/>
            </td>
            <td width="12%">Review Date To:</td>
            <td colspan="3">
            <input id="txt_date_to" name="txt_date_to" value="<?php echo $txt_date_to;?>" type="text" size="28"  readonly="yes" />
            </td>
          </tr>
