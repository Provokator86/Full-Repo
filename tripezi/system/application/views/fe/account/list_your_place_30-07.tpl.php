				...
				<input name="h_mode" id="h_mode" type="hidden" value="<?php echo $posted['h_mode'];?>"/> 
					...
					<ul>
						  <li>
								...
								<p>Private room</p>
								<div class="pop-up margintop02"> <a href="#" title="Entire Home/Apartment" class="masterTooltip"></a> <img src="images/fe/pop-up.png" class="masterTooltip" title="Private room" alt="pop-up" /></div>								
						  </li>
						  <li>
								...
								<p>Shared room</p>
								<div class="pop-up margintop02"> <a href="#" title="Entire Home/Apartment" class="masterTooltip"></a> <img src="images/fe/pop-up.png" class="masterTooltip" title="Shared room" alt="pop-up" /></div>
						  </li>
						  <li>
								...
								<div class="pop-up margintop02"> <a href="#" title="Entire Home/Apartment" class="masterTooltip"></a> <img src="images/fe/pop-up.png" class="masterTooltip" title="Entire home/apartment" alt="pop-up" /></div>
					...
					<div class="form-left-box">
						  <label class="text">Standard Price</label>
						  <div class="text-box02">
						  ...
						  <label class="text">Cleaning Fee</label>
						  <div class="text-box02">
					...
					<div class="form-right-box">
						  ...
						  <label class="text">Additional Guests ( > 1)</label>
						  <div class="text-box02">
					...
					<div class="form-left-box">
						  ...
						  <div class="pop-up margintop"> <a href="#" title="Entire Home/Apartment" class="masterTooltip"></a> <img src="images/fe/pop-up.png" class="masterTooltip" title="Cancellation Policy" alt="pop-up" /></div>
						   <br class="spacer" />
						  ...
						  <div class="err"><?php echo form_error('opt_max_night'); ?></div>
						  <div class="spacer">&nbsp;</div>
						  <div class="error"></div>
					</div>
					<div class="form-right-box">
