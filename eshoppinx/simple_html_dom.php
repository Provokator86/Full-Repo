...
class simple_html_dom {
	...
	function getElementById($id) {return $this->find("#$id", 0);}
	function getElementByClassName($id) {return $this->find(".$id", 0);}
	function getElementsByClassName($id,$idx=null) {return $this->find(".$id",  $idx);}
	function getElementsByClassNameIndex($name,$idx=-1) {return $this->find($name, $idx);}
	function getElementsById($id, $idx=null) {return $this->find("#$id", $idx);}
	function getElementByTagName($name) {return $this->find($name, 0);}
	function getElementsByTagName($name, $idx=-1) {return $this->find($name, $idx);}
	function getElementByAttributes($id) {return $this->find("$id", 0);}
