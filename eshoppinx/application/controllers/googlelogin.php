...
class Googlelogin extends MY_Controller {
	...
	function facebookRedirect()
	{
		...
		if($_SESSION['email'] !='')
		{
			...
			$google_login_details = array('social_login_name'=>$_SESSION['first_name'],'social_login_unique_id'=>$_SESSION['fb_user_id'],'screen_name'=>$_SESSION['first_name'],'social_image_name'=>$_SESSION['fb_image_name'],'social_email_name'=>$_SESSION['email'],'loginUserType'=>'facebook');
