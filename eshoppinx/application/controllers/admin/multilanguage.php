   ...
   function __construct()
	...
	public function change_language_default()
	{
		if ($this->checkLogin('A') != ''){
			...
			if($languageId != ''){
				$this->multilanguage_model->update_details(LANGUAGES,array('is_default'=>'No'),array());	
				$this->multilanguage_model->update_details(LANGUAGES,array('is_default'=>'Yes'),array('id'=>$languageId));	
