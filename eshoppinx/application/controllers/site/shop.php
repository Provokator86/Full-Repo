...
class Shop extends MY_Controller {
	...
	public function display_stores(){
		...
		$this->data['topStores'] = $this->shop->get_top_stores();        
        $this->data['nav_menu'] = 3;
		$this->load->view('site/shop/display_top_stores',$this->data);
    }

    public function display_people(){
		$this->data['heading'] = 'People';
		$this->data['topPeople'] = $this->shop->get_top_people();
        $this->data['nav_menu'] = 5;
		$this->load->view('site/shop/display_top_people',$this->data);
        
    }
    
    public function display_brands(){
        $this->data['heading'] = 'Brands';
        $this->data['topStores'] = $this->shop->get_top_brands();
        $this->data['nav_menu'] = 4;
        $this->load->view('site/shop/display_top_brands',$this->data);
