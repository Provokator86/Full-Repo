				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						<tr>
							...
							<?php 
							if ($allPrev == '1' || in_array('2', $multilang)){
								$mode = ($row->is_default == 'Yes')?'0':'1';
								if ($mode == '0'){
							?>
								<span class="badge_style b_done"><?php echo $row->is_default;?></span>
							<?php
								}else {	
							?>
								<a title="Click to set as default" class="tip_top" href="javascript:confirm_status('admin/multilanguage/change_language_default/<?php echo $row->id;?>')"><span class="badge_style"><?php echo $row->is_default;?></span></a>
							<?php 
								}
							}else {
							?>
