...
<!-- 					<li><a href="admin/product/display_product_list" <?php if($currentPage=='display_product_list'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Selling Product List</a></li>
 -->					<li><a href="admin/product/display_user_product_list" <?php if($currentPage=='display_user_product_list'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Product List</a></li>
					...
					<li><a href="admin/product/add_affl_product_form" <?php if($currentPage=='add_affl_product_form'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Add New Product</a></li>
                    
                    <?php if(!SITE_FOR_LIVE){  // for local m/c only ?>
                    <li><a href="admin/product/add_csv_product_form" <?php if($currentPage=='add_csv_product_form'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>CSV Import</a></li>
                    <?php } ?>
                ...
                <?php }?>
				<li><a href="#" <?php if($currentUrl=='stories' ){ echo 'class="active"';} ?>><span class="nav_icon folder"></span> Stories<span class="up_down_arrow">&nbsp;</span></a>
				  <ul class="acitem" <?php if($currentUrl=='stories' ){ echo 'style="display: block;"';}else{ echo 'style="display: none;"';} ?>>
					<li><a href="admin/stories/display_stories_list" <?php if($currentPage=='display_stories_list'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Stories List</a></li>
                    <!--<li><a href="admin/comments/view_stories_comments" <?php if($currentPage=='view_stories_comments'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Stories Comments List</a></li>-->
					
					<li><a href="admin/stories/add_stories_form" <?php if($currentPage=='add_stories_form'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Add New Stories</a></li>
					
				</ul>
				</li>
                
                <?php //} if ((isset($seller) && is_array($seller)) && in_array('0', $seller) || $allPrev == '1'){ 	?>
				<li><a href="#" <?php if($currentUrl=='seller'){ echo 'class="active"';} ?>><span class="nav_icon users_2"></span> Stores<span class="up_down_arrow">&nbsp;</span></a>
				<ul class="acitem" <?php if($currentUrl=='seller'){ echo 'style="display: block;"';}else{ echo 'style="display: none;"';} ?>>
					<!--<li><a href="admin/seller/display_seller_dashboard" <?php if($currentPage=='display_seller_dashboard'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Dashboard</a></li>-->
					<li><a href="admin/seller/display_seller_list" <?php if($currentPage=='display_seller_list'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Store List</a></li>
					<li><a href="admin/seller/display_seller_requests" <?php if($currentPage=='display_seller_requests'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Claim Requests</a></li>
				</ul>
				</li>
                
                <!-- START NEW CODE FOR BRANDS JAN 2015 -->               
                <?php //if(!SITE_FOR_LIVE){ ?>
                <li><a href="#" <?php if($currentUrl=='brands'){ echo 'class="active"';} ?>><span class="nav_icon users_2"></span> Brands<span class="up_down_arrow">&nbsp;</span></a>
                    <ul class="acitem" <?php if($currentUrl=='brands'){ echo 'style="display: block;"';}else{ echo 'style="display: none;"';} ?>>
                        <li><a href="admin/brands/display_brand_list" <?php if($currentPage=='display_brand_list'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Brand List</a></li>
                    </ul>
                </li>                
                <?php //} ?>
                <!-- END NEW CODE FOR BRANDS JAN 2015 -->
