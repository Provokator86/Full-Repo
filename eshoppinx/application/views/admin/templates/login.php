	...
	<div class="login_container">
		<div class="login_header blue_lgel">
			<ul class="login_branding">
                ...
                <!--<img src="images/logo/<?php echo $logo;?>" alt="<?php echo $siteTitle;?>" width="100px" title="<?php echo $siteTitle;?>">-->
                <img src="images/site_new/logo.jpg" alt="<?php echo $siteTitle;?>" width="100px" title="<?php echo $siteTitle;?>">
				</div>
				<span></span>
				</li>
