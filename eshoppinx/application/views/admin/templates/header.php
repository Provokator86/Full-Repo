	...
	<div id="header" class="blue_lin">
		<div class="header_left">
			<div class="logo">
                ...
                <img src="images/site_new/logo.jpg" alt="<?php echo $siteTitle;?>" height="20px" title="<?php echo $siteTitle;?>">
			</div>
			<div id="responsive_mnu">
				...
				<ul <?php if($currentUrl=='slider' || $currentUrl=='comments'){ echo 'style="display: block;"';}else{ echo 'style="display: none;"';} ?>>
				...
				<li><a href="#" <?php if($currentUrl=='stories' ){ echo 'class="active"';} ?>><span class="nav_icon folder"></span> Stories<span class="up_down_arrow">&nbsp;</span></a>
				  <ul <?php if($currentUrl=='stories' ){ echo 'style="display: block;"';}else{ echo 'style="display: none;"';} ?>>
