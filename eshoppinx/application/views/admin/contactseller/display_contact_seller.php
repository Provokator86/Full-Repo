				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						<tr>
							...
							<?php }?>
								<?php if ($allPrev == '1' || in_array('3', $contactseller)){?>	
								<span><a class="action-icons c-delete" href="javascript:confirm_delete('admin/contactseller/delete_contact_record/<?php echo $row->id;?>')" title="Delete">Delete</a></span>
							<?php }?>
							</td>
						</tr>
						<?php 
