          ...
          <div class="widget_content">
            ...
            <div id="tab1">
              <ul>
                ...
                <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="logo_icon">Logo Icon</label>
                    <div class="form_input">
                      <input name="logo_icon" id="logo_icon" type="file" tabindex="5" class="large tipTop" title="Please select the logo icon"/>
                    </div>
                    <div class="form_input"><img src="<?php echo base_url();?>images/logo/<?php echo $admin_settings->row()->logo_icon;?>" width="50px"/></div>
                  </div>
                </li>
                <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="logo_icon_option">Logo Icon Display</label>
                    <div class="form_input">
                    <input name="logo_icon_option" type="radio" value="yes" <?php if($admin_settings->row()->logo_icon_option=='yes'){echo 'checked="checked"';} ?> />Yes<input name="logo_icon_option" type="radio" value="no" <?php if($admin_settings->row()->logo_icon_option=='no'){echo 'checked="checked"';} ?> />No
...
<!--                 <li>
 ...
 -->                <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="payment_details">Payment Details</label>
                    <div class="form_input">
                      <textarea name="payment_details" id="payment_details" rows="5" tabindex="10" class="large tipTop mceEditor" title="Please enter the payment details for products"><?php echo htmlentities($admin_settings->row()->payment_details);?></textarea>
                    </div>
                  </div>
                </li>
              </ul>
...
<!--               <div class="form_grid_12">
 ...
 --><li>              <div class="form_grid_12">              
              ...
              <label  class="error">Note: To create Twitter api refer this <a href="https://dev.twitter.com/discussions/631" target="_blank">Reference Link</a>  </label>
                ...
                <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="consumer_secret">Twitter Access Token</label>
                    <div class="form_input">
                      <input name="twitter_access_token" id="twitter_access_token" type="text" tabindex="11" value="<?php echo $admin_settings->row()->twitter_access_token;?>" class="large tipTop" title="Please enter the twitter access token"/>
                    </div>
                  </div>
                </li>
				<li>
                  <div class="form_grid_12">
                    <label class="field_title" for="consumer_secret">Twitter Access Token Secret</label>
                    <div class="form_input">
                      <input name="twitter_access_token_secret" id="twitter_access_token_secret" type="text" tabindex="11" value="<?php echo $admin_settings->row()->twitter_access_token_secret;?>" class="large tipTop" title="Please enter the twitter access token secret"/>
                    </div>
                  </div>
                </li>
                 <li>
