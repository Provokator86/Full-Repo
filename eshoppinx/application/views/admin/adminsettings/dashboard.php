...
?>
    ...
    <div class="switch_bar">
		<ul>
            ...
            <li><a href="admin/seller/display_seller_list"><span class="stats_icon user_seller"><span class="alert_notify orange"><?php echo $getTotalSellerCount;?></span></span><span class="label"> Stores</span></a></li>
