			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php 
						...
						echo form_open_multipart('admin/category/editBanner',$attributes) 
					?>
	 						...
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<img src="<?php echo base_url();?>images/category/banner/<?php echo $banner_details->row()->image;?>" width="200"/>
									</div>
								</div>
								</li>
