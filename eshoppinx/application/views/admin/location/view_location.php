				...
				<div class="widget_wrap">
					...
					?>
	 						<ul>
                                ...
                                <li>
								<div class="form_grid_12">
									<label class="field_title" for="country_tax">Country Shipping Cost<span class="req">*</span></label>
									<div class="form_input">
                                   <?php echo $location_details->row()->shipping_cost;?>
									</div>
								</div>
								</li>
                                <li>
								<div class="form_grid_12">
									<label class="field_title" for="country_tax">Country Tax<span class="req">*</span></label>
									<div class="form_input">
                                   <?php echo $location_details->row()->shipping_tax;?>
									</div>
								</div>
								</li>
	 							<li>
