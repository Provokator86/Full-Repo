						...
						<ul>
							...
							<div class="form_input">
	 						...
	 						<li>
								...
								<div class="form_input">
								<textarea name="description" id="description" tabindex="2" style="width:370px;" class="required large tipTop" title="Please enter the product description"><?php echo $product_details->row()->description;?></textarea>
								</div>
								</div>
							</li>
	 						...
	 						<li>
								...
								<div class="form_input">
								<textarea name="shipping_policies" id="shipping_policies" tabindex="3" style="width:370px;" class="large tipTop" title="Please enter the product shipping policies"><?php echo $product_details->row()->shipping_policies;?></textarea>
								</div>
								</div>
							</li>
	 						...
	 						<li>
								...
								<div class="form_input">
								<textarea name="xchange_policy" id="xchange_policy" tabindex="3" style="width:370px;" class="large tipTop" title="Please enter the product exchange policy"><?php echo $product_details->row()->xchange_policy;?></textarea>
								</div>
								</div>
							</li>
                            ...
                            <li>
                             ...
                             <li>
								...
								<div class="form_input">
								<input type="text" name="youtube" id="youtube" tabindex="11" value="<?php echo $product_details->row()->youtube;?>" class="large tipTop" title="Please enter the youtube link" />
								</div>
								</div>
							</li>
