 ...
 -->							<th class="tip_top" title="Click to sort">
						...
						<tr>
							...
							<td class="center">
								...
								if ($weblink != ''){
									echo '<a href="'.$weblink.'" title="'.$weblink.'" class="tipTop" target="_blank">click here</a>';
								}else {
									echo 'Not available';
								}
								?>
...
-->							<td class="center">
							...
							<td class="center">
							<?php if ($allPrev == '1' || in_array('2', $product)){?>
								<span><a class="action-icons c-edit" href="admin/product/edit_user_product_form/<?php echo $row->seller_product_id;?>" title="Edit">Edit</a></span>
							<?php }?>
