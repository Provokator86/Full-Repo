						...
						<ul>
							...
							<div class="form_input">
	 						...
	 						<li>
								...
								<div class="form_input">
								<textarea name="description" id="description" tabindex="2" style="width:370px;" class="required large tipTop" title="Please enter the product description"></textarea>
								</div>
								</div>
							</li>
	 						...
	 						<li>
								<div class="form_grid_12">
								<label class="field_title" for="shipping_policies">Shipping & Policies</label>
								<div class="form_input">
								<textarea name="shipping_policies" id="shipping_policies" tabindex="3" style="width:370px;" class="large tipTop" title="Please enter the product shipping policies"></textarea>
								</div>
								</div>
							</li>
	 						...
	 						<li>
								<div class="form_grid_12">
								<label class="field_title" for="xchange_policy">Exchange Policy</label>
								<div class="form_input">
								<textarea name="xchange_policy" id="xchange_policy" tabindex="3" style="width:370px;" class="large tipTop" title="Please enter the product exchange policy"></textarea>
								</div>
								</div>
							</li>
                            ...
                            <li>
                             ...
                             <li>
								<div class="form_grid_12">
								<label class="field_title" for="youtube">Youtube Link</label>
								<div class="form_input">
								<input type="text" name="youtube" id="youtube" tabindex="11" class="large tipTop" title="Please enter the youtube link" />
								</div>
								</div>
							</li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<div class="publish_unpublish">
											<input type="checkbox" tabindex="12" name="status" checked="checked" id="publish_unpublish_publish" class="publish_unpublish"/>
										</div>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									<div class="form_input">
										<input type="button" class="btn_small btn_blue nxtTab" tabindex="13" value="Next"/>
									</div>
								</div>
								</li>
							</ul>
