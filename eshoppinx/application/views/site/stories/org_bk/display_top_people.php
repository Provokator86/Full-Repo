        	...
        	<div class="section_main">
            	...
            	<div class="main2">
                	...
                	<div class="main_box">
                    	...
                    	<h2><?php if($this->lang->line('shop_toppeple') != '') { echo stripslashes($this->lang->line('shop_toppeple')); } else echo "Top people on"; ?> <?php echo $site_Title; ?></h2>
                            	...
                            	<div class="follow_main" style="height: 360px;">
                                    ...
                                    <div class="left_follow" style="width:300px;">
                                      ...
                                      ?>
                                            ...
                                            <li><a href="things/<?php echo $store_products->PID;?>/<?php echo url_title($store_products->product_name,'-');?>"><img src="images/product/thumb/<?php echo $prodImg;?>" /></a></li>
                                      <?php 
                                      	}
                                      }
                                      ?>                  
