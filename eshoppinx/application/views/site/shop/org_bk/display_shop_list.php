	...
	<div class="container shoppage">
        ...
        ?>   
            <div class="shop_browse">
            	...
            	<span><?php if($this->lang->line('shop_browse') != '') { echo stripslashes($this->lang->line('shop_browse')); } else echo "Browse"; ?></span>
...
//                	$cat_img = base_url().'images/no_image.gif';
 ...
 <?php 
				...
				<div class="might-fancy">
					<span style="font-size:18px;"><?php if($this->lang->line('shop_whatsnew') != '') { echo stripslashes($this->lang->line('shop_whatsnew')); } else echo "What's New"; ?> <a style="margin-left: 10px;font-size:12px;" href="shopby/all"><?php if($this->lang->line('shop_seemore') != '') { echo stripslashes($this->lang->line('shop_seemore')); } else echo "See more"; ?></a></span>
