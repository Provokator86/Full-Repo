				...
				<dl>
					...
					<dd>
						<ul class="contributors-list">
							<li><a href="user/<?php echo $user_profile_details->row()->user_name;?>"><span class="thum"><img src="images/users/<?php if ($user_profile_details->row()->thumbnail != ''){echo $user_profile_details->row()->thumbnail;}else {echo 'user-thumb1.png';}?>" alt="<?php echo $user_profile_details->row()->full_name;?>" /></span><?php echo $user_profile_details->row()->full_name;?></a><small>Creator</small></li>
							
						</ul>
<!-- 						<div class="contributors-add">
							<input id="contributor-username" type="text" placeholder="+Add someone" />
							<ul class="user-list" style="display:none;">
								<li><img src="/_ui/images/common/blank.gif"><!--user image--><b><!--full name--></b><small><!--username--></small></li>
<!-- 							</ul>
						</div>
	 -->				</dd>
				</dl>
