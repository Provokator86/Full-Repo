 ...
 <div class="main_box">
		...
		?>
			<div class="review_top">
				<p class="fl"><span class="r_left fl"><?php if($this->lang->line('user_order_id') != '') { echo stripslashes($this->lang->line('user_order_id')); } else echo "Order Id"; ?> : </span><span class="fl">#<?php echo $order_details->row()->dealCodeNumber;?></span></p>
				<p class="fr"><span class="r_left fl"><?php if($this->lang->line('user_sub_totla') != '') { echo stripslashes($this->lang->line('user_sub_totla')); } else echo "Sub Total"; ?> : </span><span class="fl"><?php echo $currencySymbol.number_format($subTotal,2);?></span></p>
				<div style="clear: both;"></div>
				<p class="fl"><span class="r_left fl"><?php if($this->lang->line('user_order_date') != '') { echo stripslashes($this->lang->line('user_order_date')); } else echo "Order Date"; ?> : </span><span class="fl"><?php echo $order_details->row()->created;?></span></p>
				...
				<p class="fr" style="width:100%;text-align:right;"><span class="r_left" style="clear:both;"><?php if($this->lang->line('user_grand_total') != '') { echo stripslashes($this->lang->line('user_grand_total')); } else echo "Grand Total"; ?> : </span><span class=""><?php echo $currencySymbol.$order_details->row()->total;?></span></p>
			</div>
<!-- 			<hr class="review_hr"> -->
		<?php 
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="float:left;border:1px solid #cecece; width:99.5%;">
		        <tbody>
			        <tr bgcolor="#f3f3f3">
			            ...
			            <td width="42%" style="border-right:1px solid #cecece;text-align:center;"><span style="font-size:12px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; color:#000000; line-height:38px; text-align:center;"><?php if($this->lang->line('user_prod_name') != '') { echo stripslashes($this->lang->line('user_prod_name')); } else echo "Product Name"; ?></span></td>
			            <td width="8%" style="border-right:1px solid #cecece;text-align:center;"><span style="font-size:12px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; color:#000000; line-height:38px; text-align:center;"><?php if($this->lang->line('user_qty') != '') { echo stripslashes($this->lang->line('user_qty')); } else echo "Qty"; ?></span></td>
			            <td width="10%" style="border-right:1px solid #cecece;text-align:center;"><span style="font-size:12px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; color:#000000; line-height:38px; text-align:center;"><?php if($this->lang->line('user_unit_price') != '') { echo stripslashes($this->lang->line('user_unit_price')); } else echo "Unit Price"; ?></span></td>
			            <td width="10%" style="text-align:center;border-right:1px solid #cecece;"><span style="font-size:12px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; color:#000000; line-height:38px; text-align:center;"><?php if($this->lang->line('user_sub_totla') != '') { echo stripslashes($this->lang->line('user_sub_totla')); } else echo "Sub Total"; ?></span></td>
			            <td width="20%" style="text-align:center;border-right:1px solid #cecece;"><span style="font-size:12px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; color:#000000; line-height:38px; text-align:center;"><?php if($this->lang->line('user_rec_status') != '') { echo stripslashes($this->lang->line('user_rec_status')); } else echo "Received Status"; ?></span></td>
                         <?php 
                        	if ($view_mode!='seller'){
                        	?>	  
                        <td width="20%" style="text-align:center;"><span style="font-size:12px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; color:#000000; line-height:38px; text-align:center;"><?php if($this->lang->line('user_reviews_status') != '') { echo stripslashes($this->lang->line('user_reviews_status')); } else echo "Reviews"; ?></span></td>
                        <?php } ?>
			         </tr><tr>
...
<!-- 	                        	<option <?php if ($orderRow->received_status == 'Need refund'){echo 'selected="selected"';}?> value="Need refund"><?php if($this->lang->line('order_need_refund') != '') { echo stripslashes($this->lang->line('order_need_refund')); } else echo "Need refund"; ?></option> -->
	                    ...
	                    <?php }?> 
                        	...
                        	if ($view_mode!='seller'){
                        	?>	
                        <td style="text-align:center;border-top:1px solid #cecece;border-left:1px solid #cecece;"><span style="font-size:13px; font-family:Arial, Helvetica, sans-serif; font-weight:normal; color:#000000; line-height:30px;  text-align:center;"><a href="feedback/<?php echo $orderRow->product_id; ?>"><?php if($this->lang->line('review') != '') { echo stripslashes($this->lang->line('review')); } else echo "review"; ?></a></span>
			            </td>
                        <?php } ?>
			        </tr>
		        </tbody>
	        ...
	        <div class="review_comments" style="float: left;">
				...
				if ($cmt_count==0){
				?>
				<p style="margin: 10px 0 0;color: #0F6697;"><i><?php if($this->lang->line('user_no_comments') != '') { echo stripslashes($this->lang->line('user_no_comments')); } else echo "No comments available"; ?></i></p>
				<?php 	
				}
	        	 }else {
				?>
	      ...
	      ?>  
	       <?php }else{?>
	       <h3><?php if($this->lang->line('user_review_no') != '') { echo stripslashes($this->lang->line('user_review_no')); } else echo "Reviews not available"; ?></h3>
	       <?php }?> 
		</div>
