                            ...
                            <div class="store_list">
                            	...
                            	<div class="follow_main" style="height: 360px;">
                                    ...
                                    <div class="left_follow" style="width:300px;">
                                        ...
                                        <a class="follow_icon_links" href="user/<?php echo $store_list->user_name;?>" style="width:75%;overflow:hidden;height:20px;text-align: left;"><?php echo $store_name;?></a>
...
?>     
<p><?php if($this->lang->line('shop_nopeopleavail') != '') { echo stripslashes($this->lang->line('shop_nopeopleavail')); } else echo "No people available"; ?></p>
<?php 
}
?>                   
                        </div>
