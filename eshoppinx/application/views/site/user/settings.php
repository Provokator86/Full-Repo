    ...
    <div id="mid-panel">
        <div class="wrapper">
            <div class="container set_area" style="padding:30px 0 20px">       
                ...
                ?>
                <div class="confirm-email" style="float:left;width: 90%;">
                ...
                <input name="csrfmiddlewaretoken" value="mozhx45soLtfiGS8FS13XwTTPf1zqOxt" type="hidden">
                ...
                <div class="section photo">
	                ...
	                <fieldset class="frm">
		                ...
		                <div class="photo-func">		
			                ...
			                <input type="button" style="cursor: pointer;" class="btn-change" onClick="$('.photo-func').hide();$('.upload-file').show();return false;" value="Upload Photo"/>
			                <?php }else {?>
			                <input type="button" style="cursor: pointer;" class="btn-change" onClick="$('.photo-func').hide();$('.upload-file').show();return false;" value="Change Photo"/>
			                <input type="button" style="cursor: pointer;" class="btn-delete" id="delete_profile_image" onClick="return deleteUserPhoto();" value="Delete Photo"/>
			                <?php }?>
		                </div>
		                <div class="upload-file">
			                ...
			                <input type="button" style="cursor: pointer;" class="btn-upload" id="save_profile_image" onclick="return updateUserPhoto();" value="Upload Photo"/>
			                <input type="button" style="cursor: pointer;" class="btn-cancel" onClick="$('.photo-func').show();$('.upload-file').hide();return false;" value="Cancel"/>
		                </div>
		                <small class="comment" style="float: left;"><?php if($this->lang->line('settings_profile_identy') != '') { echo stripslashes($this->lang->line('settings_profile_identy')); } else echo "Your profile photo is your identity on"; ?> <?php echo $siteTitle;?>, <?php if($this->lang->line('settings_pickone') != '') { echo stripslashes($this->lang->line('settings_pickone')); } else echo "so pick a good one that expresses who you are."; ?></small>
	                </fieldset>
                </div>

                <div class="btn-area">
	                <!-- <button class="btn-save" id="save_account">Save Profile</button> -->
