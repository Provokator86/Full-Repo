		...
		<?php } ?>
                		<!--<div class="tab_product">
                        	...
                        	<ul class="tab_box">
                            	...
                            	<li><a class="tab_active" href="myfeed"><?php if($this->lang->line('trending_myfeed') != '') { echo stripslashes($this->lang->line('trending_myfeed')); } else echo "My Feed"; ?></a></li>
                                
                                <li><a href="trending"><?php if($this->lang->line('trending_trend') != '') { echo stripslashes($this->lang->line('trending_trend')); } else echo "Trending"; ?></a></li>
                            ...
                            <ul class="right_tab">
                            	...
                            	<li><a class="find_btn" href="people"><img src="images/find-people.png" class="btn-icon" /><?php if($this->lang->line('cart_find_people') != '') { echo stripslashes($this->lang->line('cart_find_people')); } else echo "Find People"; ?></a></li>
                                
                                <li><a class="find_btn" href="stores"><img src="images/find-store.png"  class="btn-icon" /><?php if($this->lang->line('cart_find_stores') != '') { echo stripslashes($this->lang->line('cart_find_stores')); } else echo "Find Stores"; ?></a></li>
                        ...
                        <div class="product_main">
                			...
                			<?php 
	                			foreach ($product_details as $products_list_row){
									...
									if ($product_owners[$products_list_row->user_id]->thumbnail != ''){
										$userImg = $product_owners[$products_list_row->user_id]->thumbnail;
									} 
		                			if (isset($products_list_row->web_link)){
	            						$prod_link = 'user/'.$product_owners[$products_list_row->user_id]->user_name.'/things/'.$products_list_row->seller_product_id.'/'.url_title($products_list_row->product_name,'-');
	            					}else {
