...
<!-- 			<h4><?php if($this->lang->line('credit_history') != '') { echo stripslashes($this->lang->line('credit_history')); } else echo "Credits History"; ?></h4> -->
			...
			<div class="simple">
                ...
                <div class="credit_amount_nohistory"><?php if($this->lang->line('credit_no_history') != '') { echo stripslashes($this->lang->line('credit_no_history')); } else echo "No history found."; ?></div>
