            ...
            <?php 
                ...
                <div class="box">
                    <div class="box_head">
                        ...
                        <span><?php echo $followingUserRow->followers_count;?> <?php if($this->lang->line('display_followers') != '') { echo stripslashes($this->lang->line('display_followers')); } else echo "Followers"; ?></span>
