		        ...
		        ?>
                    ...
                    <div class="tab_product">
                        ...
                        <ul class="tab_box">
                            ...
                            <li><a class="tab_active" href="user/<?php echo $userProfileDetails->row()->user_name;?>/added"><strong></strong><span><?php if($this->lang->line('display_added') != '') { echo stripslashes($this->lang->line('display_added')); } else echo "Added"; ?></span></a></li>
                            ...
                            <?php if($userProfileDetails->row()->group=='Seller') { ?>
								<li><a href="user/<?php echo $userProfileDetails->row()->user_name;?>/trending"><strong></strong><span>Trending</span></a></li>
                            <?php } ?>
