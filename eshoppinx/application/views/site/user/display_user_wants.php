 ...
 -->              </ul>
      ...
      <aside id="sidebar">
        ...
        ?>
          <div class="profile"> 
          <span class="avatar">
          <span id="user-photo-container"><img src="images/users/<?php echo $userImg;?>" />
          ...
          <?php }?>	
            ...
            <p class="location"><?php echo $userProfileDetails->row()->location;?>&nbsp;.&nbsp;<a href="<?php echo $userProfileDetails->row()->web_url;?>" target="_blank"><?php echo $userProfileDetails->row()->web_url;?></a></p>
            <p class="bio"><?php echo $userProfileDetails->row()->about;?></p>
          </div>
          <ul class="sns-list">
            <li><a href="<?php echo $userProfileDetails->row()->facebook;?>" target="_blank"><span class="icon ic-fb"></span> <?php if($this->lang->line('signup_facebook') != '') { echo stripslashes($this->lang->line('signup_facebook')); } else echo "Facebook"; ?></a></li>
            <li><a href="<?php echo $userProfileDetails->row()->twitter;?>" target="_blank"><span class="icon ic-tw"></span> <?php if($this->lang->line('signup_twitter') != '') { echo stripslashes($this->lang->line('signup_twitter')); } else echo "Twitter"; ?></a></li>
            <li><a href="<?php echo $userProfileDetails->row()->google;?>" target="_blank"><span class="icon ic-gg"></span> <?php if($this->lang->line('signup_twitter') != '') { echo stripslashes($this->lang->line('signup_twitter')); } else echo "Twitter"; ?></a></li>
          </ul>
<!--           <a href="#" class="rank" onMouseOver="var x = $(this).position();$(this).parents('.user-cover').find('.tooltip-pop').css('left',x.left+($(this).width()/2)-95+'px').show();" onMouseOut="$(this).parents('.user-cover').find('.tooltip-pop').hide();">85 rank</a>
      -->     <div class="tooltip-pop"><b><?php echo $siteTitle;?> <?php if($this->lang->line('display_rank') != '') { echo stripslashes($this->lang->line('display_rank')); } else echo "Rank"; ?></b> <span><?php if($this->lang->line('display_popularity') != '') { echo stripslashes($this->lang->line('display_popularity')); } else echo "Your rank is a real-time popularity score of the things you've added to"; ?> <?php echo $siteTitle;?>.</span> <span><?php if($this->lang->line('display_higher_rank') != '') { echo stripslashes($this->lang->line('display_higher_rank')); } else echo "The more popular your things, the higher your rank"; ?>.</span></div>
          <ul class="followers">
