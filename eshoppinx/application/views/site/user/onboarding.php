...
<div class="popup onboarding animated" style="margin:139px auto 7px; display: block; opacity: 1;">
	...
	<div class="step step1" style="display:none">
		<p class="tit"><b><?php echo $userDetails->row()->full_name;?>, <?php if($this->lang->line('onboarding_what_love') != '') { echo stripslashes($this->lang->line('onboarding_what_love')); } else echo "tell us what you love"; ?></b><br><?php if($this->lang->line('onboarding_select_one') != '') { echo stripslashes($this->lang->line('onboarding_select_one')); } else echo "Select at least one category to get started"; ?>.</p>
    ...
    <div style="display:none" class="step step2">
		<p class="tit" style="box-shadow: none; border-color: rgb(235, 236, 239);"><b><?php echo LIKE_BUTTON;?> <?php if($this->lang->line('onboarding_thinks_like') != '') { echo stripslashes($this->lang->line('onboarding_thinks_like')); } else echo "the things you like"; ?></b><br><?php echo LIKE_BUTTON;?> <?php if($this->lang->line('onboarding_person_catalog') != '') { echo stripslashes($this->lang->line('onboarding_person_catalog')); } else echo "a few things to save them to your personal catalog"; ?>.</p>
	...
	<div style="display:none;" class="step step3">
		<p class="tit"><b><?php if($this->lang->line('onboarding_follow') != '') { echo stripslashes($this->lang->line('onboarding_follow')); } else echo "Follow"; ?> <?php echo $siteTitle;?> <?php if($this->lang->line('onboarding_people') != '') { echo stripslashes($this->lang->line('onboarding_people')); } else echo "people"; ?></b><br><?php if($this->lang->line('onboarding_discover') != '') { echo stripslashes($this->lang->line('onboarding_discover')); } else echo "Follow a few top contributors to discover great things"; ?>.</p>
		<div class="txt">
				...
				<ul>
                    ...
                    <?php if ($mainCategories->num_rows()>0){?>
                        <span><?php if($this->lang->line('onboarding_category') != '') { echo stripslashes($this->lang->line('onboarding_category')); } else echo "Find by category"; ?></span>
                            ...
                            <li><a href="javascript:void(0)" cname="<?php echo url_title($catRow->cat_name,'-',TRUE);?>" class="category"><?php echo $catRow->cat_name;?></a></li>
...
<!-- 			<button class="btns-blue-embo btn-next">Next</button>
	...
	<div style="display:none" class="step step4">
     ...
     <?php 
	   		$onboarding_search_services = str_replace("{SITETITLE}",$siteTitle,$this->lang->line('onboarding_search_services'));
			
	   ?>
    
   
    
		<p class="tit"><b <?php if($this->lang->line('onboarding_search_services') != '') { echo $onboarding_search_services; } else echo "Find friends on ". $siteTitle." </b><br>Search services you use to find friends which already are on"; ?>> <?php echo $siteTitle;?>.</p>
		<div class="txt"><div class="scroll">
			<div class="intxt">
				<dl class="sns-people">
					...
					<button class="btns-gray-embo facebook"><?php if($this->lang->line('onboarding_find_frds') != '') { echo stripslashes($this->lang->line('onboarding_find_frds')); } else echo "Find friends"; ?></button></dt>
                    <dd class="follow">
				...
				<dl class="sns-people">
					...
					<button class="close"><span class="tooltip"><small><b></b><?php if($this->lang->line('onboarding_close') != '') { echo stripslashes($this->lang->line('onboarding_close')); } else echo "Close"; ?></small></span></button>
					<button class="btns-gray-embo twitter"><?php if($this->lang->line('onboarding_find_frds') != '') { echo stripslashes($this->lang->line('onboarding_find_frds')); } else echo "Find friends"; ?></button></dt>
					<dd class="follow">
				...
				<dl class="sns-people">
					...
					<button class="close"><span class="tooltip"><small><b></b><?php if($this->lang->line('onboarding_close') != '') { echo stripslashes($this->lang->line('onboarding_close')); } else echo "Close"; ?></small></span></button>
					<button id="fancy-gplus-link" class="btns-gray-embo" data-gapiattached="true"><?php if($this->lang->line('onboarding_find_frds') != '') { echo stripslashes($this->lang->line('onboarding_find_frds')); } else echo "Find friends"; ?></button></dt>
					<dd class="follow">
				...
				<dl class="sns-people">
					...
					<button class="close"><span class="tooltip"><small><b></b><?php if($this->lang->line('onboarding_close') != '') { echo stripslashes($this->lang->line('onboarding_close')); } else echo "Close"; ?></small></span></button>
					<button class="btns-gray-embo gmail"><?php if($this->lang->line('onboarding_find_frds') != '') { echo stripslashes($this->lang->line('onboarding_find_frds')); } else echo "Find friends"; ?></button></dt>
                    <dd class="follow">
                ...
                <p class="sns-notify"><?php if($this->lang->line('onboarding_choose_srvce') != '') { echo stripslashes($this->lang->line('onboarding_choose_srvce')); } else echo "Choosing a service will open a window for you to log in securely and import your contacts to"; ?> <?php echo $siteTitle;?>.</p>
			</div>
		</div></div>
		<div class="btn-area">
			<button class="btns-blue-embo btn-close"><?php if($this->lang->line('onboarding_finish') != '') { echo stripslashes($this->lang->line('onboarding_finish')); } else echo "Finish"; ?></button>
...
<!-- Section_start -->
<script src="js/<?php echo SITE_COMMON_DEFINE; ?>filescatalog.js" type="text/javascript"></script>
<script src="js/jquery-1.7.1.min.js" type="text/javascript"></script>
<script src="js/site/fancyy-filesjquery-ui-1.js" type="text/javascript"></script>
<script src="js/site/fancyy-filesjquery_002.js" type="text/javascript"></script>
<script src="js/site/fancyy-filesjquery.js" type="text/javascript"></script>
