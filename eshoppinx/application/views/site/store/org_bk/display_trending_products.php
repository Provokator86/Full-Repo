				...
				?>
					<!--<div class="profile_main">
						...
						<div class="profile_right" style="width: auto;">
							...
							<ul class="profile_right_links">
								...
								<li><a
									href="<?php echo base_url();?>store/<?php echo $store_details->row()->store_name;?>/followers"><strong><?php echo $store_details->row()->followers_count;?>
                    ...
                    <div class="tab_product">
                        ...
                        <ul class="tab_box">
                            ...
                            <li><a class="tab_active"><strong></strong><span><?php if($this->lang->line('trending_trend') != '') { echo stripslashes($this->lang->line('trending_trend')); } else echo "Trending"; ?></span></a></li>
