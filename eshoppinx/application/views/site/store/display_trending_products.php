    ...
    <div class="wrapper">
        ...
        <div class="trending">
            <div class="trending_lft">
                <ul class="tabs">
                    <li ><a href="<?php echo base_url();?>store/<?php echo $store_details->row()->store_url;?>"> <span>&nbsp;</span><?php if($this->lang->line('templates_products') != '') { echo stripslashes($this->lang->line('templates_products')); } else echo "Products"; ?></a></li>
                    <li class="active"><a href="<?php echo base_url();?>store/<?php echo $store_details->row()->store_url;?>/trending"><span>&nbsp;</span><?php if($this->lang->line('trending_trend') != '') { echo stripslashes($this->lang->line('trending_trend')); } else echo "Trending"; ?></a></li>
                </ul>
                <div class="clear"></div>
            </div>
            <div class="clear"></div>
