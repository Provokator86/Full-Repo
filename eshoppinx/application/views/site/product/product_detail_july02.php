...
return false;
        ...
        <div class="product-attribution-container yellow">
      <div class="container">
        <div class="inner-container">
          ...
          <div class="product-attribution-container-info">
            ...
            <abbr title="" class="timeago"><?php if($this->lang->line('settings_about') != '') { echo stripslashes($this->lang->line('settings_about')); } else echo "about"; ?> <?php $time_ago1 =strtotime($productDetails->row()->created); echo time_stamp($time_ago1); ?></abbr>
           </div>
        ...
        <div class="detail_save"> <input style="opacity: 1;" type="button" class="buy_btn <?php if ($loginCheck==''){echo 'sign_box';}else{?>contact_seller_btn<?php }?>" value="Contact Seller" /></div>
        <?php  
...
<?php if ($productDetails->row()->user_id != $loginCheck){?><a class="right <?php if ($loginCheck==''){echo 'sign_box';}?>  <?php echo $followClass;?>" href="javascript:void(0);" <?php if ($loginCheck != ''){?>data-uid="<?php echo $productDetails->row()->user_id;?>" onclick="javascript:store_follow(this);"<?php }?>><?php echo $followText;?></a><?php }?> 
...
<?php 
echo preg_replace("/#(\w+)/", "<a target=\"_self\" href=\"".base_url()."tag/$1\">#$1</a>", $cmtrow->comments);
?> 
...
<?php echo preg_replace("/#(\w+)/", "<a target=\"_self\" href=\"".base_url()."tag/$1\">#$1</a>", $cmtrow->comments);?> 
</p> <span class="comments_detail_day"><?php  $time_ago =strtotime($cmtrow->dateAdded);
echo time_stamp($time_ago); ?> </span> </div>
<p style="float:left;width:100%;text-align:left;">
