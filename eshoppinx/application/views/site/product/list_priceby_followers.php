					...
					<li class="menu-container"><a href="" class="menu-title btn btn-gray"><span><?php if($this->lang->line('product_extlinks') != '') { echo stripslashes($this->lang->line('product_extlinks')); } else echo "Extra Links"; ?></span></a>
						<div class="menu-content">
							...
							<ul class="list-option">
								<li><a href="<?php echo base_url();?>giftguide/list/<?php echo $list_details->row()->id;?>/followers" lid="<?php echo $list_details->row()->id;?>" loid="3462155" list_name="$<?php echo $list_details->row()->list_value;?>" class="btn-list-share"><?php if($this->lang->line('header_share') != '') { echo stripslashes($this->lang->line('header_share')); } else echo "Share"; ?></a></li>
							</ul>
						</div>
					</li>
...
<div id="content" class="wrapper-content content timeline">
	<header>
		<ul class="stats-list tab">
			<li><a href="giftguide/list/<?php echo $list_details->row()->id;?>"><?php if($this->lang->line('user_things') != '') { echo stripslashes($this->lang->line('user_things')); } else echo "Things"; ?><strong><?php echo $list_details->row()->product_count;?></strong></a></li>
