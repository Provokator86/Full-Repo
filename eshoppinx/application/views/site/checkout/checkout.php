...
<?php if($flash_data != '') { ?>
   ...
   <!-- Section_start -->
                ...
                <div class="main_box">    
                		<div class="tab_product">
                        	...
                        	<ul class="tab_box">
                            	...
                            	<li><a class="tab_active" href="checkout/cart"><?php if($this->lang->line('common_checkout') != '') { echo stripslashes($this->lang->line('common_checkout')); } else echo "Check out"; ?></a></li>	                                
        ...
        <?php if ($paypal_ipn_settings['status'] == 'Enable'){?>
	      <li class="depth1 current" id="dep1"><span><?php echo $payMethodCount;?></span><a onclick="javascript:paypal();" class="current"><?php if($this->lang->line('checkout_paypal') != '') { echo stripslashes($this->lang->line('checkout_paypal')); } else echo "Paypal"; ?></a></li>
        <?php 
        $payMethodCount++;
        }
        if ($authorize_net_settings['status'] == 'Enable'){
        ?>
	      <li class="depth2" id="dep2"><span><?php echo $payMethodCount;?></span><a onclick="javascript:creditcard();"><?php if($this->lang->line('checkout_credit_card') != '') { echo stripslashes($this->lang->line('checkout_credit_card')); } else echo "Credit Card"; ?></a></li>
	    <?php 
			...
			<div class="cart-payment-wrap card-payment new-card-payment" id="PaypalPay" style="display:<?php if ($paypal_ipn_settings['status'] == 'Enable'){echo 'block';}else {echo 'none';}?>;">
                    ...
                    <input type="hidden" name="paypalEmail" id="paypalEmail" value="<?php echo $paypalProcess['merchant_email']; ?>"  />                        
						...
						<div id="complete-payment">
							...
							<input name="PaypalSubmit" id="PaypalSubmit" class="start_btn_2" type="submit" value="<?php if($this->lang->line('checkout_comp_pay') != '') { echo stripslashes($this->lang->line('checkout_comp_pay')); } else echo "Complete Payment"; ?>" style="cursor:pointer;"  />
						...
						<div id="complete-payment">
                                    ...
                                    <label for="payment-personal-name-fst"><?php if($this->lang->line('header_name') != '') { echo stripslashes($this->lang->line('header_name')); } else echo "Name"; ?> <b>*</b></label>
                                        ...
                                        <label for="payment-card-number"><?php if($this->lang->line('checkout_card_no') != '') { echo stripslashes($this->lang->line('checkout_card_no')); } else echo "Card Number"; ?> <b>*</b></label>
                                         ...
                                         <label for="payment-card-number"><?php if($this->lang->line('checkout_card_type') != '') { echo stripslashes($this->lang->line('checkout_card_type')); } else echo "Card Type"; ?> <b>*</b></label>
                                            ...
                                            <option value="Amex"><?php if($this->lang->line('checkout_ameexp') != '') { echo stripslashes($this->lang->line('checkout_ameexp')); } else echo "American Express"; ?></option>
                                            <option value="Visa"><?php if($this->lang->line('checkout_visa') != '') { echo stripslashes($this->lang->line('checkout_visa')); } else echo "Visa"; ?></option>
                                            <option value="MasterCard"><?php if($this->lang->line('checkout_master_card') != '') { echo stripslashes($this->lang->line('checkout_master_card')); } else echo "Master Card"; ?></option>
                                            <option value="Discover"><?php if($this->lang->line('checkout_discover') != '') { echo stripslashes($this->lang->line('checkout_discover')); } else echo "Discover"; ?></option>
                                            </select>
                                        ...
                                        <?php $Sel ='selected="selected"';  ?>
											<select id="CCExpDay" name="CCExpDay" class="select-round select-white select-date selectBox required" style="width: auto;">
											...
											<select id="CCExpMnth" name="CCExpMnth" class="select-round select-white select-date selectBox required" style="width: auto;">
                                        ...
                                        <label for="payment-card-security"><?php if($this->lang->line('checkout_security_code') != '') { echo stripslashes($this->lang->line('checkout_security_code')); } else echo "Security Code"; ?></label>
											...
											<a href="javascript:void(0);" class="tooltip" onClick="$('.card-back').show();return false;"><?php if($this->lang->line('checkout_what_this') != '') { echo stripslashes($this->lang->line('checkout_what_this')); } else echo "What is this?"; ?></a>
											...
											<dl class="card-back">
                                                <dt style="padding: 10px 0;"><?php if($this->lang->line('checkout_cvc_cvs') != '') { echo stripslashes($this->lang->line('checkout_cvc_cvs')); } else echo "Security Code (CVC or CVS)"; ?></dt>
												<dd>
													<img src="images/card-back.gif" alt="" style="float:left;margin-right:10px;">
							...
							<div class="cart-payment">
                             ...
                             <?php if ($authorize_net_settings['status'] == 'Enable'){ ?>
                              ...
                              <?php } ?>
							<input name="CreditSubmit" id="CreditSubmit" class="button-complete start_btn_2" type="submit" value="<?php if($this->lang->line('checkout_comp_pay') != '') { echo stripslashes($this->lang->line('checkout_comp_pay')); } else echo "Complete Payment"; ?>" style="cursor:pointer;"  />
         ...
         <?php  }else{ ?>
			...
			<form name="PaymentPaypalForm" id="PaymentPaypalForm" method="post" enctype="multipart/form-data" action="site/checkout/PaymentGiftFree" autocomplete="off">
						<div id="complete-payment">
							...
							<input name="PaypalSubmit" id="PaypalSubmit" class="start_btn_2" type="submit" value="<?php if($this->lang->line('checkout_comp_purchas') != '') { echo stripslashes($this->lang->line('checkout_comp_purchas')); } else echo "Complete Purchase"; ?>" style="cursor:pointer;"  />
							<!--<div class="waiting"><?php if($this->lang->line('checkout_processing') != '') { echo stripslashes($this->lang->line('checkout_processing')); } else echo "Processing"; ?>...</div>
							<div class="card-payment-foot"><?php if($this->lang->line('checkout_by_place') != '') { echo stripslashes($this->lang->line('checkout_by_place')); } else echo "By placing your order, you agree to the Terms"; ?> &amp; <?php if($this->lang->line('checkout_codtn_privacy') != '') { echo stripslashes($this->lang->line('checkout_codtn_privacy')); } else echo "Conditions and Privacy Policy"; ?>.</div>-->
...
-->		
		...
		?>       
            ...
            <div class="cart-payment-wrap card-payment new-card-payment" id="CreditCardPay" style="display:<?php if ($paypal_ipn_settings['status'] == 'Disable' && $authorize_net_settings['status'] == 'Enable'){echo 'block';}else {echo 'none';}?>;"> 
					 ...
					 <script>$(document).ready(function(){	$("#PaymentSubscribeForm").validate();
					  ...
					  $.validator.addMethod("ValidZipCode", function( value, element ) {
						...
						<div id="complete-payment">
							...
							<input name="CreditSubscribeSubmit" id="CreditSubscribeSubmit" class="button-complete start_btn_2" type="submit" value="<?php if($this->lang->line('checkout_comp_pay') != '') { echo stripslashes($this->lang->line('checkout_comp_pay')); } else echo "Complete Payment"; ?>" style="cursor:pointer;"  />
