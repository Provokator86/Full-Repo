...
<div style='display:none'>
  ...
  <div id='inline_example10' style='background:#fff;'>
  		...
  		<div class="popup_page">
            ...
            <div class="post_product">
            	...
            	<a class="example19" href="#"><div class="post_product_img"><img src="images/post-product-icon.png" /></div>
                	<span><?php if($this->lang->line('templates_post_prod') != '') { echo stripslashes($this->lang->line('templates_post_prod')); } else echo "Post a Product"; ?></span>
            ...
            <div class="post_product" style="border-right:none;">
            
            	<a href="stories/new"><div class="post_product_img"><img src="images/post-story-icon.png" /></div>
                	<span><?php if($this->lang->line('story_poststory') != '') { echo stripslashes($this->lang->line('story_poststory')); } else echo "Post a Story"; ?></span>
  ...
  <div id='inline_example14' style='background:#fff;'>
  		...
  		<div class="popup_page">
            ...
            <div class="post_product">
            	...
            	<a class="example20" href="#"><div class="post_product_img"><img src="images/frm_web.png" /></div>
            ...
            <div class="post_product">
            	...
            	<a class="example21" href="#"><div class="post_product_img"><img src="images/upload.png" /></div>
            ...
            <div class="post_product" style="border-right:none;">
            	...
            	<a href="mailto:<?php echo $this->config->item('email');?>"><div class="post_product_img"><img src="images/email.png" /></div>
...
<div style='display:none'>
  ...
  <div id='inline_example15' style='background:#fff;'>
  		...
  		<div class="popup_page">
            ...
            <div class="post_product" style="border-right:none;">
            	<span class="popup_stay"><?php if($this->lang->line('templates_enter_link') != '') { echo stripslashes($this->lang->line('templates_enter_link')); } else echo "Enter a link or a website address"; ?></span>
                <input type="text" value="" placeholder="http://" style="width:425px" class="signup_scroll_1 url_" />           	            
            	<input type="submit" class="start_btn_1" onclick="fetch_images(this);" value="<?php if($this->lang->line('templates_submit') != '') { echo stripslashes($this->lang->line('templates_submit')); } else echo "Submit"; ?>">
...
<div style='display:none'>
  ...
  <div id='inline_example16' style='background:#fff;'>
  		...
  		<div class="popup_page">
            ...
            <div class="post_product" style="border-right:none; padding:0px 0px 15px 0px">
            	<span class="popup_stay"><?php if($this->lang->line('templates_select_file') != '') { echo stripslashes($this->lang->line('templates_select_file')); } else echo "Select a file to upload"; ?>.</span>
                <input type="file"  class="signup_scroll_1" id="upload_product_img" style="width:425px" />           	            
            	<input type="submit" class="start_btn_1" id="upload_product" onclick="javascript:upload_product(this);" value="<?php if($this->lang->line('header_upload') != '') { echo stripslashes($this->lang->line('header_upload')); } else echo "Upload"; ?>">
                <span class="example22"></span>
                <a href="#" class="example19" style="float:right; margin:20px 20px 0;"><?php if($this->lang->line('signup_goback') != '') { echo stripslashes($this->lang->line('signup_goback')); } else echo "Go Back"; ?></a>
            </div>
