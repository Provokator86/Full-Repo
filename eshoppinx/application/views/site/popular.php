            	...
            	<div class="main3">
                		...
                		<div class="tab_product" >
                        	...
                        	<ul class="tab_box">
                              ...
                              <!--  <li><a class="tab_active" href="javascript:void(0);"><?php if($this->lang->line('header_recent') != '') { echo stripslashes($this->lang->line('header_recent')); } else echo "Recent"; ?></a></li>-->
                                         ...
                                         <div class="info_links">
                                        	...
                                        	<div class="cover boxcaption">
                                                      ...
                                                      <div class="deal_tag_title">
                                                      	...
                                                      	<h2> <a class="" data-pid="<?php echo $products_list_row->seller_product_id;?>" href="<?php echo $prod_link;?>"><?php echo character_limiter($products_list_row->product_name,25);?></a></h2>
