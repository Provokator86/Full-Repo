...
$ci =& get_instance();
//echo $ci->config->item('consumer_secret');die;
...
parent::__construct($ci->config->item('consumer_key'), $ci->config->item('consumer_secret'), $access_token['oauth_token'], $access_token['oauth_token_secret']);
...
parent::__construct($ci->config->item('consumer_key'), $ci->config->item('consumer_secret'), $request_token['oauth_token'], $request_token['oauth_token_secret']);
...
parent::__construct($ci->config->item('consumer_key'), $ci->config->item('consumer_secret'));
}
}
