...
define('STORIES', 						TBL_PREF.'stories');
define('STORIES_COMMENTS', 				TBL_PREF.'stories_comments');
define('CONTACTSELLER', 				TBL_PREF.'contact_seller');
define('TAGS_PRODUCT', 					TBL_PREF.'tags');
define('PRODUCT_FEEDBACK', 				TBL_PREF.'product_feedback');
define('FOOTER', 						TBL_PREF.'footer');
define('REPORT_ISSUES', 				TBL_PREF.'reportissues');
define('PRODUCT_ATTRIBUTE', 			TBL_PREF.'product_attribute');
define('SUBPRODUCT', 					TBL_PREF.'subproducts');
define('SHOPS',			 				TBL_PREF.'shops');
define('STORE_CLAIMS',	 				TBL_PREF.'store_claims');
################ below jan 2015 #########################
