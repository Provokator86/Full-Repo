...
if(file_exists(dirname(__FILE__)) . DIRECTORY_SEPARATOR . 'jscripts' . DIRECTORY_SEPARATOR . 'for_' . CONFIG_EDITOR_NAME . ".js")
{
	?>
<script type="text/javascript"
	src="jscripts/<?php echo 'for_' . CONFIG_EDITOR_NAME . '.js'; ?>"></script>
	<?php
}
?>
<link rel="stylesheet" type="text/css"
	href="theme/<?php echo CONFIG_THEME_NAME; ?>/css/ajaxfilemanager.css" />
<link rel="stylesheet" type="text/css"
	href="theme/<?php echo CONFIG_THEME_NAME; ?>/css/<?php echo CONFIG_EDITOR_NAME; ?>.css" />
<link rel="stylesheet" type="text/css"
	href="theme/<?php echo CONFIG_THEME_NAME; ?>/css/jquery-calendar.css" />
<link rel="stylesheet"
	href="theme/<?php echo CONFIG_THEME_NAME; ?>/css/thickbox.css"
...
<body>
	<div id="wrapper">
		<div id="header">
			<dl id="currentFolderInfo">
				<dt>
				<?php echo LBL_CURRENT_FOLDER_PATH; ?>
				</dt>
				<dd id="currentFolderPath">
				<?php echo $folderInfo['path']; ?>
				</dd>
			</dl>
			<div id="viewList">
				...
				{
					?>
				<input type="radio" name="view" class="radio"
					onclick="return changeView(this);" value="<?php echo $k; ?>"
					<?php echo ($k==$view?'checked':''); ?>> <?php echo $v; ?>
					&nbsp;&nbsp; <?php
				}
				?>
			...
			<ul id="actionHeader">
				<li><a href="#" id="actionRefresh" onclick="return windowRefresh();"><span><?php echo LBL_ACTION_REFRESH; ?>
					</span> </a></li>
				<li><a href="#" id="actionSelectAll" class="check_all"
					onclick="return checkAll(this);"><span><?php echo LBL_ACTION_SELECT_ALL; ?>
					</span> </a></li>
					<?php
				...
				<li><a href="#" id="actionDelete"
					onclick="return deleteDocuments();"><span><?php echo LBL_ACTION_DELETE; ?>
					</span> </a></li>
					<?php
					}
					?>
				...
				<li><a href="#" id="actionCut"
					onclick="return cutDocuments('<?php echo ERR_NOT_DOC_SELECTED_FOR_CUT; ?>');"><span><?php echo LBL_ACTION_CUT; ?>
					</span> </a></li>
					<?php
					}
					?>
				...
				<li><a href="#" id="actionCopy"
					onclick="return copyDocuments('<?php echo ERR_NOT_DOC_SELECTED_FOR_COPY; ?>');"><span><?php echo LBL_ACTION_COPY; ?>
					</span> </a></li>
					<?php
					}
					?>
				...
				<li><a href="#" id="actionPaste"
					onclick="return pasteDocuments('<?php echo ERR_NOT_DOC_SELECTED_FOR_PASTE; ?>');"><span><?php echo LBL_ACTION_PASTE; ?>
					</span> </a></li>
					<?php
					}
					?>
				...
				<li><a id="actionNewFolder" href="#"
					onclick="return newFolderWin(this);"><span><?php echo LBL_BTN_NEW_FOLDER; ?>
					</span> </a></li>
					<?php
					}
					?>
				...
				<li><a id="actionUpload" href="#"
					onclick="return uploadFileWin(this);"><span><?php echo LBL_BTN_UPLOAD; ?>
					</span> </a></li>
					<?php
					}
					?>
				...
				<li><a href="#" id="actionClose"
					onclick="return cancelSelectFile();"><?php echo IMG_BTN_CLOSE; ?> </a>
				</li>
				<li><a href="#" class="thickbox" id="actionInfo"
					onclick="return infoWin(this);"><span>Info</span> </a></li>
			...
			<form action="" method="post" name="formAction" id="formAction">
				<input type="hidden" name="currentFolderPath"
					id="currentFolderPathVal" value="" /><select name="selectedDoc[]"
					id="selectedDoc" style="display: none;" multiple="multiple"></select><input
					type="hidden" name="action_value" value="" id="action_value" />
			</form>
		</div>
		...
		<div id="body">
			...
			if(CONFIG_OPTIONS_SEARCH)
			{
				...
				<fieldset class="boxSearch">
					...
					<table cellpadding="0" cellspacing="0" class="tableSearch">
						<tbody>
							<tr>
								<td><b><?php echo LBL_SEARCH_NAME; ?> </b> <br /> <input
									type="text" class="input inputSearch" name="search_name"
									id="search_name" />
								</td>
							</tr>
							<tr>
								<td><b><?php echo LBL_SEARCH_FOLDER; ?> </b><br /> <span
									id="searchFolderContainer"> <?php
									if(CONFIG_LOAD_DOC_LATTER)
									{
										?> <script type="text/javascript">
	          				$(document).ready(
	          					function()
	          					{
									...
									{
										?> <select class="input inputSearch" name="search_folder"
										id="search_folder">
										<?php
										...
										foreach(getFolderListing(CONFIG_SYS_ROOT_PATH) as $k=>$v)
										{
											...
											<?php echo (removeTrailingSlash(backslashToSlash(($folderInfo['path']))) == removeTrailingSlash(backslashToSlash(($v)))?' selected="selected"':''); ?>>
												<?php echo shortenFileName($k, 30); ?>
											</option>
											<?php
										}
							...
							<tr>
								<td><b><?php echo LBL_SEARCH_MTIME; ?> </b><br /> <input
									type="text" class="input inputMtime" name="search_mtime_from"
									id="search_mtime_from"
									value="<?php echo (!empty($_GET['search_mtime_from'])?$_GET['search_mtime_from']:''); ?>" />
									<span class="leftToRightArrow">&nbsp;</span> <input type="text"
									class="input inputMtime" name="search_mtime_to"
									id="search_mtime_to"
							...
							<tr>
								<td><b><?php echo LBL_SEARCH_RECURSIVELY; ?> </b>&nbsp;&nbsp; <input
									type="radio" name="search_recursively" value="1"
									id="search_recursively_1" class="radio"
									<?php echo (!empty($_GET['search_recursively'])?'checked="checked"':''); ?> />
									<?php echo LBL_RECURSIVELY_YES; ?> <input type="radio"
									name="search_recursively" value="0" id="search_recursively_0"
									class="radio"
									<?php echo (empty($_GET['search_recursively'])?'checked="checked"':''); ?> />
									<?php echo LBL_RECURSIVELY_NO; ?>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<p class="searchButtons">
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="99%">&nbsp;</td>
								<td width="1%" nowrap style="padding-right: 16px;"><a href="#"
									onclick="return searchDocuments();" class="buttonLink"><span><?php echo BTN_SEARCH; ?>
									</span> </a>
								</td>
							</tr>
						</table>
			...
			?>
				...
				<fieldset id="folderFieldSet">
					...
					<legend>
					<?php echo LBL_FOLDER_INFO; ?>
					</legend>
					<table cellpadding="0" cellspacing="0" class="tableSummary"
						id="folderInfo">
						<tbody>
							<tr>
								<th><?php echo LBL_FOLDER_PATH; ?></th>
								<td colspan="3" id="folderPath"><?php echo transformFilePath($folderInfo['path']); ?>
								</td>
							</tr>
							<tr>
								<th><?php echo LBL_FOLDER_CREATED; ?></th>
								<td colspan="3" id="folderCtime"><?php echo (!empty($folderInfo['ctime'])?date(DATE_TIME_FORMAT,$folderInfo['ctime']):'&nbsp;') ; ?>
								</td>

							</tr>
							<tr>
								<th><?php echo LBL_FOLDER_MODIFIED; ?></th>
								<td colspan="3" id="folderMtime"><?php echo (!empty($folderInfo['mtime'])?date(DATE_TIME_FORMAT,$folderInfo['mtime']):'&nbsp;'); ?>
								</td>
							</tr>
							<tr>
								<th><?php echo LBL_FOLDER_SUDDIR; ?></th>
								<td colspan="3" id="folderSubdir"><?php echo (isset($folderInfo['subdir'])?$folderInfo['subdir']:"&nbsp;"); ?>
								</td>

							</tr>
							<tr>
								<th><?php echo LBL_FOLDER_FIELS; ?></th>
								<td colspan="3" id="folderFile"><?php echo (isset($folderInfo['file'])?$folderInfo['file']:'&nbsp;'); ?>
								</td>
							</tr>

							<tr>
								<th><?php echo LBL_FOLDER_WRITABLE; ?></th>
								<td id="folderWritable"><span
									class="<?php echo (isset($folderInfo['is_readable'])?($folderInfo['is_readable']?'flagYes':'flagNo'):'&nbsp;'); ?>">&nbsp;</span>
								</td>
								<th><?php echo LBL_FOLDER_READABLE; ?></th>
								<td id="folderReadable"><span
									class="<?php echo (isset($folderInfo['is_writable'])?($folderInfo['is_writable']?'flagYes':'flagNo'):'&nbsp;'); ?>">&nbsp;</span>
								</td>
					...
					<p class="searchButtons" id="returnCurrentUrl">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="99%">&nbsp;</td>
								<td width="1%" nowrap style="padding-right: 16px;"><a href="#"
									id="selectCurrentUrl" class="buttonLink"><span><?php echo MENU_SELECT; ?>
									</span> </a>
								</td>
							</tr>
						</table>
	...
	<div id="ajaxLoading" style="display: none">
		<img class="ajaxLoadingImg"
			src="theme/<?php echo CONFIG_THEME_NAME; ?>/images/ajaxLoading.gif" />
	</div>
			...
			<div class="jqmBody">
				<form id="formUpload" name="formUpload" method="post"
					...
					<table class="tableForm" cellpadding="0" cellspacing="0">
						<thead>
							<tr>
								<th colspan="4"><?php echo FILE_FORM_TITLE; ?><a class="action"
									href="#" title="<?php echo FILE_LBL_MORE;  ?>"
									onclick="return addMoreFile();"><span class="addMore">&nbsp;</span>
								</a></th>
							</tr>
						</thead>
						<tbody id="fileUploadBody">
							<tr style="display: none">
								...
								<td><input type="file" style="font-size: 12px" name="file" />
								</td>

								<td><a href="#" class="buttonLink"><span><?php echo FILE_LBL_UPLOAD; ?>
									</span> </a>
								</td>
								<td><a href="#" class="action" title="Cancel"
									style="display: none"><span class="cancel">&nbsp;</span> </a> <span
									class="uploadProcessing" style="display: none">&nbsp;<span>
	...
	<div id="winNewFolder" style="display: none">
		<div class="jqmContainer">
			<div class="jqmHeader">
				<a href="#" onclick="return tb_remove();"><?php echo LBL_ACTION_CLOSE; ?>
				</a>
			</div>
			<div class="jqmBody">
				<form id="formNewFolder" name="formNewFolder" method="post"
					action="">
					<input type="hidden" name="currentFolderPath" value=""
						id="currentNewfolderPath" />
					<table class="tableForm" cellpadding="0" cellspacing="0">
						<thead>
							<tr>
						...
						<tbody>
							<tr>
								...
								<td><input type="text" name="new_folder" style="font-size: 12px"
									id="new_folder" value="" class="input">
							...
							<tr>
								...
								<td nowrap>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="99%">&nbsp;</td>
											<td nowrap width="1%"><a href="#" class="buttonLink"
												onclick="return doCreateFolder();"><span><?php echo FOLDER_LBL_CREATE; ?>
												</span> </a>
											</td>
										</tr>
									</table>
	...
	<div id="winPlay" style="display: none">
		<div class="jqmContainer">
			<div class="jqmHeader">
				<a href="#" onclick="return closeWinPlay();"><?php echo LBL_ACTION_CLOSE; ?>
				</a>
			</div>
			<div class="jqmBody">
		...
		<div class="jqmContainer">
			...
			<div class="jqmBody">
				<form id="formRename" name="formRename" method="post" action="">
					<input type="hidden" name="original_path" id="original_path" /> <input
						type="hidden" name="num" id="renameNum" value="" />
					<table class="tableForm" cellpadding="0" cellspacing="0">
						<thead>
							<tr>
						...
						<tbody>
							<tr>
								...
								<td><input type="name" id="renameName" style="font-size: 12px"
									class="input" name="name" style="width:250px" />
								</td>
							</tr>
						</tbody>
						<tfoot>
								...
								<td nowrap>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="99%">&nbsp;</td>
											<td nowrap width="1%"><a href="#" class="buttonLink"
												onclick="return doRename();"><span><?php echo RENAME_LBL_RENAME; ?>
												</span> </a>
											</td>
										</tr>
									</table>
		...
		<div class="jqmContainer">
			...
			<div class="jqmBody">
				<table class="tableInfo" cellpadding="0" cellspacing="0">
					<tbody>
						<tr>
							<th nowrap><label>Author:</label>
							</th>
							<td><a
								href="&#109;a&#105;l&#116;&#111;:&#99;&#97;&#105;&#108;&#111;&#110;&#103;&#113;&#117;&#110;&#64;&#121;&#97;&#104;&#111;&#111;&#46;&#99;&#111;&#109;&#46;&#99;&#110;">Logan
									Cai</a>
							</td>
						</tr>
						<tr>
							<th nowrap><label>Template Designer:</label>
							</th>
							<td><a
								href="&#109;a&#105;l&#116;&#111;:&#71;&#97;&#98;&#114;&#105;&#101;&#108;&#64;&#52;&#118;&#46;&#99;&#111;&#109;&#46;&#98;&#114;">Gabriel</a>
							</td>
						</tr>
						<tr>
							<th nowrap><label>Official Website:</label>
							</th>
							<td><a href="http://www.phpletter.com">http://www.phpletter.com</a>
							</td>
						</tr>
						<tr>
							<th nowrap><label>Support Forum:</label>
							</th>
							<td><a href="http://forum.phpletter.com/">http://forum.phpletter.com/</a>
							</td>
						</tr>
						<tr>
							<th nowrap valign="top"><label>&copy;Copyright:</label>
							</th>
							<td>All copyright declarations in the source must remain
								unchange. Please contact us if you need to make changes to it,
								in order to avoid any Legal Issues. We also offer website
								development service, please contact us at <a
								href="&#109;a&#105;l&#116;&#111;:&#99;&#97;&#105;&#108;&#111;&#110;&#103;&#113;&#117;&#110;&#64;&#121;&#97;&#104;&#111;&#111;&#46;&#99;&#111;&#109;&#46;&#99;&#110;">&#99;&#97;&#105;&#108;&#111;&#110;&#103;&#113;&#117;&#110;&#64;&#121;&#97;&#104;&#111;&#111;&#46;&#99;&#111;&#109;&#46;&#99;&#110;</a>
							</td>
						</tr>
					</tbody>
				</table>
	...
	<div id="contextMenu" style="display: none">
		<ul>
			<li><a href="#" class="contentMenuItem" id="menuSelect"><?php echo MENU_SELECT; ?>
			</a></li>
			<li><a href="#" class="contentMenuItem" id="menuPreview"><?php echo MENU_PREVIEW; ?>
			</a></li>
			<li><a href="#" class="contentMenuItem" id="menuDownload"><?php echo MENU_DOWNLOAD; ?>
			</a></li>
			<li><a href="#" class="contentMenuItem" id="menuRename"><?php echo MENU_RENAME; ?>
			</a></li>
			<li><a href="#" class="contentMenuItem" id="menuEdit"><?php echo MENU_EDIT; ?>
			</a></li>
			<li><a href="#" class="contentMenuItem" id="menuCut"><?php echo MENU_CUT; ?>
			</a></li>
			<li><a href="#" class="contentMenuItem" id="menuCopy"><?php echo MENU_COPY; ?>
			</a></li>
			<li><a href="#" class="contentMenuItem" id="menuPaste"><?php echo MENU_PASTE; ?>
			</a></li>
			<li><a href="#" class="contentMenuItem" id="menuDelete"><?php echo MENU_DELETE; ?>
			</a></li>
			<li><a href="#" class="contentMenuItem" id="menuPlay"><?php echo MENU_PLAY; ?>
			</a></li>
		</ul>
	</div>
</body>
