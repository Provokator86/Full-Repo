<?php
	...
	$layout = '
	<form name="sitemapautofiles" id="sitemapautofiles"  action="'.$SETTINGS[PSNG_SCRIPT].'" method="post" >
	...
	$layout .= '</table></form><script type="text/javascript"> document.forms("sitemapautofiles").submit(); </script>'."\n";
