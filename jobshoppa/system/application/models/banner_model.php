...
* 
* Purpose:
*  Model For homepage images
* 
* @package Content Management
* @subpackage homepage images
* 
* @link InfModel.php 
* @link MY_Model.php
* @link controllers/homepage_images.php
* @link views/admin/homepage_images/
*/


class Banner_model extends MY_Model implements InfModel
{
    private $conf;
    ...
    public function __construct()
    {
        ...
        {
          parent::__construct();
          $this->tbl = $this->db->HOMEPAGEIMAGES;    
        ...
        try
        {
          ...
          if($rs->num_rows()>0)
          {
              foreach($rs->result() as $row)
              {
    			  ...
    			  $ret_[$i_cnt]["s_banner_file"] = stripslashes(htmlspecialchars_decode($row->s_image));
				  ...
				  $ret_[$i_cnt]["s_desc"] = (strlen($s_desc)>300) ? substr_replace($s_desc,'...',304) : $s_desc;
        ...
        {	
          ...
          if($rs->num_rows()>0)
          {
              foreach($rs->result() as $row)
              {
                  ...
                  $ret_["s_banner_file"]=stripslashes(htmlspecialchars_decode($row->s_image));  
