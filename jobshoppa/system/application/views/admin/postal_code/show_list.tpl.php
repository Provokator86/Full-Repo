...
/*$("#frm_search_1").submit(function(){
    ...
    if($.trim($("#frm_search_1 #txt_zip_code").val())=="") 

    {
        s_err +='Please provide Zip Code.<br />';
        b_valid=false;
...
$("#frm_search_2").submit(function(){
    ...
    /*if($.trim($("#frm_search_2 #txt_zip_code").val())=="") 
    {
        s_err +='Please provide zip code.<br />';
        b_valid=false;
    }*/
...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can view the postal codes presnt in the database.Admin can also add postal codes here, if he need to add a new postal codes.</div>
    <div id="tab_search">
      ...
      <form id="frm_search_1" name="frm_search_1" method="post" action="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_zip_code" name="txt_zip_code" value="<?php echo $txt_zip_code;?>" type="text" size="28" />
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <?php /*?><input id="txt_state" name="txt_state" value="<?php echo $txt_state;?>" type="text" size="28"  /><?php */?>
			<select name="opt_state_id" id="opt_state_id">
						<option value="">Select State </option>
						<?php  echo makeOptionState('i_parent_id=0', decrypt($opt_state_id))?>
				</select>
			...
			<select name="opt_city_id" id="opt_city_id">
						...
						<?php  echo makeOptionCity('i_parent_id=0', decrypt($opt_city_id))?>
			</select>
