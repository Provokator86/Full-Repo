...
*  View For feedback List Showing
...
/*    if($.trim($("#frm_search_2 #txt_job_title").val())=="") 

    {
        s_err +='Please provide Feedback.<br />';
        b_valid=false;
...
<div id="right_panel">
    ...
    <h2><?php echo $heading;?></h2>
        <div class="info_box">From here admin can view and edit the feedback provided by the Clients for completed jobs.</div>
    ...
    <div id="tabcontent">
      ...
      <?php /*?><form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_job_title" name="txt_job_title" value="<?php echo $txt_job_title;?>" type="text" size="28" />
	  ...
	  <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" >
          ...
          <tr>
            <td width="12%">Posted <span style="padding-left:30px;">From Date</span>:</td>
            <td width="15%">
