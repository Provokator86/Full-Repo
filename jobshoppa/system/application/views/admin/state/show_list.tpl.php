...
$("#frm_search_2").submit(function(){
   ...
   /* if($.trim($("#frm_search_2 #txt_state_title").val())=="") 
    {
        s_err +='Please provide state name.<br />';
        b_valid=false;
    }*/
...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can view the county presnt in the database.Admin can also add county here, if he need to add a new county.</div>
    <div id="tab_search">
      ...
      <form id="frm_search_1" name="frm_search_1" method="post" action="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_state_title" name="txt_state_title" value="<?php echo $txt_state_title;?>" type="text" size="28" />
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<?php /*?> <td width="12%">Abbreviation:</td>

            <td  colspan="3">

            <input id="txt_abbreviation" name="txt_abbreviation" value="<?php echo $txt_abbreviation;?>" type="text" size="28"  />
