...
*  View For language List Showing
...
/*$("#frm_search_1").submit(function(){
    ...
    if($.trim($("#frm_search_1 #txt_language").val())=="") 
    {
...
$("#frm_search_2").submit(function(){
    ...
    if($.trim($("#frm_search_2 #txt_language").val())=="") 

    {
        s_err +='Please Provide Language Name.<br />';
        b_valid=false;
    }
      ...
      <form id="frm_search_1" name="frm_search_1" method="post" action="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_language" name="txt_language" value="<?php echo $txt_language;?>" type="text" size="28" />
