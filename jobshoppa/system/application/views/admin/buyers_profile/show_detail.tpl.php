	  ...
	  <div id="tabcontent">
		  <div id="div1">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				 <td bgcolor="#f1f1f1">Date of Birth: </td>
				<td><?php echo $info["s_dob"];?></td>
			   <td bgcolor="#f1f1f1">Fax No: </td>
				<td><?php echo $info["s_fax"];?></td>
			  </tr>
			  <?php 
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				...
				<td><?php echo $user_details['i_job_post'];?></td>
