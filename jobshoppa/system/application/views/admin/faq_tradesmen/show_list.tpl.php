...
/*$("#frm_search_1").submit(function(){
    ...
    if($.trim($("#frm_search_1 #txt_faq_title").val())=="") 

    {

        s_err +='Please provide Faq Question.<br />';
...
/*    if($.trim($("#frm_search_2 #txt_faq_title").val())=="") 
    {
        s_err +='Please Provide FAQ Question.<br />';
        b_valid=false;
    }*/
...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can view, add and delete the FAQ for professional .</div>
      ...
      <form id="frm_search_1" name="frm_search_1" method="post" action="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="15%" nowrap="nowrap">Faqs  Question *:</td>

            <td width="23%">

            <input id="txt_faq_title" name="txt_faq_title" value="<?php echo $txt_faq_title;?>" type="text" size="28" />
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="15%" nowrap="nowrap">FAQ  Question :</td>
