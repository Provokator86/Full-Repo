...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
    ...
    <div class="info_box">From here Admin can add or edit the FAQ for professional .</div>
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
              show_msg("error");  
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td>Category *:</td>
          <td>
		  <select id="opt_cat" name="opt_cat" onchange='ajax_call_get_content("ajax_get_content",this.value,txt_faq_question.value);' >
		  	<option value="">Select</option>
			<?php echo makeOptionCategory('s_category_type="'.tradesman_faq.'" AND c.i_status=1 ',$posted["opt_cat"]); ?>
		  </select>
		  </td>
          <td>&nbsp;</td>
        </tr>
