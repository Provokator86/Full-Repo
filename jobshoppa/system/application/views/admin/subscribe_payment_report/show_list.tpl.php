...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view the subscription payments paid by professionals and their invoices.</div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<?php echo makeOptionUserByType('i_is_active = 1',$opt_buyer_id,2); ?>
			</select>
