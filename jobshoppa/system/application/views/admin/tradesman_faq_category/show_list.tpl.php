...
* 
* Purpose:
*  View For category List Showing
* 
...
/*$("#frm_search_1").submit(function(){
    ...
    if($.trim($("#frm_search_1 #txt_state_title").val())=="") 
    {
...
$("#frm_search_2").submit(function(){
    ...
    /*if($.trim($("#frm_search_2 #txt_category_name").val())=="") 
    {
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can manage the category for Professional FAQ.</div>
	<div class="clr"></div>
      ...
      <form id="frm_search_1" name="frm_search_1" method="post" action="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_category_title" name="txt_category_title" value="<?php echo $txt_category_title;?>" type="text" size="28" />
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td ><input id="txt_category_name" name="txt_category_name" value="<?php echo $txt_category_name;?>" type="text" size="28" /></td>

           <?php /*?> <td width="12%">Created On:</td>
            ...
            <td colspan="3">
			<select id="opd_category_type" name="opd_category_type">
				<option value="">All</option>
			<?php echo makeOptionCategoryType("",$opd_category_type)?>
			</select>
