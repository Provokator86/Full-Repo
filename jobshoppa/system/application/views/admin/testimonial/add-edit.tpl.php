...
$(document).ready(function(){
	...
	$("input[name='txt_event_start_date']").datepicker({dateFormat: 'yy-M-dd',
	...
	$("input[name='txt_event_end_date']").datepicker({dateFormat: 'yy-M-dd',
...
$("#frm_add_edit").submit(function(){
	...
	*/
	...
	//var x	=	document.forms["frm_add_edit"]["txt_person_email"].value; 
	/*var adminEmailaddressVal = $.trim($("#txt_person_email").val());
	...
	/*	  
	if($.trim($("#txt_person_image").val())=="" && $.trim($("#h_image_name").val())=="") 
    {
        s_err +='Please browse person image.<br />';
        b_valid=false;
    }	
	*/
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
    ...
    <div class="info_box">From here Admin can add testimonials and also can edit the testimonials send by the users of the site.</div>
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
              show_msg("error");  
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<?php /*?><tr>
          <td> Email *:</td>
          <td><input id="txt_person_email" name="txt_person_email" value="<?php echo $posted["txt_person_email"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr><?php */?>
		...
		<tr>
          <td> Status :</td>
          <td>
		  	<select name="opt_test_state" id="opt_test_state">
				<?php echo makeOption($arr_state,$posted['opt_test_state']); ?>
			</select>
		  </td>
          <td>&nbsp;</td>
        </tr> 
