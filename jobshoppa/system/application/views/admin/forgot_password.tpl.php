...
$(document).ready(function(){
    $("#frm_login").submit(function(){
        ...
        if(address=="") 
        {
            s_err='<div id="err_msg" class="error_massage"><strong>Please provide email address.</strong></div>';
            b_valid=false;
        }
         else if(reg.test(address) == false) 
         {
            s_err +='<div id="err_msg" class="error_massage"><strong>Please provide valid email</strong></div>';
            b_valid=false;
        }      
...
<div id="content">
  ...
  <form id="frm_login" action="" method="post">
    ...
    <br class="clr" />
     ...
     <div class="lable">&nbsp;</div>
    <div class="field"><a href="<?php echo admin_base_url()?>" style="color:#FFFFFF;text-decoration:none;">Login</a></div>
	  <br class="clr" />
  </form>  
  </div>
</div>
