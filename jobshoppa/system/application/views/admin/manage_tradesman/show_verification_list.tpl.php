...
/*    if($.trim($("#frm_search_2 #txt_user_name").val())=="") 
	{
...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can view, activate and deactivate the registered professional.</div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
           ...
           <td width="10%">Username:</td>
            ...
            <td width="19%"><input id="txt_user_name" name="txt_user_name" value="<?php echo $txt_user_name;?>" type="text" size="28" /></td>
