...
$("#frm_add_edit").submit(function(){
    ...
    $("#div_err").hide("slow"); 
	 ...
	 if($.trim($("#txt_below_slab").val())=="") 
		{
			s_err +='Please Provide Commission .<br />';
			b_valid=false;
		}
	else if(!pattern.test($("#txt_below_slab").val()))	
		{
			s_err +='Please Provide Correct Commission .<br />';
			b_valid=false;
		}		
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td>Commission  *:</td>
          <td>
		  <input id="txt_below_slab" name="txt_below_slab" value="<?php echo $posted["txt_below_slab"];?>" type="text" size="30" />
		  &nbsp;%</td>
          <td>&nbsp;</td>
        </tr>
