...
/*$("#frm_search_1").submit(function(){
    ...
    if($.trim($("#frm_search_1 #txt_city_title").val())=="") 
...
$("#frm_search_2").submit(function(){
    ...
    /*if($.trim($("#frm_search_2 #txt_city_title").val())=="") 
    {
        s_err +='Please provide city name.<br />';
        b_valid=false;
    }*/
      ...
      <form id="frm_search_1" name="frm_search_1" method="post" action="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_city_title" name="txt_city_title" value="<?php echo $txt_city_title;?>" type="text" size="28" />
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<select name="opt_type_id" id="opt_type_id">
						...
						<?php  echo makeOptionState('i_parent_id=0', decrypt($opt_type_id));?>
				</select>
