...
<div id="right_panel">
 ...
 <div id="content">   
		<div class="dashboard_box">
			...
			<div class="content">
				<ul>
					<li><span style=" color:#F58726;font-style:italic; font-weight:bold;">Total Number of Clients : </span><a style="text-decoration:underline;" target="_blank" href="<?php echo admin_base_url().'manage_buyers/show_list' ?>"><?php echo $i_no_buyer ?></a></li>
					<li><span style=" color:#F58726;font-style:italic; font-weight:bold;">Total Number of Professionals : </span><a style="text-decoration:underline;" target="_blank" href="<?php echo admin_base_url().'manage_tradesman/show_list' ?>"><?php echo $i_no_tradesman ?></a></li>
					<li><span style=" color:#F58726;font-style:italic; font-weight:bold;">Total Clients Signup Today : </span><a style="text-decoration:underline;" target="_blank" href="<?php echo admin_base_url().'manage_buyers/show_list' ?>"><?php echo $i_no_buyer_signup ?></a></li>
					<li><span style=" color:#F58726;font-style:italic; font-weight:bold;">Total Professionals Signup today : </span><a style="text-decoration:underline;" target="_blank" href="<?php echo admin_base_url().'manage_tradesman/show_list' ?>"><?php echo $i_no_tradesman_signup ?></a></li>
					<li><span style=" color:#F58726;font-style:italic; font-weight:bold;">Total Quotes Placed Today : </span><a style="text-decoration:underline;" target="_blank" href="<?php echo admin_base_url().'job_live_report/show_qoute_list' ?>"><?php echo $i_tot_quotes ?></a></li>
					<li><span style=" color:#F58726;font-style:italic; font-weight:bold;">Total Messages Posted Today : </span><a style="text-decoration:underline;" target="_blank" href="<?php echo admin_base_url().'manage_private_message/show_list' ?>"><?php echo $i_tot_msg_post ?></a></li>
					<li><span style=" color:#F58726;font-style:italic; font-weight:bold;">Total Jobs Accepted by Professionals Today : </span><a style="text-decoration:underline;" target="_blank" href="<?php echo admin_base_url().'manage_jobs/show_in_progress' ?>"><?php echo $i_accept_jobs ?></a> </li>
					<li><span style=" color:#F58726;font-style:italic; font-weight:bold;">Total Payments Made Today : </span><a style="text-decoration:underline;" target="_blank" href="<?php echo admin_base_url().'comm_payment_report/show_list' ?>"><?php echo $total_pay_amount ?></a></li>
				</ul>
			</div>
		</div>
		
		<div class="dashboard_box">
			<div class="title">Jobs Completed Today</div>
			<div class="content">
				<ul>
					...
					<li><a target="_blank" href="<?php echo admin_base_url().'job_overview/index/'.encrypt($value['id']) ?>"><span style=" color:#F58726;font-style:italic; font-weight:bold;"><?php echo substr($value['s_title'],0,125) ?></span></a></li>
					...
					<li><span style=" color:#F58726;font-style:italic; font-weight:bold;">No Record Found</span></li>
		...
		<div class="dashboard_box">
			<div class="title">New Jobs to be Approved</div>
			<div class="content">
				<ul>
					<?php if($posted_jobs)
							{
					...
					<li><a target="_blank" href="<?php echo admin_base_url().'manage_jobs/show_list' ?>"><span style=" color:#F58726;font-style:italic; font-weight:bold;"><?php echo substr($value['s_title'],0,125) ?></span></a></li>
