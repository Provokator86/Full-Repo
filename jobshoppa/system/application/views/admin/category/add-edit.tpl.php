...
// Ajax call to populate parent caregry options
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          ...
          <td><input id="txt_category_name_<?php echo $val['id'] ?>" name="txt_category_name_<?php echo $val['id'] ?>" value="<?php echo $posted["txt_category_name_".$val['id']];?>" type="text" size="50" /><?php echo $posted["txt_category_name_".$val['id']];?></td>
          <td>&nbsp;</td>
        </tr>
		<?php } } ?>
