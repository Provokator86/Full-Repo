    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          ...
          <td align="left" colspan="3" ><?php echo $info["s_commission_slab_100"];?></td>
        </tr> 
        <tr>
          <td valign="top" width="50%"><strong>Commission Slab Greater Than 100:</strong></td>
          <td colspan="3"><?php echo $info["s_commission_greater_than_100"];?></td>
        </tr> 
		<tr>
