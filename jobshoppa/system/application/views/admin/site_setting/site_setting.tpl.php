...
/*	
	...
	var subsc_pattern = /^\+?[0-9]*\.?[0-9]+$/;
	if($.trim($("#s_subcription_amount").val())=="") 
    {
        s_err +='Please provide subscription amount.<br />';
        b_valid=false;
    }
	else if(!subsc_pattern.test($("#s_subcription_amount").val()))	
		{
			s_err +='Please provide subscription amount in integer or decimal values.<br />';
			b_valid=false;
		}	
			...
			<div id="myaccount">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" >
					...
					<tr>
						<td>Site Title  *:</td>
						<td>
							<input id="s_title" name="s_title" value="<?php echo $posted["s_title"];?>" 
							type="text" size="50" />						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr><?php */?>
                    ...
                    <tr>
                            <td>&nbsp;</td>
                            <td class="caption_txt" colspan="2">From here Admin can set the email address, from where all emails will be sent to the registered user's of the site.</td>
                    </tr>
					...
					<tr>
                            <td>&nbsp;</td>
                            <td class="caption_txt" colspan="2">From here Admin can set the Paypal email ID to receive the commission payments.</td>
                    </tr>
					<tr>
						<td>Site Address*:</td>
						<td>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td class="caption_txt" colspan="2">From here Admin can set the actual URL of the site.</td>
                    </tr>
					<?php /*?>
					<tr>
						<td>Contact Number*:</td>
						<td>
							<input id="s_contact_number" name="s_contact_number" value="<?php echo $posted["s_contact_number"];?>" 
							type="text" size="50" />						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					...
					<tr>
						<td>Service Call Email *:</td>
						<td>
							<input id="s_service_call_email" name="s_service_call_email" value="<?php echo $posted["s_service_call_email"];?>" 
							type="text" size="50" />						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					...
					<tr>
					  ...
					  <td align="left"><input id="s_subcription_amount" name="s_subcription_amount" value="<?php echo $posted["s_subcription_amount"];?>" 
							type="text" size="50" /></td>
					  <td>&nbsp;</td>
					  <td>&nbsp;</td>
				  	</tr>
					<tr>
                        <td>&nbsp;</td>
                        <td class="caption_txt" colspan="2">From here Admin can set the subscription amount for the site.</td>
                    </tr>
					<tr>
					  <td valign="top">Subscription Status *: </td>
					  <td align="left"><input type="radio" name="sub_status" id="sub_status" value="0" <?php if($posted['sub_status']==0) echo 'checked=checked'; ?> /> Off
					  &nbsp;&nbsp;<input type="radio" name="sub_status" id="sub_status" value="1" <?php if($posted['sub_status']==1) echo 'checked=checked'; ?>/> On</td>
					  <td>&nbsp;</td>
					  <td>&nbsp;</td>
				  	</tr>
					<tr>
                        <td>&nbsp;</td>
                        <td class="caption_txt" colspan="2">From here Admin can set the subscription status for the site.</td>
                    </tr>
