...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view all the private message posted by all the different professional.</div>
	<div class="clr"></div>
    <div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
           ...
           <a alt="View" title="View" href="<?php echo admin_base_url().'job_overview/index/'.encrypt($job_info["id"])?>" target='_blank'>
		   <?php echo $job_info['s_title'];?>
		   </a>
			...
			<a title="Click here to view profile" alt='Click here to view profile' href='<?php echo admin_base_url().'buyers_profile/index/'.encrypt($job_info["i_buyer_id"])?>' target='_blank'>
           <?php echo $job_info['s_buyer_name'];?>
			</a>	
