...
* 
* Purpose:
*  View For customer support Add & Edit
* 
...
$("#frm_add_edit").submit(function(){
	...
	if((text = tinyMCE.get('txt_answer').getContent())=='') 
		{
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
    <h2><?php echo $heading;?></h2>
        <div class="info_box">From here Admin can add and edit the customer support.</div>    
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
              show_msg("error");  
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td>Question *:</td>
          <td><input id="txt_question" name="txt_question" value="<?php echo $posted["txt_question"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr>
        ...
        <tr>
          ...
          <td>
          <textarea name="txt_answer" id="txt_answer" cols="46" rows="4"><?php echo $posted["txt_answer"]; ?></textarea>
          </td>
          <td>&nbsp;</td>
        </tr>
