...
*  View For Customer_support List Showing
...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can view ,add and edit the customer support.</div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="15%" nowrap="nowrap">Question :</td>
