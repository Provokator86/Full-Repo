...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td>Role *:</td>
          <td><input id="txt_role_title" name="txt_role_title" value="<?php echo $posted["txt_role_title"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr>
        ...
        <tr>
          <td>Active:</td>
          <td><input id="i_role_is_active" name="i_role_is_active" value="1" <?php if($posted["i_role_is_active"]==2) echo ''; else echo 'checked="checked"';?>  type="checkbox" /></td>
          <td>&nbsp;</td>
        </tr>
      </table>
      </div>
