		  ...
		  <div id="div1">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				...
				<td bgcolor="#f1f1f1">Client Name:</td>
			  ...
			  <tr>
			   ...
			   <tr>
				...
				<td bgcolor="#f1f1f1">Date Assigned</td>
				<td><?php echo $info["dt_assigned_date"];?></td>
			  </tr>
			  <?php 
			...
			?>
			  ...
			  <tr>
			   <td bgcolor="#f1f1f1">Professional Assigned:</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <?php
			   ...
			   if(count($info['job_files'])>0)
			  {
			  	$i=1;
			  		foreach($info['job_files'] as $file)
					{
			  ?>
				  <tr>
					<td bgcolor="#f1f1f1"><?php echo 'File '.$i++;?></td>
					<td colspan="3"><a href="<?php echo base_url().'job/download_job_files/'.encrypt($file['s_file_name']);?>"><?php echo t('Download')?></a></td>
            ...
            <div class="description" >
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
				 ...
				 <?php 
			  		if(count($quote_list)>0)
					{
						...
						{ if($quote['s_status']=='Pending')
						$quote['s_status'] = 'Not Approved';
						?>
                ...
                <tr>
                  ...
                  <td width="25%"><?php echo $quote['dt_entry_date']?></td>				  
            ...
            <div class="description">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
				  ...
				  <th align="left">Terminated Person</th>
                ...
                <tr>
                  ...
                  <td width="15%"><?php echo $feed['s_comments']?></td>
				 <td width="15%"><?php echo $feed['s_terminate_reason']?></td>
				  <td width="15%"><?php echo $feed['s_receiver_user']?></td>
				  
				  <td width="15%"><?php echo show_star($feed['i_rating'])?></td>
