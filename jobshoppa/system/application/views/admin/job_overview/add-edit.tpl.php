...
$("#frm_add_edit").submit(function(){
	...
	/* if($.trim($("#s_skype_id").val())=="") 
		{
			s_err +='Please provide skype id.<br />';
			b_valid=false;
		}	
	 if($.trim($("#s_msn_id").val())=="") 
		{
			s_err +='Please provide MSN id.<br />';
			b_valid=false;
		}
	 if($.trim($("#s_yahoo_id").val())=="") 
		{
			s_err +='Please provide yahoo id.<br />';
			b_valid=false;
		}	*/
	...
	else if(!lat_long_pattern.test($("#s_lat").val()))	
		{
			s_err +='Please provide correct latitude.<br />';
			b_valid=false;
		}
	...
	else if(!lat_long_pattern.test($("#s_lng").val()))	
		{
			s_err +='Please provide correct longitude.<br />';
			b_valid=false;
		}	*/	
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<?php /*?><tr>
          <td>Lattitude *:</td>
          <td><input id="s_lat" name="s_lat" value="<?php echo $posted["s_lat"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr>
		<tr>
          <td>Longitude *:</td>
          <td><input id="s_lng" name="s_lng" value="<?php echo $posted["s_lng"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr>
		<?php */?>
