...
$("#frm_add_edit").submit(function(){
    ...
    $("#div_err").hide("slow"); 
	 ...
	 if($.trim($("#opt_alert_type").val())=="") 
    {
        s_err +='Please provide Alert Type.<br />';
        b_valid=false;
    }
	
	if((text = tinyMCE.get('txt_subject').getContent())=='') 
    {
        s_err +='Please provide Subject .<br />';
        b_valid=false;
    }
	if((text = tinyMCE.get('txt_content').getContent())=='') 
    {
        s_err +='Please provide Content of the alert .';
        b_valid=false;
    }
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td>Alert For *:</td>
          <td><input id="txt_alert_type" name="txt_alert_type" value="<?php echo $posted["txt_alert_type"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr>
		...
		<tr>
          <td>Type *:</td>
          <td>
		  <select name="opt_alert_type" id="opt_alert_type">
		  	<option value="">select</option>
			<?php echo makeOption($arr_alert,$posted['opt_alert_type']) ?>
		  </select>
		  </td>
          <td>&nbsp;</td>
        </tr>		
		...
		<tr>
          ...
          <td><!--<input id="txt_user_type" name="txt_user_type" value="<?php echo $posted["txt_subject"];?>" type="text" size="50" />-->
          <textarea name="txt_subject" id="txt_subject" cols="46" rows="4"><?php echo $posted["txt_subject"]; ?></textarea>          </td>
          <td>&nbsp;</td>
        </tr>
		
		<tr>
          <td valign="top">Content *:</td>
          <td><!--<input id="txt_user_type" name="txt_user_type" value="<?php echo $posted["txt_content"];?>" type="text" size="50" />-->
          <textarea name="txt_content" id="txt_content" cols="46" rows="4"><?php echo $posted["txt_content"]; ?></textarea>          </td>
          <td>&nbsp;</td>
        </tr>
