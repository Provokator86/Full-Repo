...
$("#frm_search_2").submit(function(){
    ...
    if($.trim($("#frm_search_2 #txt_created_on").val())=="" || $.trim($("#frm_search_2 #txt_to").val())=="") 
    {
        s_err +='Please provide date.<br />';
        b_valid=false;
    }
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view the revenue generated per month.</div>
