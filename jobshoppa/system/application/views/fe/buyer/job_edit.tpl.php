...
$("#frm_job_edit").submit(function(){	
   ...
   // $("#div_err").hide("slow");     
	if($.trim($("#opd_quote_period").val())=="") 
	{
		...
		s_err +='<div class="error"><span class="left"><strong>Please select quote days.</strong></span></div>';
		b_valid=false;
	}
...
<div id="div_container">
      <div class="body_bg">
            ...
            <div class="body_right">
                        ...
                        <h1><img src="images/fe/job.png" alt="" /> <?php  echo t('Edit')?> <span><?php echo t('Job')?></span></h1>
                        ...
                        <div class="shadow_big">
                              <div class="right_box_all_inner">
                                    ...
                                    <div class="fld01" style="padding-top:10px;">
                                          <input  class="button" type="button" id="btn_save_job" value="Save"/>
