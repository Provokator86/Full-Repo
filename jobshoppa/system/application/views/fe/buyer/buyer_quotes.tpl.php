      ...
      <div class="body_bg">
            ...
            <div class="body_right">
                  ...
                  <div class="shadow_big">
                        <div class="right_box_all_inner" style="padding:0px;">
                              ...
                              <div class="<?php echo ($i++%2) ? 'white_box' : 'sky_box'?> ">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                                <td width="185" align="center" valign="top"><a href="<?=base_url().'tradesman_profile/'.encrypt($val['job_details']['i_tradesman_id'])?>" class="blue_link"><?php echo $val['s_username']?></a><br/>
                                                ...
                                                <td width="116" align="center" valign="top"><a href="javascript:void(0);" onclick="send_msg('<?php echo encrypt($job_details['id'])?>')"><img src="images/fe/pmb.png" alt="My Private Message Board" title="My Private Message Board" /></a> </td>
                                          </tr>
                                    </table>
                              </div>
							  <?php
                  ...
                  <div style="display:none ;">
                        <div id="accept_div" class="lightbox">
                              <h1>Are you sure you want to choose "Bricklaying" for this job?</h1>
                             <div style="text-align:center;">
                              <a href="#success_div" class="lightbox_main terminate_btn" style="float:left; margin-left:130px; margin-right:10px;"><strong>Yes</strong></a>
                              <a href="javascript:void(0)"  class="terminate_btn" style="float:left; "><strong>No</strong></a>
                            </div>
                        </div>
                  </div>
                  <div style="display:none ;">
                        <div id="success_div" class="lightbox">
                              <h1> You have successfully awarded the jobtitle  to "Bricklaying"</h1>
                            "Bricklaying" will get his notifications and once he accepts the job, the job process will start.
                        </div>
                  </div>
