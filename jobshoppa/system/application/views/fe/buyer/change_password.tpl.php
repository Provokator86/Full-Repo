...
$("#contact_form").submit(function(){
    ...
    $("#div_err").hide(); 
	 ...
	 if($.trim($("#txt_new_password").val())=="") 
		{
		   s_err +='<div class="error_massage"><strong>Please provide your new password.</strong></div>';
			b_valid=false;
		}
     ...
     <div id="div_err">
        ...
        <div id="inner_container02">
           ...
           <!-- <h6>&quot; Please take a moment and fill the form out below &quot;</h6>-->
			...
			<form name="contact_form" id="contact_form" action="buyer/change_password/" method="post">
                <div class="account_left_panel">
                    <div class="round_container">
                        ...
                        <div class="mid" style="min-height:862px;">
                            ...
                            <div id="form_box01">
                                <div class="label03">Current Password <span class="red_txt">*</span> :</div>
                                <div class="field03">
                                    <input type="password"  name="txt_password" id="txt_password" autocomplete="off"/>
                                </div>
                                <div class="clr"></div>
