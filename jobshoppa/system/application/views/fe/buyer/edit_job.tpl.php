                        ...
                        <div class="mid" style="min-height:878px;">
                            ...
                            <div id="form_box01">
							  ...
							  <p>Type 3 characters to get postal code suggestion.</p>
                                ...
                                <div class="field03">
                                    <input type="text"  name="txt_budget_price" id="txt_budget_price"  size="48" style="width:100px;"  value="<?php echo $posted['txt_budget_price']?>" />£
                                </div>
                                <div class="clr"></div>
                                ...
                                <div class="clr"></div>
                                <div class="label03">Attach Pictures/Files <span class="red_txt">*</span> :</div>
...
<div class="title">
                                ...
                                <div class="clr"></div>
                                <div class="label04">
                                    <input name="rd_available_time" id="rd_available_time1" type="radio" value="1"  style="margin-right:10px;" onclick="select_available(1);" <?php echo ($posted["rd_available_time"]==1)?"checked":"";?>/>
                                    I'm Flexible</div>
                                <div class="label04">
                                    <input name="rd_available_time" id="rd_available_time2" type="radio" value="2"  style="margin-right:10px;" onclick="select_available(2);" <?php echo ($posted["rd_available_time"]==2)?"checked":"";?>/>
