...
<form name="ajax_frm_job_confirm" id="ajax_frm_job_confirm" method="post" action="<?php echo base_url().'tradesman/do_delete_watch_list'?>">
<div class="cancel_box lightbox_all" style="display:block;">
    ...
    <div class="mid">
        <div class="title">
            <h3><span>Would you like to delete this job</span> from your watchlist? </h3>
        </div>
        <div class="clr"></div>
        <div class="label01">&nbsp;</div>
        <div class="field01">
		<input type="hidden" name="i_watch_list_id" id="i_watch_list_id" value="<?php echo $i_watch_list_id?>" />
