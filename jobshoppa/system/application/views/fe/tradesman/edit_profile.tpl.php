...
<div id="form_box01">
   ...
   <?php 
	...
	<div class="label03">Form of payment <span class="red_txt">*</span> :</div>
	<div class="field03">
	
	 	
		<input type="checkbox" name="RadioGroup1[]" value="1" id="RadioGroup1_0" 
		<?php if(!empty($posted['i_payment_type'])) {
			foreach($posted['i_payment_type'] as $key=>$val)
			{		if($val==1) {	
	 	?>checked="checked" <?php } } } ?>	 />
		Credit Cards
		
		
		<input type="checkbox" name="RadioGroup1[]" value="2" id="RadioGroup1_1" <?php if(!empty($posted['i_payment_type'])) {
			foreach($posted['i_payment_type'] as $key=>$val)
			{		if($val==2) {	
	 	?>checked="checked" <?php } } } ?>	 />
		Cheques
		
		<input type="checkbox" name="RadioGroup1[]" value="3" id="RadioGroup1_2"  <?php if(!empty($posted['i_payment_type'])) {
			foreach($posted['i_payment_type'] as $key=>$val)
			{		if($val==3) {	
	 	?>checked="checked" <?php } } } ?>	/>
		Cash 
