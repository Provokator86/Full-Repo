		...
		<div id="inner_container02">
			...
			<div id="registration_box">
				...
				<form id="form_buyer_reg" action="" method="post" enctype="multipart/form-data" >
					...
					<div class="clr"></div>
					<div class="label01" style="width:450px;">Job Type :</div>
					<div class="field01" style="width:500px;"><strong><?php echo $job_type;?></strong></div>
					<div class="clr"></div>
					
					
					<?php /*?><div class="label01" style="width:450px;">Commission :</div>
					<div class="field01" style="width:500px;"><strong>@ <?php echo $comm_slab?> %</strong></div><?php */?>
					<div class="label01" style="width:450px;">Your Quote :</div>
					<div class="field01" style="width:500px;"><strong>£ <?php echo $amt_quoted?> </strong></div>					
					<div class="clr"></div>		
								
					<?php /*?><div class="label01" style="width:450px;">Job Cost:</div>
					<div class="field01" style="width:500px;"><strong>£ <?php echo $amt_to_paid?></strong></div><?php */?>
					<div class="label01" style="width:450px;">Commission Payable:</div>
					...
					<div style=" border-top:1px solid #ddd; padding-top:15px; margin-top:15px;">
						...
						<div class="left" style=" width:300px;text-align:center;background:#f1f1f1; border:1px solid #ddd; margin-top:10px; padding:20px;">
							...
							<p><img src="https://www.paypal.com/en_US/i/btn/btn_xpressCheckout.gif" style="cursor:pointer;" onclick='window.location="<?php echo base_url().'tradesman/express_payment/'.$i_job_id?>"'></p>
