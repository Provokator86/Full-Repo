...
<form name="ajax_frm_job_confirm" id="ajax_frm_job_confirm" method="post" action="<?php echo base_url().'tradesman/save_give_feedback'?>">
<div class="cancel_box lightbox_all" style="display:block;">
    ...
    <div class="mid">
        <div class="title"> 
            <h3><span>Please</span> provide feedback</h3>
        </div>
        <div class="clr"></div>
        <div class="label01">Comment</div>
		<div class="field01">
		<input type="hidden" name="i_feedback_id" id="i_feedback_id" value="<?php echo $i_feedback_id?>" />
