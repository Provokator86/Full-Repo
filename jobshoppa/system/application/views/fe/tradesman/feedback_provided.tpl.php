...
<div id="inner_container02">
            <div class="title">
                <h3><span>Reviews </span>To Be Provided</h3>
            </div>
            <div class="clr"></div>
           <!-- <h6>&quot; This section consists of all the bids you have placed in respect to all the jobs that are relevant to you &quot;</h6>-->
          <div class="clr"></div>
                    ...
                    <div class="round_container">
                        ...
                        <div class="mid" style="min-height:878px;">
                            <div class="heading_box">
                                <div class="left">Total Reviews: <?=$i_feedback_to_be_provided?> </div>	
								</div>							
							<div id="job_list">
