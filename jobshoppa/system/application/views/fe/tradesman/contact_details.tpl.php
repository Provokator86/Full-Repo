...
$("#contact_form").submit(function(){
    ...
    $("#div_err").hide("slow"); 
	 ...
	 if($.trim($("#txt_contact").val())=="") 
		{
		   s_err +='<div class="error"><span class="left"><strong>Please provide contact number.</strong></span></div>';
			b_valid=false;
		}	
	else if(reg_contact.test($.trim($("#txt_contact").val())) == false) 
		{
			s_err +='<div class="error"><span class="left"><strong>Please provide valid contact number.</strong></span></div>';
			b_valid=false;
		}
...
<div class="body_bg">
           ...
           <?php include_once(APPPATH.'views/fe/common/tradesman_left_menu.tpl.php'); ?>
            <div class="body_right">
                        ...
                        <h1><img src="images/fe/account.png" alt="" /> <?php echo t('Contact')?> <span><?php echo t('Details')?> </span></h1>
                        <div class="shadow_big">
                              <div class="right_box_all_inner">
							  
							  <form name="contact_form" id="contact_form" action="tradesman/set_contact_details/" method="post">
                                    ...
                                    <div class="fld01" style="padding-top:10px;">
                                          <input  class="button" type="button" name="btn_save" id="btn_save" value="Save"/>
                                          <input  class="button" type="button" name="btn_cancel" id="btn_cancel" value="Cancel"/>
                                    </div>
                                    <div class="spacer"></div>
									<form>
