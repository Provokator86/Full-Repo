...
<form name="ajax_frm_job_confirm" id="ajax_frm_job_confirm" method="post" action="<?php echo base_url().'tradesman/deny_job_update'?>">
...
<div id="div_err1">
    ...
    <div class="mid">
        <div class="title">
            <h3><span>Would you like to </span>deny this job?</h3>
        </div>
        <div class="clr"></div>
        <div class="label01">&nbsp;</div>
        <div class="field01">
		<input type="hidden" name="h_job_id" id="h_job_id" value="<?php echo $i_job_id?>" />
		<input type="hidden" name="h_quote_id" id="h_quote_id" value="<?php echo $job_details['i_quote_id']?>" />
		<input type="hidden" name="h_tradesman_id" id="h_tradesman_id" value="<?php echo $job_details['i_tradesman_id']?>" />
