...
<div id="inner_container02">
            <div class="title">
                <h3><span>Jobs In </span> Progress</h3>
            </div>
            <div class="clr"></div>
            <!--<h6>&quot; Here you will find all the jobs that you have won and are in progress &quot;</h6>-->
          <div class="clr"></div>
                    ...
                    <div class="round_container">
                        ...
                        <div class="mid" style="min-height:878px;">
                            <div class="heading_box">
                                <div class="left">In progress Jobs : <?=$i_progress_jobs?> </div>                                
                            </div>
