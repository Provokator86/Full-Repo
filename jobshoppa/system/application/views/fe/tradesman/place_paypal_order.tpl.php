		...
		<div class="IPN_style">
			<?php
				...
				//if( $this->cart->total_items() ) :
					...
					$paypal_obj->add_field('return', base_url() .'tradesman/payment_success');
					$paypal_obj->add_field('notify_url', base_url() .'tradesman/payment_success');
					$paypal_obj->add_field('cancel_return', base_url() .'tradesman/payment_failure');
...
/*					foreach($cart_contents as $items)
					...
					$CUSTOM_FLD = $user_id . '&'. $item_id;
					$paypal_obj->add_field('custom', $CUSTOM_FLD);
