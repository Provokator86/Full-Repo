<div class="body_left">
                  ...
                  <div class="shadow_small">
                        <div class="left_box" style="padding-bottom:5px;">
                              <ul class="category" style="padding-bottom:0px;">
                                    ...
                                    <li><a href="<?php echo base_url().'tradesman/tradesman_radar_job'?>" <?php echo ($this->i_sub_menu_id==8)?'class="active"': '' ?>><?php echo t('Radar Jobs')?> (<?=$i_total_radar_job?>)</a></li>
                              </ul>
                        </div>
                  </div>
                  ...
                  <div class="shadow_small">
                        <div class="left_box" style="padding-bottom:5px;">
                              <ul class="category" style="padding-bottom:0px;">
                                    <li><a href="<?=base_url().'tradesman/feedback_received'?>" <?php echo ($this->i_sub_menu_id==13)?'class="active"': '' ?>><?php echo t('Feedback Received')?> (<?php  echo $profile_info['i_feedback_received'];?>)</a></li>
