...
<form name="ajax_frm_job_del" id="ajax_frm_job_del" method="post" action="<?php echo base_url().'job/save_watch_list'?>">
<div class="cancel_box lightbox_all" style="display:block;">
    ...
    <div class="mid">
        <div class="title">
            <h3><span>Would you like to </span>add this job to your watch list ?</h3>
        </div>
        <div class="clr"></div>
		...
		<input type="button" value="No"  name="btn_no" id="btn_no" />
        </div>
        <div class="clr"></div>
    </div>
    <div class="bot">&nbsp;</div>
