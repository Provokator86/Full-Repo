     ...
     <div id="div_err">
        ...
        <div id="inner_container02">
                ...
                <div class="mid">
                    ...
                    <div class="content">
                        ...
                        <form name="frm_login_form" id="frm_login_form" action="" method="post">
							...
							<?=$button?>	-->
							<!--<div id="fb-root" style="float:left; width:250px;"></div>
							<fb:login-button scope="user_likes,user_birthday,user_location,user_photos,user_status,user_website,email" size="large" on-login="fblogincheck()">Connect with Facebook</fb:login-button>
                        ...
                        <div class="box02">
                            <h6><span>Both fields are required</span></h6>
            ...
            <div id="login_problem">
                ...
                <p>&nbsp;</p>
                <p class="big_txt15">Check that you are accepting our cookies Or try  <a href="<?php echo base_url().'user/forget_password'?>" style="text-decoration:underline;">resetting your password</a></p>
            </div>
            <div class="clr"></div>
        </div>
        <div class="clr"></div>
