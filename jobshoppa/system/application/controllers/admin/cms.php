...
class Cms extends My_Controller implements InfController
{
    ...
    public function add_information()           
    {
		...
		try
        {
            ...
            if($_POST)
            {
				...
				$is_data_exist = $this->mod_rect->fetch_content_using_cms_type_id(decrypt($posted["opt_title"]));
    ...
    */
	...
	function ajax_get_content()
	{
		...
		$info = $this->mod_rect->fetch_content_using_cms_type_id(decrypt($type_id));
		//print_r($info); exit;
		if(!empty($info))
		{
