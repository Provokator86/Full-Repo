...
class Forgot_password extends My_Controller implements InfController
{
    ...
    public function __construct()
    {
        try
        {
          ...
          $this->cls_msg["save_succ"]="A new password had generated and send to #Email# successfully.";
            ...
            if($_POST)
            {
                ...
                else///validated, now save into DB
                {
                    ...
                    $s_where=" Where s_email='".get_formatted_string($s_email)."' ";              
                 	...
                 	$admin_loggedin=$this->obj_mod_->change_password($s_where,$org_changed_pass);
                    ...
                    if(!empty($admin_loggedin))   ////saved successfully
                    {
						...
						{
							set_success_msg(str_replace("#Email#",get_unformatted_string($s_email),$this->cls_msg["save_succ"]));
							redirect(admin_base_url().'forgot_password');
						}
