...
class Commission_waiver extends My_Controller implements InfController
{
    ...
    public function __construct()
    {
        ...
        {
          parent::__construct();
          $this->data['title']				=	"Commission Waiver Management";////Browser Title

          ////////Define Errors Here//////
          $this->cls_msg = array();
          $this->cls_msg["no_result"]		=	"No information found about commission waiver.";
          $this->cls_msg["save_err"]		=	"Information about commission waiver failed to save.";
          $this->cls_msg["save_succ"]		=	"Information about commission waiver saved successfully.";
          $this->cls_msg["delete_err"]		=	"Information about commission waiver failed to remove.";
          $this->cls_msg["delete_succ"]		=	"Information about commission waiver removed successfully.";
    ...
    */      
    public function modify_information($i_id=0)
    {
        ...
        try
        {
            $this->data['title']		=	"Edit Commission Waiver Details";////Browser Title
            $this->data['heading']		=	"Edit Commission waiver";
            $this->data['pathtoclass']	=	$this->pathtoclass;
            $this->data['mode']			=	"edit";
            ...
            if($_POST)
            {
				$posted=array();
                $posted["h_mode"]				= 	$this->data['mode'];
				$posted["txt_no_waiver"]		=	trim($this->input->post("txt_no_waiver"));
                ...
                $this->form_validation->set_rules('txt_no_waiver', 'no. of referrals', 'required');
                ...
                {
                    $info	=	array();
					$info["i_waiver_commission"]	=	$posted["txt_no_waiver"];
                    $info["i_status"]				=	$posted["i_is_active"];
                    $info["dt_entry_date"]			=	strtotime(date("Y-m-d H:i:s"));
            ...
            else
            {
                ...
                $posted=array();
				$posted["txt_no_waiver"]		=	trim($info["i_waiver_commission"]);			
            ...
            ////////////end Submitted Form///////////
            $this->render("commission_waiver/add-edit");
        }
        catch(Exception $err_obj)
        {
            show_error($err_obj->getMessage());
