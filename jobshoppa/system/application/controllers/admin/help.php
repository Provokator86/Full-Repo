    ...
    */
    public function show_list($order_name='',$order_by='asc',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $s_title=($this->input->post("h_search")?$this->input->post("txt_faq_title"):$this->session->userdata("txt_faq_title")); 
            ...
            if($s_search=="basic")
            {
                ...
                $this->session->set_userdata("txt_faq_title",$s_title);
            ...
            elseif($s_search=="advanced")
            {
                ...
                $this->data["h_search"]=$s_search;
                $this->data["txt_faq_title"]=$s_title;                
    ...
    public function add_information()           
    {
		...
		try
        {
            ...
            if($_POST)
            {
				...
				$is_data_exist = $this->mod_rect->fetch_content_by_ajax_call(decrypt($posted["opt_cat"]),$posted["txt_help_question"]);
                ...
                else///validated, now save into DB
                {
					...
					$info["i_help_cat"]		=	decrypt($posted["opt_cat"]);
                    ...
                    $info["dt_entry_date"]	=	strtotime(date("Y-m-d H:i:s"));					
					 ...
					 if(empty($is_data_exist))  //  INSERTING NEW  RECORD IF NOT EXIST AFTER CHECKING 
						{
    ...
    public function modify_information($i_id=0)
    {
        ...
        try
        {
            ...
            else
            {
				...
				$posted["opt_cat"]  			= encrypt($info["i_help_cat"]);
