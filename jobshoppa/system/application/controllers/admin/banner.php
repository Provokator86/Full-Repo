...
class Banner extends My_Controller implements InfController
{
    ...
    public function __construct()
    {
        ...
        try
        {
          ...
          $this->load->model("banner_model","mod_rect");
		  ...
		  $this->uploadWidth = $config['admin_banner_image_upload_thumb_width'];
		  $this->uploadHeight = $config['admin_banner_image_upload_thumb_height'];
        }
    ...
    */
    public function show_list($start=NULL,$limit=NULL)
    {
        try
        {
            $this->data['heading']="Banner Images";////Package Name[@package] Panel Heading
    ...
    */
    public function add_information()           
    {
        ...
        {
            $this->data['title']="Banner Management";////Browser Title
            $this->data['heading']="Add Banner Image";
            ...
            if($_POST)
            {
				...
				$this->form_validation->set_rules('txt_description', 'banner description', 'required');
                ...
                else///validated, now save into DB
                {
                    ...
                    if($i_newid)////saved successfully
                    {
						...
						{
							get_image_thumb($this->uploaddir.$info["s_image"], $this->thumbdir, 'thumb_'.$info["s_image"],$this->uploadHeight,$this->uploadWidth);
							get_image_thumb($this->uploaddir.$info["s_image"], $this->thumbdir, 'thumb_small_'.$info["s_image"],58,98);
						}
    ...
    */      
    public function modify_information($i_id=0)
    {
        ...
        try
        {
            ...
            $this->data['heading']="Edit Banner Image";
            $this->data['pathtoclass']=$this->pathtoclass;
            $this->data['mode']="edit";
				...
				else///validated, now save into DB
                {
                    ...
                    if($i_aff)////saved successfully
                    {
						if($arr_upload_res[0]==='ok')
						{
							...
							get_file_deleted($this->thumbdir,'thumb_small_'.$posted['h_image_name']);
						}
                        set_success_msg($this->cls_msg["save_succ"]);
                        redirect($this->pathtoclass."show_list");
                    }
