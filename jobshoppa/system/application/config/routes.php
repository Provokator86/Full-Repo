...
/*
$route['admin/about_professional/show_list/(:any)'] ="admin/customer_support/show_list/$1";
$route['admin/general/show_list/(:any)'] ="admin/customer_support/show_list/$1";  
$route['admin/posting_jobs/show_list/(:any)'] ="admin/customer_support/show_list/$1";      
*/
