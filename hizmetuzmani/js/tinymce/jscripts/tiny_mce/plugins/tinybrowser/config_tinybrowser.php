...
$tinybrowser['path']['image'] = '/hizmetuzmani/uploaded/content_images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/hizmetuzmani/uploaded/content_files/'; // Media files location
$tinybrowser['path']['file']  = '/hizmetuzmani/uploaded/content_files/'; // Other files location
