...
* @link model/comm_payment_model.php
* @link views/admin/manage_invoice/
*/
...
class Manage_invoice extends My_Controller implements InfController
{
    ...
    */
    public function show_list($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            $this->data['heading']="Payment history";////Package Name[@package] Panel Heading
			...
			$table_view["detail_view"] = FALSE;
             $j_col = 0;   
			$table_view["headers"][$j_col]["val"]	="Serial No"; 
			...
			$table_view["headers"][++$j_col]["val"]	="Payment Paid By";
			...
			$table_view["headers"][++$j_col]["val"]	="Pay Amount";
...
<table style="width:600px; margin:0px auto; line-height:16px; background-color:#FFFFFF; color:#000;font-size:12px;font-family:Arial, Helvetica, sans-serif;" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
            <td colspan="2" style=" color:#aaa; line-height:35px; font-size:11px; text-align:center; font-family:Georgia, Times New Roman, Times, serif; "><em><strong>Hizmetuzmani</strong></em></td>
      </tr>
</table>
</body>
</html>
