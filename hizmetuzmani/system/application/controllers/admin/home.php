...
class Home extends My_Controller implements InfController
{
    ...
    */
    ...
    function ajax_change_province_option()
    {
        ...
        echo '<select id="opt_province_id" name="opt_province_id" style="width:192px;" onchange="call_ajax_get_zipcode(\'ajax_change_zipcode_option\',this.value,'.$city_id.',\'parent_zip\');">
              <option value="">Select city</option>'.$parent_province_option.'</select>';
    }    
