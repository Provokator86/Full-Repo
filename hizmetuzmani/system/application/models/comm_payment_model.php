...
* 
* @package Invoice
* @subpackage manage_invoice
* 
* @link InfModel.php 
* @link MY_Model.php
* @link controllers/manage_invoice.php
* @link views/admin/manage_invoice/
*/


class Comm_payment_model extends MY_Model implements InfModel
{
    private $conf;
    ...
    */
	...
	public function gettotal_report_amount($s_where=null)
    {
        try
        {
          $ret_=0;
