        ...
        try
        {
          ...
          if($rs->num_rows()>0)
          {
              foreach($rs->result() as $row)
              {
				  ...
				  $ret_["s_description"]			=	nl2br(get_unformatted_string($row->s_description)); 
				  $ret_["d_budget_price"]			=	get_unformatted_string($row->d_budget_price);
				 ...
				 // $ret_["s_postal_code"]			=	stripslashes(htmlspecialchars_decode($row->postal_code)); 
				  $ret_["s_latitude"]				=	get_unformatted_string($row->s_latitude); 
        ...
        try
        {
          ...
          if($rs->num_rows()>0)
          {
              foreach($rs->result() as $row)
              {
				  ...
				  $ret_[$i_cnt]["content"]=$this->db->JOB_HISTORY_KEY[get_unformatted_string($row->s_message)];
        ...
        try
        {
          ...
          if($rs->num_rows()>0)
          {
              foreach($rs->result() as $row)
              {
                  ...
                  $ret_["s_commission_slab_100"]=get_unformatted_string($row->s_commission_slab_100);
				  $ret_["s_commission_greater_than_100"]=get_unformatted_string($row->s_commission_greater_than_100); 
        ...
        try
        {
          ...
          if($rs->num_rows()>0)
          {
              foreach($rs->result() as $row)
              {
				  ...
				  $ret_[$i_cnt]["d_budget_price"]			=	get_unformatted_string($row->d_budget_price);
