        ...
        try
        {
            ...
            if(!empty($info))
            {
                ...
                $this->db->query($s_qry,array(  
												  get_formatted_string($info['s_referred_name']),
												  get_formatted_string($info['s_referred_email']),
												  $info['s_referred_code'],
												  intval($info['i_referrer_id']),
    ...
    public function delete_info($i_id)
    {
        try
        {
            ...
            elseif(intval($i_id)==-1)////Deleting All
            {
                ...
                if($i_ret_)
                {
                    $logi["msg"]="Deleting all information from ".$this->tbl_recom." ";
