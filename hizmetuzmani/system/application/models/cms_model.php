        ...
        try
        {
          ...
          if($rs->num_rows()>0)
          {
              foreach($rs->result() as $row)
              {
				  ...
				  {
				  $ret_[$i_cnt]["s_title"]          =   stripslashes(htmlspecialchars_decode($row->{$this->site_default_lang_prefix.'_s_title'})); 
				  } 				 
				  $s_desc                           =   get_unformatted_string($row->{$this->s_lang_prefix.'_s_description'});	
				  if($s_desc=='')
				  {
				  $s_desc                           =   get_unformatted_string($row->{$this->site_default_lang_prefix.'_s_description'});	
				  }			 
        ...
        try
        {
          ...
          if($rs->num_rows()>0)
          {
              foreach($rs->result() as $row)
              {
                  ...
                  $ret_["s_description"]	=	get_unformatted_string($row->{$this->s_lang_prefix.'_s_description'});
				  $ret_["s_title"]          =   get_unformatted_string($row->{$this->s_lang_prefix.'_s_title'}); 
