                        ...
                        <div id="feedback_div" class="lightbox" style="width:700px;">
                              ...
                              <div class="feedback_div_blue">
                                    ...
                                    <div class="com_job "> <img src="images/fe/dot1.png" alt="" class="left" />
										  ...
										  {
										  ?>
                                          <div class="feedback_img"><img src="images/fe/icon02.png" alt="" style="margin-right:5px;" /><?php echo t('Positive feedback')?></div>
								<?php
								}
								else
								{
								?>		  
										  <div class="feedback_img_negative"><img style="margin-right: 5px;" alt="" src="images/fe/icon05.png"><?php echo t('Negative feedback')?></div>
								<?php } ?>		  
