...
$('input[id^="btn_testi"]').each(function(i){
   $(this).click(function(){
      //$.blockUI({ message: 'Just a moment please...' });
       $("#buyer_testimonial").submit();
   }); 
});    


///////////Submitting the form/////////
$("#buyer_testimonial").submit(function(){
    var b_valid=true;
    var s_err="";
    $("#div_err").show("slow"); 
	  ...
	  <div class="username_box">
		<div class="right_box03">
			...
			<div id="div_err">
			  ...
			  <form action="<?php echo base_url().'buyer/testimonial/' ?>" method="post" id="buyer_testimonial">
