 ...
 $(document).ready(function() {
                           ...
                           var call_ajax    =   function(job_id,user_id)
                           {
                                    ...
                                    $.ajax({
                                    type: "POST",
                                    url: base_url+'buyer/ajax_pagination_pmb',
                  ...
                  <div class="username_box">
                        <div class="right_box03">
                              ...
                              <div class="filter_option_box">
                                    ...
                                    <form name="frm_ajax" id="frm_ajax" >
