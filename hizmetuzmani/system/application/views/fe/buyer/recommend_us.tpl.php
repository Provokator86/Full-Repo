...
$(document).ready(function() {
    ...
    $("#btn_recommend").click(function(){
        ...
        if(blank_text==true)
        {
            $("#err_div").removeClass('error_massage success_massage').addClass('error_massage').text('<?php echo addslashes(t('Please provide Name and Email address')); ?>').slideDown(1000).delay(1000).slideUp(1000);
            
        }
        else if(b_valid==true)
        {
