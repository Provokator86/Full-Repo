...
<div class="body_bg">
            ...
            <div class="body_right">
                        ...
                        <h1><img src="images/fe/general.png" alt="" /> <?php echo get_title_string(t('My Testimonial'))?></h1>
                        <div class="shadow_big">
                              <div class="right_box_all_inner">
							  <form name="test_form" id="test_form" action="<?php echo base_url().'buyer/buyer_testimonial/'?>" method="post">
