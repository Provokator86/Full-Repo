...
<div class="job_categories">
	...
	<form id="frm_buyer_reg" name="frm_buyer_reg" action="<?php echo base_url().'user/registration/TVNOaFkzVT0='?>" method="post" enctype="multipart/form-data" >
		  ...
		  <h2><?php echo addslashes(t('Buyer Registration'))?> <?php if($this->session->userdata('job_post_session')!='') { ?><span style="float:right;color:#F0650A;font-size:14px;"><?php echo addslashes(t('If you already have account'))?>  - <a style="color:#F0650A; font-size:14px; font-weight:bold;" href="<?php echo base_url().'user/login/'.encrypt(1);?>"><?php echo addslashes(t('please click here to login'))?></a> </span> <?php } ?> </h2> 
