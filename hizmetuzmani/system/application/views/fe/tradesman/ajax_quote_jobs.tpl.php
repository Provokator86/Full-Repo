                              ...
                              <div class="<?=($i++%2)?'white_box':'sky_box'?>">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
												...
												<a href="javascript:void(0);" onclick="window.location.href='<?php echo base_url().'private_message/private_msg_board_land/'.encrypt($val['i_job_id'])?>'"><img src="images/fe/pmb.png" alt="<?php echo t('My Private Message Board');?>" title="<?php echo t('My Private Message Board');?>"/></a> </td>
                                          </tr>
                                    </table>
                              </div>
                              <?php 
