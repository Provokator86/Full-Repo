<script type="text/javascript">
 ...
 $(document).ready(function() {
    ...
    $('.photo_zoom06').find('.login_button').click(function(){
        ...
        if($(this).attr('name')=='yes')
        {
           $.ajax({
                        type: "POST",
                        async: false,
                        url: base_url+'job/ajax_delete_invitation',
                        data: "job_id="+job_id,
                        success: function(msg){
	...
	/* search on filter values */
		$('input[id^="btn_invite_srch"]').each(function(i){
		   $(this).click(function(){
			   $("#srch_invite").submit();
		   }); 
		});  
    ...
    var job_id ;
    var enc_buyer_id ;
    function delete_invitation(enc_job_id)
    {
        job_id  =   enc_job_id ;
        show_dialog('photo_zoom06') ;
    }
	...
	<div class="midd_part height02">
	  <div class="username_box">
        ...
        <?php include_once(APPPATH.'views/fe/common/message.tpl.php'); ?>
			  ...
			  <form name="srch_invite" id="srch_invite" action="" method="post">
	  ...
	  $("#category").msDropDown();
	   ...
	   $('#category_msdd').css("padding", "0px");
		$('#category_msdd').css("height", "38px");
				...
				<input class="small_button" id="btn_invite_srch" type="button" value="<?php echo addslashes(t('Search'))?>" />
...
<div class="buttondiv">
<input class="login_button flote02" type="button" name="yes" value="<?php echo  addslashes(t('Yes')); ?>" />
<input class="login_button flote02" type="button" name="no" value="<?php echo  addslashes(t('No')) ; ?>" />
</div>
</div>
<!--lightbox-->