...
$("#contact_form").submit(function(){
	...
	if($.trim($("#txt_password").val())=="") //// For  name 
	{
	...
	{
		$("#err_txt_confirm_password").text('<?php echo addslashes(t('Please provide your confirm password'))?>').slideDown('slow');
		b_valid  =  false;
	}
            ...
            <div class="midd_part height02">
			  ...
			  <div class="username_box">			  
				<div class="right_box03">
				  ...
				  <div class="div02">						 
						<form name="contact_form" id="contact_form" action="<?php echo base_url().'tradesman/change-password' ?>" method="post">
