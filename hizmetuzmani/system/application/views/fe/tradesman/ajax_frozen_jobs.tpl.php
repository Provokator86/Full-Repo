		  ...
		  <table width="100%" cellspacing="0" cellpadding="0" border="0">
				<tbody>
					  ...
					  <tr <?php echo $class ?>>
							...
							<h4><a href="javascript:void(0);" class="accept_link" rel="<?php echo encrypt($val['id']).','.encrypt($val['i_tradesman_id']) ?>" ><?php echo addslashes(t('Accept'))?></a> | <a href="javascript:void(0);"  class="deny_link" rel="<?php echo encrypt($val['id']).','.encrypt($val['i_tradesman_id']) ?>"><?php echo addslashes(t('Deny'))?></a></h4>
							</td>
							<td valign="middle" align="center">
							 <a href="<?php echo base_url().'job-details/'.$job_url;?>" target="_blank"><img src="images/fe/view.png" alt="" onmouseover="this.src='images/fe/view-hover.png'" onmouseout="this.src='images/fe/view.png'"  onclick="this.src='images/fe/view.png'" title="view" /></a>
							  ...
							  <a href="<?php echo base_url().'tradesman/pmb_landing/'.encrypt($val['id'])  ;?>"><img src="images/fe/mass.png" alt="" onmouseover="this.src='images/fe/mass-hover.png'" onmouseout="this.src='images/fe/mass.png'" title="Message " /></a>
							 </td>
					  </tr>                                                      
					  <?php $i++; } } 
						  else { 
