...
<?php if($tradesman_list) { 
	...
	foreach($tradesman_list as $val)
		...
		$img = showThumbImageDefault('user_profile',$val['s_image'],'man-photo.png',65,65,'photo');
 ?>
<div class="<?php echo $class ?>">
	 <div class="left_photo"><!--<img src="images/fe/man-photo.png" alt=""  class="photo"/>--><?php echo $img ?>
	 ...
	 <div class="right_content">
		   ...
		   <div class="invite">
		   <div class="div01">
		   <!--<a href="javascript:void(0);" onclick="show_dialog('photo_zoom03')">Invite</a>-->
		   <!--<a href="javascript:void(0);">Invite</a> |--><a target="_blank" href="<?php echo base_url().'tradesman-profile/'.encrypt($val['id']) ?>"> <?php echo addslashes(t('View Profile'))?></a>
		   </div>
		   ...
		   <div class="main_faq02">
			  ...
			  <div class="faq_contant">
			   ...
			   <?php 
				 ...
				 {
				echo '<div class="faq_contant"><div class="feed_back width02">'.addslashes(t('No feedback rating yet')).'</h5></div></div>';									  
				 }
				 ?> 
