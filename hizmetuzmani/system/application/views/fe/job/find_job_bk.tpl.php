      ...
      <div class="body_bg">
            ...
            <div class="body_right">
				<div id="div_err">
                  ...
                  <h1><?php echo get_title_string(t('Find Job'))?></h1>
                  ...
                  <div class="grey_box02">
                        ...
                        <div class="fld01" style="width:240px;">
                              <input type="text"  name="txt_postal_code" id="txt_postal_code" value="<?php echo $posted['src_job_postal_code']?>"  style="width:230px;" maxlength="7" />
                        </div>						
                        ...
                        <div class="fld01" style="width:240px;">
                              ...
                              <input name="btn_save" id="btn_save"  class="button" type="button" value="<?php echo t('Search')?>" />
                        </div>
                        <div class="spacer"></div>
                  </div>
				  </form>
