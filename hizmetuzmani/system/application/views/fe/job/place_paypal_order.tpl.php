		...
		<div class="IPN_style">
			<?php
				...
				//if( $this->cart->total_items() ) :
					...
					$paypal_obj->add_field('return', base_url() .'job/payment_success_contact');
					$paypal_obj->add_field('notify_url', base_url() .'job/payment_success_contact');
					$paypal_obj->add_field('cancel_return', base_url() .'job/payment_failure_contact');
