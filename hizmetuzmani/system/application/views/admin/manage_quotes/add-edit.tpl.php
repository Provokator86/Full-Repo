...
* 
* Purpose:
*  View For quotes Add & Edit
* 
* @package Jobs
* @subpackage manage_quotes
* 
...
$("#frm_add_edit").submit(function(){
    ...
    {
        s_err +='Please provide quote price.<br />';
        b_valid=false;
    }
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
	...
	<div class="info_box">From here admin can edit the quotes placed by tradesmen for jobs .</div>
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
              show_msg("error");  
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td>
          <textarea name="txt_comment" id="txt_comment" cols="46" rows="4"><?php echo $posted["txt_comment"]; ?></textarea>
          </td>
          <td>&nbsp;</td>
        </tr>
		<tr>
          <td>Quote Price  *:</td>
          <td><input id="txt_quote" name="txt_quote" value="<?php echo $posted["txt_quote"];?>" type="text" size="50" />
		  </td>
          <td>&nbsp;</td>
        </tr>
