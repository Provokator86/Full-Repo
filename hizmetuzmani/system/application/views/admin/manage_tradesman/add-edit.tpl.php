...
$("#frm_add_edit").submit(function(){
	...
	if($.trim($("#s_about").val())=="") 
		{
			s_err +='Please provide about tradesman.<br />';
			b_valid=false;
		}
	...
	else if($.trim($("#s_contact_no").val()).length!=10)	
		{
			s_err +='Please provide 10 digits contact no.<br />';
			b_valid=false;
		}*/
	...
	if($.trim($("#opt_zip").val())=="") 
		{
			s_err +='Please select a zip code.<br />';
			b_valid=false;
		}			
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
	...
	<div class="info_box">From here Admin can edit the information about tradesman and verified the ssn, mobile phone and address details.</div>
	<div class="clr"></div>
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td valign="top">About Tradesman *:</td>
          <td>
		  <textarea style="width:280px; height:100px;" id="s_about" name="s_about" ><?php echo $posted["s_about_me"];?></textarea>
		  </td>
          <td>&nbsp;</td>
        </tr>
		...
		<?php /*?><tr>
          <td>Contact No *:</td>
          <td><input id="s_contact_no" name="s_contact_no" class="numeric_valid" value="<?php echo $posted["s_contact_no"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr><?php */?>
		...
		<tr>
          ...
          <td>
			  ...
			  <select id="opt_city" name="opt_city" onchange='call_ajax_get_province("ajax_change_province_option",this.value,"parent_state");'>
		...
		<tr>
          ...
          <td>
		  <div id="parent_state">
		  <select id="opt_state" name="opt_state">
		...
		<tr>
		  ...
		  <select id="opt_zip" name="opt_zip">
		  	<option>select</option>
			<?php echo makeOptionZip(' 	province_id="'.decrypt($posted['opt_state']).'" AND city_id="'.decrypt($posted['opt_city']).'" ',$posted['opt_zip']) ?>
		  </select>
		  </div>
		  </td>
          <td>&nbsp;</td>
		...
		<tr>
          <td>Verification:</td>
          <td>		
		  <?php if($posted['i_trades']==1) { ?>  
		  <input id="i_ssn" name="i_ssn" value="1"  <?php if($posted["i_ssn"]==0) echo ''; else echo 'checked="checked"';?>  type="checkbox" /> Social Security Number 
		  <?php } ?>
		  <input id="i_address" name="i_address" value="1"  <?php if($posted["i_address"]==0) echo ''; else echo 'checked="checked"';?>  type="checkbox" /> Address Proof 
		   <input id="i_mobile" name="i_mobile" value="1"  <?php if($posted["i_mobile"]==0) echo ''; else echo 'checked="checked"';?>  type="checkbox" /> Mobile Phone
		   <?php if($posted['i_trades']==2) { ?>
		   <input id="i_tax" name="i_tax" value="1"  <?php if($posted["i_tax"]==0) echo ''; else echo 'checked="checked"';?>  type="checkbox" /> Tax number
		   <?php } ?>
		  </td>
          <td>&nbsp;</td>
        </tr>
