...
* Modified Date:
* Purpose:
*  View For province List Showing
* @package General
* @subpackage province
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view the provinces presnt in the database.Admin can also add provinces here, if he need to add a new province.</div>
	<div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="15%">Province Name :</td>

            <td width="23%">

            <input id="txt_province_title" name="txt_province_title" value="<?php echo $txt_province_title;?>" type="text" size="35" />
           ...
           <?php /*?> <input id="txt_abbreviation" name="txt_abbreviation" value="<?php echo $txt_abbreviation;?>" type="text" size="35"  /><?php */?>
