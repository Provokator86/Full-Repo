...
function check_duplicate(){
    var $this = $("#txt_province_title");
    $this.next().remove("#err_msg");  
	$(".star_err1").remove();
	$(".star_succ1").remove();
	var i_city_id   =   $("#opt_city").val();
    if($this.val()!="" && i_city_id!='')
    {
               ...
               {"h_id":$("#h_id").val(),
                ...
                function(data)
                {
                  if(data!="valid")////invalid 
                  {
                      ...
                      .insertAfter("#txt_province_title");
...
$("#frm_add_edit").submit(function(){
	...
	if($.trim($("#txt_province_title").val())=="") 
    {
        s_err +='Please provide province name.<br />';
        b_valid=false;
    }
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td>Title *:</td>
          <td><input id="txt_province_title" name="txt_province_title" value="<?php echo $posted["txt_province_title"];?>" type="text" size="50" /></td>
          <td>&nbsp;</td>
        </tr>
