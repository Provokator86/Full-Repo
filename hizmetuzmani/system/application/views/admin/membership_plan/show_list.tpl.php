...
* 
* Purpose:
*  View For Membership Plan List Showing
* 
* @package General
...
<div id="right_panel">
	...
	<div class="info_box">From here admin can view , and edit the mebership plan offers .</div>
	<div class="clr"></div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <select id="opt_type" name="opt_type">
				...
				<?php echo makeOption($arr_type,$opt_type) ?>
			</select>
