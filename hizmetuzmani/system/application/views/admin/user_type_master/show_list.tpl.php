...
$("#frm_search_1").submit(function(){
    ...
    if($.trim($("#frm_search_1 #txt_user_type").val())=="") 
    {
        s_err +='Please provide user type.<br />';
        b_valid=false;
    }   
...
$("#frm_search_2").submit(function(){
    ...
    if($.trim($("#frm_search_2 #txt_user_type").val())=="") 
    {
        s_err +='Please provide user type.<br />';
        b_valid=false;
    }
...
<div id="right_panel">
    ...
    <div id="tabbar">
      ...
      <ul><?php //javascript:void(0)?>
        ...
        <li id="test"><a href="#div1" <?php echo ($h_search=="basic"?'class="select"':'') ?> id="1"><span>Search</span></a></li>

        <?php /*?><li><a href="#div2" <?php echo ($h_search=="advanced"?'class="select"':'') ?> id="2"><span>Advanced Search</span></a></li><?php */?>
      ...
      <form id="frm_search_1" name="frm_search_1" method="post" action="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="15%" nowrap="nowrap">User Type  *:</td>

            <td width="23%">

            <input id="txt_user_type" name="txt_user_type" value="<?php echo $txt_user_type;?>" type="text" size="28" />
