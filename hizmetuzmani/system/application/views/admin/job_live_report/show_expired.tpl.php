...
* 
* Purpose:
* view For Expired auctions List Showing
* 
* @package Report
* @subpackage Expired Auctions
* 
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view all the auctions that have been expired.</div>
	<div class="clr"></div>
