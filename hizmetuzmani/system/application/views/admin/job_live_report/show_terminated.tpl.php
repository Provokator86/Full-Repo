...
* 
* Purpose:
* view For Terminated auctions List Showing
* 
* @package Report
* @subpackage Terminated Auctions
* 
...
function customRange(input) { 
    ...
    return {
		//alert('sam');
      minDate: jQuery('#txt_created_on').datepicker("getDate")
    };
...
////////datePicker/////////
////////datePicker/////////
$("#txt_to,#txt_created_on").datepicker({dateFormat: 'yy-M-dd',
                                               changeYear: true,
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view all the Auctions (Jobs) that have been awarded but Terminated by the Buyer.</div>
	<div class="clr"></div>
    ...
    <div id="tabcontent">
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td width="23%">
              <input id="txt_created_on" name="txt_created_on" value="<?php echo $txt_created_on;?>" type="text" size="28"/>
            ...
            <td width="21%">
			<input id="txt_to" name="txt_to" value="<?php echo $txt_to;?>" type="text" size="28"/>       
