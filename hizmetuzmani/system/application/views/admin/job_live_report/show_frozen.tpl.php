...
* 
* Purpose:
* view For Frozen auctions List Showing
* 
* @package Report
* @subpackage Frozen Auctions
* 
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view all the auctions that have been awarded to a particular bidder but the bidder has not accepted the job yet.</div>
	<div class="clr"></div>
