    ...
    <div id="tabcontent">
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td><input id="txt_title" name="txt_title" value="<?php echo $txt_title;?>" type="text" size="28" /></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-top:1px solid #a7a7a7;">
		...
		<tr>
			...
			<td><a href="<?php echo $search_action.'/s_title/'.(($order_name=='s_title' &&$order_by=='asc') ? 'desc' : 'asc');?>"><?php echo (($order_name=='s_title') ? '<strong>Title</strong>' : 'Title')?></a>
			<?php 					
			echo (($order_name=='s_title' && $order_by=='asc') ? '<img src="images/admin/shorting_up.png" />': (( $order_name=='s_title' && $order_by=='desc')? '<img src="images/admin/shorting_down.png" />':''))?>
			</td>
			<td>&nbsp;</td>
			<td><a href="<?php echo $search_action.'/i_created_date/'.(($order_name=='i_created_date' &&$order_by=='asc') ? 'desc' : 'asc');?>"><?php echo (($order_name=='i_created_date') ? '<strong>Date</strong>' : 'Date')?></a>
			<?php 					
			echo (($order_name=='i_created_date' && $order_by=='asc') ? '<img src="images/admin/shorting_up.png" />': (( $order_name=='i_created_date' && $order_by=='desc')? '<img src="images/admin/shorting_down.png" />':''))?>
			</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
