...
* 
* Purpose:
* view For Complete auctions List Showing
* 
* @package Report
* @subpackage Complete Auctions
* 
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view all the auctions that has been won by tradesman .</div>
	<div class="clr"></div>
