...
* 
* Purpose:
* view For In Progress auctions List Showing
* 
* @package Report
* @subpackage In Progrress Auctions
* 
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view all the Auctions (Jobs) that have been awarded but In Progress.</div>
	<div class="clr"></div>
