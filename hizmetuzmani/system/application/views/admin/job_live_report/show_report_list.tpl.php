...
* 
* Purpose:
* view For live auctions List Showing
* 
* @package Report
* @subpackage Live Auctions
* 
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view the live auctions(jobs) that are taking place. Live auctions are those auctions which are not yet awarded to any tradesman and the quote period did not expire</div>
	<div class="clr"></div>
