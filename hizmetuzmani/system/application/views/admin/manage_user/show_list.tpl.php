...
<div id="right_panel">
    ...
    <h2><?php echo $heading;?></h2>
                 ...
                 <div class="info_box">From here Admin can can view, add and delete the user .</div>     
    <div id="tab_search">
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_username" name="txt_username" value="<?php echo $txt_username;?>" type="text" size="28" />
            ...
            <input id="txt_email" name="txt_email" value="<?php echo $txt_email;?>" type="text" size="28"  readonly="yes"/>
