...
$("#frm_add_edit").submit(function(){
	...
	{
		s_err +='Please provide proper zip code.<br />';
			b_valid=false;
	}
		*/
	if($.trim($("#opt_province_id").val())=="") 
		{
			s_err +='Please select province.<br />';
			b_valid=false;
		}
...
function call_ajax_get_province(ajaxURL,item_id,cngDv)
{
	...
	jQuery(function($) {
		...
		$.ajax({
				type: "POST",
				url: base_url+'admin/home/'+ajaxURL,
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td>
                ...
                <select name="opt_city_id" id="opt_city_id" onchange='call_ajax_get_province("ajax_change_province_option",this.value,"parent_province");'>
		...
		<tr>
            ...
            <div id="parent_province">
				<select name="opt_province_id" id="opt_province_id" >
						<option value="">Select province </option>
						<?php  echo makeOptionProvince(' i_city_id ="'.decrypt($posted["opt_city_id"]).'" ', $posted["opt_province_id"])?>
				</select>
            </div>    
			</td>
			<td>&nbsp;</td>
