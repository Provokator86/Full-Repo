<form id="letter_search" method="post" action="" name="search">
     ...
     <tbody>
		...
		?>
			...
			<tr>
				...
				<input name="submit_translations" type="button" value="Submit" onclick="submit_translation('letter_search')" />
...
function submit_translation1(frmid)
{
	var frm_data	= jQuery('#'+frmid).serialize();
	
	jQuery.ajax({
			type: 'POST',
			url : '<?php echo admin_base_url()?>language_home/search_translation_submit/',
			data: frm_data,
			//dataType: 'json',
