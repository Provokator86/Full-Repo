...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view all the private message posted by all the different tradesman.</div>
	<div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
           ...
           <a title="View" href="<?php echo admin_base_url().'job_overview/index/'.encrypt($job_info["id"])?>"><?php echo $job_info['s_title'];?>
