...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view, add and delete the Category.</div>
	<div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="15%" nowrap="nowrap">Category Name :</td>

            <td width="23%">

            <input id="txt_category_name" name="txt_category_name" value="<?php echo $txt_category_name;?>" type="text" size="28" />

            </td>

            <?php /*?><td width="12%">Category Type :</td>
                               
            <td colspan="3">
               <select id="opt_type_id" name="opt_type_id" >
                  <option value="">Select</option>
                      <?php echo makeOptionCategoryList($opt_type_id); ?>   
              </select>
            </td><?php */?>
          </tr>
