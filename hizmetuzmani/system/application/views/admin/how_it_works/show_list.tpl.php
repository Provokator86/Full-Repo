...
/*$("#frm_search_1").submit(function(){
    ...
    if($.trim($("#frm_search_1 #txt_title").val())=="") 
...
/*    if($.trim($("#frm_search_2 #txt_title").val())=="") 
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view and edit the contents of how it works.</div>
	<div class="clr"></div>
