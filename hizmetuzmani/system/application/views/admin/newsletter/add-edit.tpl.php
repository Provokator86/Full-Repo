...
$("#frm_add_edit").submit(function(){
	...
	/*check if one of the checkbox is selected or not */	
	var all_chk 	= $('#i_all').is(':checked');
	var buyer_chk 	= $('#child_box1').is(':checked');
	var trade_chk 	= $('#child_box2').is(':checked');
	var gen_chk 	= $('#child_box3').is(':checked');
		
	if(all_chk==false && buyer_chk==false && trade_chk==false && gen_chk==false)
		{
			s_err +='Please select users .<br />';
			b_valid=false;
		}
	/* end  of check if one of the checkbox is selected or not */	
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
	...
	<div class="info_box">From here Admin can create and save the newsletters for all, only buyers, only tradesman and general subscribers of the site.</div>
	<div class="clr"></div>
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td>
          <textarea name="txt_content" id="txt_content" ><?php echo $posted["txt_content"]; ?></textarea></td>
          <td>&nbsp;</td>
        </tr>
		...
		<tr>
			...
			<td>
			All :
			<input id="i_all" name="chk[]" value="3" <?php if($posted["i_all"]==3) echo 'checked="checked"'; else echo '';?>  type="checkbox" />
			&nbsp;&nbsp;Only Buyers :
			<input name="i_buyers" id="child_box1" value="1" <?php if($posted["i_buyers"]==1) echo 'checked="checked"'; else echo '';?> type="checkbox" class="child_box" onclick="check()"/>
			&nbsp;&nbsp;Only Tradesman :
			<input name="i_tradesman" id="child_box2" value="2" <?php if($posted["i_tradesman"]==2) echo 'checked="checked"'; else echo '';?> type="checkbox" class="child_box" onclick="check()"/>
			
			&nbsp;&nbsp;General Subscribers :
			<input name="i_general" id="child_box3" value="4" <?php if($posted["i_general"]==4) echo 'checked="checked"'; else echo '';?>  type="checkbox"  class="child_box" onclick="check()"/>
			</td>
			<td>&nbsp;</td>
