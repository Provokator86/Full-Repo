...
<div id="right_panel">		
		<h2><?php echo $info["s_title"];?>	
		<span style="float:right;">
		<a href="javascript:void(0);" class="go_back" style="color:#3B5998;"> &laquo;Go back</a></span>
		</h2>
    	<p>&nbsp;</p>
	  ...
	  <div id="tabcontent1">
		  <div id="div1">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			   ...
			   <td bgcolor="#f1f1f1">Date of Expiry: </td>
		  ...
		  <div class="details_box" style="border:0 !important;">
			...
			<?php 
					...
					{ ?>
				<h5>Highest Quote: <?php echo $d_high_quote?></h5>
				<h5>Lowest Quote: <?php echo $d_low_quote?></h5>
				<?php } ?>
