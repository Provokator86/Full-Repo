...
<div id="right_panel">
	...
	<div class="info_box">From here admin can view all the jobs that has been completed by the tradesman.</div>
	<div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" >
          ...
          <tr>
            ...
            <td>Completed <span style="padding-left:10px;">From Date</span>:</td>
