...
* 
* Purpose:
*  View For active job List Showing
* 
...
<div id="right_panel">
	...
	<div class="info_box">From here admin can view all the active jobs where bidding is going on.Admin can monitor all the personal message board messages for each job.</div>
	<div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" >
          ...
          <tr>
            ...
            <td width="12%">Approved <span style="padding-left:10px;">From Date</span>:</td>
            ...
            <input id="txt_created_frm" name="txt_created_frm" value="<?php echo $txt_created_frm;?>" type="text" size="28"  readonly="yes"/>
 			...
 			<td>To Date</td>
            <td> <input id="txt_created_to" name="txt_created_to" value="<?php echo $txt_created_to;?>" type="text" size="28"  readonly="yes"/></td>

           
			 <td width="12%">Status:</td>

            <td width="15%">
				<select name="opt_status_id" id="opt_status_id">
				<option value="">All</option>
			<?php echo makeOption($arr_status,$opt_status_id); ?>
			</select>
