...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td>Title *:</td>
          <td><input id="txt_banner_title" name="txt_banner_title" value="<?php echo $posted["txt_banner_title"];?>" type="text" size="30" /></td>
          <td>&nbsp;</td>
        </tr>      
        <tr>
          <td>Photo *:</td>
		 ...
		 <?php /*?><tr>
          <td>Pick Slogan Color *:</td>
          <td>
		  		<input style="background-color:#<?php echo $posted["txt_slogan_code"]; ?>" id="txt_slogan_code" name="txt_slogan_code" value="<?php echo $posted["txt_slogan_code"]; ?>" type="text" size="10" />
		 ...
		 <tr>
          <td>Pick banner Color *:</td>
          <td>
		  		<input id="txt_slogan_bg_code" name="txt_slogan_bg_code" value="<?php echo $posted["txt_slogan_bg_code"]; ?>" type="text" size="10"style="background-color:#<?php echo $posted["txt_slogan_bg_code"]; ?>" />
