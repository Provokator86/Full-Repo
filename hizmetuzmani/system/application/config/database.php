...
/* test purpose 30-07-2012 */
$db['default']["PARENTCATEGORY"]				=	$s_tblPre."category_parent";
$db['default']["SUBCATEGORY"]					=	$s_tblPre."category_sub";
/* test purpose 30-07-2012 */
...
$db['default']["AUTOMAIL_KEY"]= array(  'job_posted'=>'Job Posted Mail',
										...
										'tradesman_prof_info'=>'Tradesman Professional Information',
