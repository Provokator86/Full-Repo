...
else
{
    ...
    $db['default']['password'] = "";
    $db['default']['database'] = "quoteurjob";    
}
...
$db['default']["USERROLE"]   = array('1'=>'Buyer','2'=>'Tradesman','3'=>'Both','4'=>'General'); // Mrinmoy Mondal
...
$db['default']["AUTOMAIL_KEY"]= array(  'job_posted'=>'Job Posted Mail',
										...
										'tradesman_radar_jobs'	=> 'Tradesman Radar Jobs Mail', // Sam
...
$db['default']["PAYMENT_TYPE"]   = array(0=>'Cash',1=>'Credit card',2=>'Cheque'); // Sam
...
*/															 
										...
										/************CMS****************/ 										
                                         ...
                                         /* 'News_category'=>array('label'=>'News',
                                                             'top_menu'=>'CMS',
                                                             'menu_name'=>'News',
                                                           //  'menu_link'=>'news/show_list',
															 'sub_menu_name'=>'News Category',
															 'sub_menu_link'=>'news_category/show_list', ),*/
										...
										'Buyer_faq_category'=>array('label'=>'FAQ',
                                                             ...
                                                             'menu_name'=>'FAQ',
                                                             //'menu_link'=>'faq/show_list',
															 'sub_menu_name'=>'Buyers FAQ Category',
										...
										'Tradesman_faq_category'=>array('label'=>'FAQ',
                                                             ...
                                                             'menu_name'=>'FAQ',
                                                             //'menu_link'=>'faq/show_list',
															 'sub_menu_name'=>'Tradesman FAQ Category',
										 ...
										 'Faq_tradesmen'=>array('label'=>'FAQ',
														 ...
														 'menu_name'=>'FAQ',
														 //'menu_link'=>'faq/show_list',
														 'sub_menu_name'=>'Tradesman FAQ',
														 'sub_menu_link'=>'faq_tradesmen/show_list',
														  ),
														  
										 'How_it_works_buyer'=>array('label'=>'How It Works',
                                                             'top_menu'=>'CMS',
                                                             'menu_name'=>'How It Works',
                                                             //'menu_link'=>'faq/show_list',
															 'sub_menu_name'=>'Buyers How It Works',
															 'sub_menu_link'=>'how_it_works_buyer/show_list',
															  ),
															  
										 'How_it_works_tradesman'=>array('label'=>'How It Works',
                                                             'top_menu'=>'CMS',
                                                             'menu_name'=>'How It Works',
                                                             //'menu_link'=>'faq/show_list',
															 'sub_menu_name'=>'Tradesman How It Works',
										 ...
										 'Auto_mail_tradesman'=>array('label'=>'Auto Mail',
                                                             ...
                                                             'menu_name'=>'Automail',
                                                             //'menu_link'=>'faq/show_list',
															 'sub_menu_name'=>'Tradesman Automail',
...
// Iman
$db['default']["CONTROLLER_NO_ACCESS_REQUIRED"] = array("Home","Forgot_password","Language","My_account","Buyers_profile","Tradesman_profile_view","Job_overview","Quote_overview",'Job_expire','Quote_approve_day_expire',"Radar_job","Frozen_job_to_active","Frozen_job_alert");
