    ...
    */
    public function show_list($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $s_where=" WHERE n.i_status=0 AND n.i_is_deleted =0 AND cat_c.i_lang_id=".$this->i_admin_language;
    ...
    */
    public function show_active($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $s_where=" WHERE (n.i_status=1 || n.i_status=8) AND n.i_is_deleted =0 AND cat_c.i_lang_id=".$this->i_admin_language;
    ...
    */
    public function show_complete($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $s_where=" WHERE n.i_status=6 AND n.i_is_deleted =0 AND cat_c.i_lang_id=".$this->i_admin_language;
    ...
    */
    public function show_in_progress($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $s_where=" WHERE  n.i_is_deleted =0 AND cat_c.i_lang_id=".$this->i_admin_language;
            ...
            {
                $s_where = " WHERE (n.i_status=4 || n.i_status=5 || n.i_status=11 || n.i_status=8) AND n.i_is_deleted =0 AND cat_c.i_lang_id=".$this->i_admin_language;
                /////Releasing search values from session///
                $this->session->unset_userdata("s_title");
				$this->session->unset_userdata("s_cat");
				$this->session->unset_userdata("opt_buyer_id");
        ...
        try
        {
            ...
            if($_POST)
            {
                ...
                else///validated, now save into DB
                {
					...
					//print_r($info); echo '<br/>'.decrypt($type); exit;
    ...
    */
    public function show_param_list($type=NULL,$start=NULL,$limit=NULL)
    {
        try
        {
			...
			$table_view["headers"][1]["val"]	="Description";
			$table_view["headers"][2]["val"]	="Buyer";
