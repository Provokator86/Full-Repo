        ...
        try
        {
            ...
            if($_POST)
            {
                ...
                else///validated, now save into DB
                {
					...
					//$info["s_contact_us_phone"]		=	$posted["s_contact_us_phone"];
					//$info["s_contact_us_fax"]		=	$posted["s_contact_us_fax"];
					//$info["s_contact_us_address"]	=	$posted["s_contact_us_address"];
					//$info["s_service_call_email"]	=	$posted["s_service_call_email"];
					$info["i_records_per_page"]		=	$posted["i_records_per_page"];
					$info["i_default_language"]		=	decrypt($posted["i_default_language"]);
                    //$info["s_sitename"]				=	$posted["s_sitename"];
