...
class Testimonial extends My_Controller implements InfController
{
    ...
    public function __construct()
    {
        ...
        try
        {
		  ...
		  $this->uploaddir = $this->config->item('testimonial_banner_image_upload_path');	
		  	
		  //for uploading image thumbnails to this folder
		  $this->thumbdir = $this->config->item('testimonial_banner_image_thumb_upload_path');
		  
		  //for display thumbnails image 
		  $this->thumbDisplayPath = $this->config->item('testimonial_image_thumb_path');	
    ...
    public function modify_information($i_id=0)
    {
        ...
        try
        {
            ...
            else
            {
				...
				//$posted["txt_person_email"]		=	$info["s_person_email"];				
