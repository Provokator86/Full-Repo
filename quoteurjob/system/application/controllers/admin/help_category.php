...
class Help_category extends My_Controller implements InfController
{
    ...
    public function __construct()
    {
        ...
        {
          parent::__construct();
          $this->data['title']="Help Category Management";////Browser Title
		  $this->type = 'help';
    ...
    */
    public function show_list($start=NULL,$limit=NULL)
    {
        try
        {
            $this->data['heading']="Help  Category";////Package Name[@package] Panel Heading
    ...
    */
    public function add_information()           
    {
		...
		try
        {
            ...
            ////////////end Submitted Form///////////
            $this->render("help_category/add-edit");
        }
        catch(Exception $err_obj)
        {
            show_error($err_obj->getMessage());
    ...
    */
    public function show_detail($i_id=0)
    {
        try
        {
            ...
            $this->render("help_category/show_detail",TRUE);
            unset($i_id);
        }
        catch(Exception $err_obj)
        {
    ...
    */
	...
	{
		$info	= $this->mod_rect->fetch_multi_cat_temp('');
