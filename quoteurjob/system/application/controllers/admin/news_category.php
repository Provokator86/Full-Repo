...
class News_category extends My_Controller implements InfController
{
    ...
    public function __construct()
    {
        ...
        {
          parent::__construct();
          $this->data['title']="News Category Management";////Browser Title
    ...
    */
    public function show_list($start=NULL,$limit=NULL)
    {
        try
        {
            $this->data['heading']="News  Category";////Package Name[@package] Panel Heading
    ...
    */
    public function add_information()           
    {
		...
		try
        {
            ...
            ////////////end Submitted Form///////////
            $this->render("news_category/add-edit");
        }
        catch(Exception $err_obj)
        {
            show_error($err_obj->getMessage());
    ...
    */
    public function show_detail($i_id=0)
    {
        try
        {
            ...
            $this->render("news_category/show_detail",TRUE);
            unset($i_id);
        }
        catch(Exception $err_obj)
        {
