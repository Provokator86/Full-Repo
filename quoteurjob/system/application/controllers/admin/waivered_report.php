...
class Waivered_report extends My_Controller implements InfController
{
    ...
    public function __construct()
    {
        ...
        {
          parent::__construct();
          $this->data['title']="Waivered Report";////Browser Title
          ...
          $this->load->model("Waivered_model","mod_rect");
    ...
    */
    public function show_list($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            $this->data['heading']="Waivered Report";////Package Name[@package] Panel Heading
...
*/            }
			...
			$arr_sort = array(0=>'i_created_on',1=>'i_invoice_no',6=>'i_rating');   
			// echo $order_name.'---';
		...
		//	$table_view["headers"][++$j_col]["val"]	="Buyer Name";
			...
			$table_view["headers"][++$j_col]["val"]	="Waived Date"; 
			$table_view["headers"][$j_col]["width"]	="11%";
		///	$table_view["headers"][$j_col]["align"]	="right";
			$table_view["headers"][++$j_col]["val"]	="Waived Amount";
			$table_view["headers"][$j_col]["width"]	="14%";
			$table_view["headers"][$j_col]["align"]	="right";
		...
		/*	$table_view["headers"][++$j_col]["val"]	="Action"; 
			...
			//	$table_view["tablerows"][$i][$i_col++]	=$info[$i]["s_buyer_name"];
				...
				$table_view["tablerows"][$i][$i_col++]	=$info[$i]["dt_waivered_date"];
			//	$table_view["tablerows"][$i][$i_col++]	=$info[$i]["s_quote_amount"];
				$table_view["tablerows"][$i][$i_col++]	=$info[$i]["s_waiver_amt"];
           //     $table_view["tablerows"][$i][$i_col++]	=$info[$i]["s_transaction_id"];
				...
				$d_total_pay = doubleval($d_total_pay + $info[$i]["d_waiver_amt"]);
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                          ...
                                          <tr>
                                                ...
                                                <td width="80%" valign="top" style="color:#616161;"> CAD '.$paid_amount_word.' </td>
                                          </tr>
                                            <tr>
