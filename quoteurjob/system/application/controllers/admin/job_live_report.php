    ...
    */
    public function show_report_list($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $s_where=" WHERE n.i_status=1  AND n.i_is_deleted=0 AND cat_c.i_lang_id=".$this->i_admin_language;
            if($s_search=="basic")
            {
/*                $s_where=" WHERE n.s_title LIKE '%".get_formatted_string($s_news_title)."%' ";
                /////Storing search values into session///
...
*/            }
	 ...
	 public function show_frozen($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $s_where=" WHERE n.i_status=8  AND n.i_is_deleted=0 AND cat_c.i_lang_id=".$this->i_admin_language;
            if($s_search=="basic")
            {
/*                $s_where=" WHERE n.s_title LIKE '%".get_formatted_string($s_news_title)."%' ";
                /////Storing search values into session///
...
*/            }
	...
	public function show_expired($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $s_where=" WHERE n.i_status=7  AND n.i_is_deleted=0 AND cat_c.i_lang_id=".$this->i_admin_language;
            if($s_search=="basic")
            {
/*                $s_where=" WHERE n.s_title LIKE '%".get_formatted_string($s_news_title)."%' ";
                /////Storing search values into session///
...
*/            }
	...
	public function show_won_list($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        ...
        try
        {
            ...
            $s_where=" WHERE n.i_status IN(4,9,5,6,11)  AND n.i_is_deleted=0 AND cat_c.i_lang_id=".$this->i_admin_language;
            if($s_search=="basic")
            {
/*                $s_where=" WHERE n.s_title LIKE '%".get_formatted_string($s_news_title)."%' ";
                /////Storing search values into session///
...
*/            }
	...
	public function show_in_progress($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $s_where=" WHERE n.i_status IN(4,11)  AND n.i_is_deleted=0 AND cat_c.i_lang_id=".$this->i_admin_language;
            if($s_search=="basic")
            {
/*                $s_where=" WHERE n.s_title LIKE '%".get_formatted_string($s_news_title)."%' ";
                /////Storing search values into session///
...
*/            }
	...
	public function show_terminated($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $s_where=" WHERE n.i_status=9  AND n.i_is_deleted=0 AND cat_c.i_lang_id=".$this->i_admin_language;
            if($s_search=="basic")
            {
/*                $s_where=" WHERE n.s_title LIKE '%".get_formatted_string($s_news_title)."%' ";
                /////Storing search values into session///
    ...
    */
    public function show_qoute_list($order_name='',$order_by='DESC',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $s_where=" WHERE  (n.i_status=1 OR n.i_status=8) AND n.i_is_deleted=0 AND cat_c.i_lang_id=".$this->i_admin_language;
            if($s_search=="basic")
            {
/*                $s_where=" WHERE n.s_title LIKE '%".get_formatted_string($s_news_title)."%' ";
                /////Storing search values into session///
