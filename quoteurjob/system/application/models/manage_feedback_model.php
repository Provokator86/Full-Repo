    ...
    */
    public function fetch_multi($s_where=null,$i_start=null,$i_limit=null)
    {
        try
        {
			...
			$s_qry="SELECT n.*, u.s_name AS s_sender_user, r.s_name AS s_receiver_user, j.s_title AS s_job_title,
					cat_c.s_name As s_category_name
				...
				//	" LEFT JOIN ".$this->tbl_cat." AS c ON j.i_category_id = c.id "
					" LEFT JOIN {$this->db->CATEGORYCHILD} cat_c ON cat_c.i_cat_id = j.i_category_id"
	...
	public function fetch_multi_sorted_list($s_where=null,$order_name,$order_by,$i_start=null,$i_limit=null)
    {
        try
        {
			//$s_wh = " ORDER BY n.i_created_date DESC ";
          	$ret_=array();
			$s_qry="SELECT n.*, u.s_name AS s_sender_user, r.s_name AS s_receiver_user,j.s_title AS s_job_title,j.s_description AS s_job_description,cat_c.s_name AS s_category_name FROM ".$this->tbl." n ".
					" LEFT JOIN ".$this->tbl_users." AS u ON n.i_sender_user_id = u.id ".
					" LEFT JOIN ".$this->tbl_users." AS r ON n.i_receiver_user_id = r.id".
