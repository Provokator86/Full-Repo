...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view the states presnt in the database.Admin can also add states here, if he need to add a new state.</div>
	<div class="clr"></div>
