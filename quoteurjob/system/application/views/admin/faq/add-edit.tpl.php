...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
	...
	<div class="info_box">From here Admin can add or edit the FAQ for buyers .</div>
	<div class="clr"></div>
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
		  ...
		  <select id="opt_cat" name="opt_cat" onchange='ajax_call_get_content("ajax_get_content",opt_language.value,this.value,txt_faq_question.value);' >
			...
			<?php echo makeOptionCategory('s_category_type="'.buyer_faq.'" AND c.i_status=1 AND cc.i_lang_id =1',$posted["opt_cat"]); ?>
		  </select>
		  </td>
          <td>&nbsp;</td>
        </tr>
