    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td>
          <textarea name="s_comments" style="width:600px;" id="s_comments" cols="35" rows="4"><?php echo $posted["s_comments"]; ?></textarea>
          </td>
          <td>&nbsp;</td>
        </tr>
		<tr>
       ...
       <?php /*?> <tr>
		 ...
		 <tr>
          <td>Type :</td>
          <td  valign="middle">
		  <input type="radio" name="i_positive" value="0"  onclick="chk_rate(1)" <?php if($posted["i_positive"]==0) echo 'checked="checked"';?> /> Negative <input type="radio" name="i_positive" value="1"  onclick="chk_rate(0)" <?php if($posted["i_positive"]==1) echo 'checked="checked"';?>/> Positive
		  </td>
          <td>&nbsp;</td>
        </tr>
