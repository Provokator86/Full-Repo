			...
			<div id="myaccount">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" >
				  ...
				  <tr>
					...
					<tr>
					<td>&nbsp;</td>
					<td colspan="2" class="caption_txt">From here Admin can set the default language. The default language is the language in which the visitor's of the site will be able to view the site.</td></tr> 
				</table>
			</div>
			<? /*****end Modify Section*******/?>      
			</div>
