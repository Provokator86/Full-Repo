...
/*$("#frm_search_1").submit(function(){
...

    {
        ...
        s_err +='Please provide Question U Want Help.<br />';
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can manage the help question and answers .</div>
	<div class="clr"></div>
      ...
      <form id="frm_search_1" name="frm_search_1" method="post" action="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="15%" nowrap="nowrap">Help  Question *:</td>
