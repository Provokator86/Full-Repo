    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <td>Language *:</td>
          <td>
		  <select name="opt_language" id="opt_language" onchange='ajax_call_get_content("ajax_get_content",this.value,opt_cat.value,txt_help_question.value);'>
		...
		<tr>
          <td>Category *:</td>
          <td>
		  <select id="opt_cat" name="opt_cat" onchange='ajax_call_get_content("ajax_get_content",opt_language.value,this.value,txt_help_question.value);' >
		  	<option value="">Select</option>
			<?php echo makeOptionCategory('s_category_type="'.help.'" AND c.i_status=1 AND cc.i_lang_id =1',$posted["opt_cat"]); ?>
		  </select>
		  </td>
          <td>&nbsp;</td>
        </tr>
