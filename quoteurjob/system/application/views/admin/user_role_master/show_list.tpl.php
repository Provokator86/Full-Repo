...
$("#frm_search_1").submit(function(){
    ...
    if($.trim($("#frm_search_1 #txt_role_title").val())=="") 

    {
        s_err +='Please provide Role Name.<br />';
...
$("#frm_search_2").submit(function(){
    ...
    if($.trim($("#frm_search_2 #txt_role_title").val())=="") 
  ...
  /* if($.trim($("#frm_search_2 #txt_abbreviation").val())=="") 
    {
        s_err +='Please provide Abbreviation.<br />';
        b_valid=false;
    }*/
      ...
      <form id="frm_search_1" name="frm_search_1" method="post" action="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_role_title" name="txt_role_title" value="<?php echo $txt_role_title;?>" type="text" size="28" />
