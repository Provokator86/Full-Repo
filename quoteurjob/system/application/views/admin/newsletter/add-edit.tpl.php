...
<script language="javascript" type="text/javascript" src="js/tinymce/tinymce_load_new.js"></script>
<script>
function check()
 {
...
$("#frm_add_edit").submit(function(){
	...
	{
		s_err +='Please provide any date greater than yestyerday .<br />';
		b_valid=false;
	}
