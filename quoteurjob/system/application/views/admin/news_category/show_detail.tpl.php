...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $info["id"];?>"> 
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
          <th align="left"><strong>Category Name for English:</strong></th>
          <th align="left"><?php echo $info[1]["s_category_name"];?></th>
          <th align="left"></th>
          <th align="left"></th>
        </tr>
        ...
        <tr>
		  ...
		  <td valign="top"><strong>Category Name for French:</strong></td>
          <td><?php echo $info[0]["s_category_name"];?></td>
		    <td valign="top"></td>
          <td></td>
        </tr>   
		<tr>
