    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td>Page Name *:</td>
          <td>
		  <select id="opt_title" name="opt_title" onchange='call_ajax_to_get_content("ajax_get_content",this.value,opt_language.value);'>
		 ...
		 <tr>
          <td>Language *:</td>
          <td>
		  <select name="opt_language" id="opt_language" onchange='call_ajax_to_get_content("ajax_get_content",opt_title.value,this.value);'>
