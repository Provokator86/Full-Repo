...
$("#frm_add_edit").submit(function(){
	...
	/*if((text = tinyMCE.get('txt_description').getContent())=='') 
		{
	...
	/*if($.trim($("#txt_revisit_after").val())=="") 
		{
			s_err +='Please provide revisit after.<br />';
			b_valid=false;
		}
	if($.trim($("#txt_robots").val())=="") 
		{
			s_err +='Please provide robots.<br />';
			b_valid=false;
		}
	
	if($.trim($("#txt_classifications").val())=="") 
		{
			s_err +='Please provide classifications.<br />';
			b_valid=false;
		}
	if($.trim($("#txt_expires").val())=="") 
		{
			s_err +='Please provide expires.<br />';
			b_valid=false;
		}
	if($.trim($("#txt_google_site").val())=="") 
		{
			s_err +='Please provide google site verification .<br />';
			b_valid=false;
		}	*/					
