                  ...
                  <div class="shadow_big">
                        ...
                        <div class="right_box_all_inner">
                              <form id="form_buyer_reg" action="<?php echo base_url().'user/registration/TWlOaFkzVT0'?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="fld01" style="width:300px;">
                                          <div id="parent_city">
                                                <?php /*?> <select name="opt_city" id="opt_city" style="width:192px;" onchange='call_ajax_get_zipcode("ajax_change_zipcode_option",this.value,opt_state.value,"parent_zip");'>
								...
								?>
                                    ...
                                    <div class="fld01" style="width:380px;">
                                          ...
                                          <option>10</option>
                                          <option>15</option>-->
                                                <?php echo makeOptionRadiusOption('', $posted['radius'])?>
                                          </select>
                                          <!--<script type="text/javascript">
											$(document).ready(function(arg) {
												$("#radius1").msDropDown();
