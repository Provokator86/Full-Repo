<div class="body_bg">
            ...
            <div class="body_right">
				  ...
				  <div class="grey_box02" >
                        ...
                        &nbsp;
                        <input  class="button" type="submit" value="<?php echo t('Show All')?>" />
                  </div>
				  </form>
                  ...
                  <div class="shadow_big" >
                        <div class="right_box_all_inner" style="padding:0px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                                <td valign="top" width="428"><h5><a href="<?php echo base_url().'job/job_details/'.encrypt($val['job_id']) ?>" class="blue_link"><?php echo $val['s_job_title'] ?></a></h5>
                                                      <p> <a href="<?php echo base_url().'private_message/tradesman_private_message_details/'.encrypt($val['id']) ?>" class="grey_link"><?php echo $val['s_message'] ?></a></p>
                                                      </td>
                                                <td valign="top" width="87" align="center"><?php echo empty($val['dt_reply_on'])?'':$val['dt_reply_on']?></td>
                                                <td valign="top"  width="97" align="center"><a href="<?php echo base_url().'private_message/tradesman_private_message_details/'.encrypt($val['id']) ?>"><img src="images/fe/view.png" alt="<?php echo t('View'); ?>" title="<?php echo t('View'); ?>"/></a> &nbsp; 
							  ...
							  <?php }
										...
										echo '<div class="white_box " style="padding:0px;">'.t('No Private message has been posted yet for this job').'</div>';
									} ?>
