                              ...
                              <div class="top_bg_banner">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                                ...
                                                <td width="79" align="center"><?php echo t('Quotes')?></td>
                                                <td width="104" align="center"><?php echo t('Option')?></td>
                                          </tr>
                                    </table>
                              </div>
							  <?php
                              ...
                              <div class="<?php echo ($i++%2) ? 'white_box':'sky_box'?>">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                                ...
                                                <td width="78" align="center" valign="top"><strong><?php echo $val['i_quotes']?></strong></td>  
                                                <td width="105" align="center" valign="top"><input name="" type="button" class="pink_button01" value="<?php echo t('View')?>"  onclick="window.location.href='<?php echo base_url().'job/job_details/'.encrypt($val['id'])?>'"/></td>
                                          </tr>
                                    </table>
                              </div>
                         	<?php 
