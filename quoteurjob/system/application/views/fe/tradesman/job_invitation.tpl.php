...
<div class="body_bg">
            ...
            <div class="body_right">
                  <h1><img src="images/fe/job_secure.png" alt="" /><?php echo get_title_string(t('Job Invitations'))?><span> (<?=$i_job_invitation?>)</span></h1>
					<h4><?php echo t('Here you will find all the Job Invitations by the Buyers')?></h4>
                  	<div id="job_list">		
