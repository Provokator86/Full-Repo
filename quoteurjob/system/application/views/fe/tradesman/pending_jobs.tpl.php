...
<div class="body_bg">
            ...
            <div class="body_right">
                  <h1><img src="images/fe/job_secure.png" alt="" /> <?php echo get_title_string(t('Pending Jobs'))?> <span>(<?=$i_pending_jobs?>)</span></h1>
                  <h4><?php echo t('This section consists of the jobs that has been declared as incomplete by the Buyer')?></h4>
                  	<div id="job_list">		
