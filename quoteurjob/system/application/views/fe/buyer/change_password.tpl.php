...
<div class="body_bg">
            ...
            <div class="body_right">
                        ...
                        <h1><img src="images/fe/account.png" alt="" /> <?php echo get_title_string(t('Change Password'))?> </h1>
                        <div class="shadow_big">
                              <div class="right_box_all_inner">
							  
							  <form name="contact_form" id="contact_form" action="<?php echo base_url().'buyer/change_password/'?>" method="post">
