...
$("#reply_frm").submit(function(){
    ...
    //$("#div_err").hide("slow"); 
	 ...
	 if($.trim($("#txt_comment").val())=="") 
		{
		   s_err +='<div class="error"><span class="left"><strong>Please provide comment.</strong></span></div>';
			b_valid=false;
		}	
    /////////validating//////
     if(!b_valid)
...
<div class="body_bg">
            ...
            <div class="body_right">
                  <h1><img src="images/msg_board.png" alt="" /> <?php echo t('My')?> <span><?php echo t('Private Message Board')?></span></h1>
                  <div class="shadow_big" >
						...
						<form name="reply_frm" id="reply_frm" action="<?php echo base_url().'private_message/private_message_details/'.encrypt($msg_id);?>" method="post">
                              <div class="rply_div">
                                    ...
                                    <br />
                                    <input name="submit" id="btn_submit" type="submit" class="button" value="Submit" />
                              </div>
						</form>	  
                              ...
                              <div class="email_content">
                                    ...
                                    <div class="email_detail"><?php echo $date ?> (6 days ago)</div>
                                    <div class="spacer"></div>
                                    <div class="email_area"> <?php echo $val['s_receiver_name'] ?>,
                                          <p><?php echo $val['s_content'] ?></p>
                                          Thanks<br />
                                          <?php echo $val['s_sender_name'] ?> </div>
										  
                              </div>  
							  <?php }
									 } else {
										echo '<div class="email_content " style="padding:0px;">No record found</div>';
									} ?>                           
