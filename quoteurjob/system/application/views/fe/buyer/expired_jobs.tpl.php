...
<div id="div_container">
      <div class="body_bg">
            ...
            <div class="body_right">
                        <h1><img src="images/fe/job.png" alt="" /> <?php echo get_title_string(t('Expired Jobs'))?> <span>(<?=$i_expired_jobs?>)</span></h1>
                 <h4 style="font-size:14px;"> <?php echo t('This section consists of all expired jobs you have posted')?></h4>
