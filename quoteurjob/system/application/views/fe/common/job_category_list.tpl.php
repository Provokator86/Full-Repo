	  ...
	  <div class="shadow_small">
			<div class="left_box" style="padding-bottom:0px;">
				<div style="overflow:auto;" class="scrollDiv">
				  ...
				  <div class="button_bg">
						<input  class="button_big" style="font-size:12px;" type="button" value="<?php echo t('All Category Jobs')?>"  onclick="window.location.href='<?php echo base_url().'job/find_job'?>'"/>
				  </div>
			</div>
	  </div>
