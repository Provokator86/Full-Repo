...
$tinybrowser['path']['image'] = '/quoteurjob/uploaded/content_images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/quoteurjob/uploaded/content_files/'; // Media files location
$tinybrowser['path']['file']  = '/quoteurjob/uploaded/content_files/'; // Other files location
