...
#navigation {margin:0 auto; padding:0; width:100%; height:35px; background:url(../../images/admin/black_0.gif) repeat-x left top;}
...
#content {margin:0 auto; padding:25px 0; width:100%; height:auto;}
	...
	#tabbar ul li a {margin:0; padding:0 10px; color:#FFFFFF; text-decoration: none; display:block; background:url(../../images/admin/black_0.gif) no-repeat center;}
	...
	#right_panel input[type="button"] {margin:0; padding:0 8px; width:auto; height:20px; background:url(../../images/admin/black_0.gif) no-repeat center; border:none; font:bold 11px Arial, Helvetica, sans-serif; color:#FFFFFF; cursor:pointer;}
	...
	#tabbar2 ul li a {margin:0; padding:0 10px; color:#FFFFFF; text-decoration: none; display:block; background:url(../../images/admin/black_0.gif) no-repeat center;}
