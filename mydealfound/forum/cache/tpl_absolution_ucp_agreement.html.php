<?php if (!defined('IN_PHPBB')) exit; $this->_tpldata['DEFINE']['.']['CURRENT_PAGE'] = 'register'; $this->_tpl_include('overall_header.html'); if ($this->_rootref['S_SHOW_COPPA'] || $this->_rootref['S_REGISTRATION']) {  if ($this->_rootref['S_LANG_OPTIONS']) {  ?>
