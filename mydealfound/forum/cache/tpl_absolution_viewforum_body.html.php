...
<?php } if ($this->_rootref['S_FORUM_RULES']) {  ?>
	...
	<div class="rules">
		...
		<?php } else { ?><h3><?php echo ((isset($this->_rootref['L_FORUM_RULES'])) ? $this->_rootref['L_FORUM_RULES'] : ((isset($user->lang['FORUM_RULES'])) ? $user->lang['FORUM_RULES'] : '{ FORUM_RULES }')); ?></h3>
...
<?php if ($this->_rootref['S_NO_READ_ACCESS']) {  ?>
	...
	<?php } ?>
		...
		<tr>
			<td class="forumicon"><?php echo $_topicrow_val['TOPIC_FOLDER_IMG']; ?></td>
			<td class="forumdetails">
				<?php if ($_topicrow_val['TOPIC_ICON_IMG']) {  ?><span class="forumimage"><img src="<?php echo (isset($this->_rootref['T_ICONS_PATH'])) ? $this->_rootref['T_ICONS_PATH'] : ''; echo $_topicrow_val['TOPIC_ICON_IMG']; ?>" alt="<?php echo ((isset($this->_rootref['L_TOPIC_ICON'])) ? $this->_rootref['L_TOPIC_ICON'] : ((isset($user->lang['TOPIC_ICON'])) ? $user->lang['TOPIC_ICON'] : '{ TOPIC_ICON }')); ?> <?php echo ((isset($this->_rootref['L_IMAGE'])) ? $this->_rootref['L_IMAGE'] : ((isset($user->lang['IMAGE'])) ? $user->lang['IMAGE'] : '{ IMAGE }')); ?>" /></span><?php } if ($_topicrow_val['S_UNREAD_TOPIC']) {  ?><a href="<?php echo $_topicrow_val['U_NEWEST_POST']; ?>"><?php echo (isset($this->_rootref['NEWEST_POST_IMG'])) ? $this->_rootref['NEWEST_POST_IMG'] : ''; ?></a> <?php } ?><a href="<?php echo $_topicrow_val['U_VIEW_TOPIC']; ?>" class="topictitle"><?php echo $_topicrow_val['TOPIC_TITLE']; ?></a>
				...
				<?php if ($_topicrow_val['PAGINATION']) {  ?><strong class="pagination"><span><?php echo $_topicrow_val['PAGINATION']; ?></span></strong><?php } if ($_topicrow_val['ATTACH_ICON_IMG']) {  echo $_topicrow_val['ATTACH_ICON_IMG']; ?> <?php } ?><span class="forum-descriptions"><?php echo ((isset($this->_rootref['L_POST_BY_AUTHOR'])) ? $this->_rootref['L_POST_BY_AUTHOR'] : ((isset($user->lang['POST_BY_AUTHOR'])) ? $user->lang['POST_BY_AUTHOR'] : '{ POST_BY_AUTHOR }')); ?> <?php echo $_topicrow_val['TOPIC_AUTHOR_FULL']; ?> &raquo; <?php echo $_topicrow_val['FIRST_POST_TIME']; ?></span>        
			</td>
        	<td class="forumtopics"><div class="statbubble"><span><?php echo $_topicrow_val['REPLIES']; ?></span><br /><?php echo ((isset($this->_rootref['L_REPLIES'])) ? $this->_rootref['L_REPLIES'] : ((isset($user->lang['REPLIES'])) ? $user->lang['REPLIES'] : '{ REPLIES }')); ?></div></td>
            <td class="forumposts"><div class="statbubble"><span><?php echo $_topicrow_val['VIEWS']; ?></span><br /><?php echo ((isset($this->_rootref['L_VIEWS'])) ? $this->_rootref['L_VIEWS'] : ((isset($user->lang['VIEWS'])) ? $user->lang['VIEWS'] : '{ VIEWS }')); ?></div></td>
			<td>
				...
				<?php if (! $this->_rootref['S_IS_BOT']) {  ?><a href="<?php echo $_topicrow_val['U_LAST_POST']; ?>"><?php echo (isset($this->_rootref['LAST_POST_IMG'])) ? $this->_rootref['LAST_POST_IMG'] : ''; ?></a> <?php } ?><br /><span class="fade"><?php echo $_topicrow_val['LAST_POST_TIME']; ?></span>
			</td>
		</tr>
