...
<?php if ($this->_rootref['SEARCHED_QUERY']) {  ?> <p><?php echo ((isset($this->_rootref['L_SEARCHED_QUERY'])) ? $this->_rootref['L_SEARCHED_QUERY'] : ((isset($user->lang['SEARCHED_QUERY'])) ? $user->lang['SEARCHED_QUERY'] : '{ SEARCHED_QUERY }')); ?>: <strong><?php echo (isset($this->_rootref['SEARCHED_QUERY'])) ? $this->_rootref['SEARCHED_QUERY'] : ''; ?></strong></p><?php } if ($this->_rootref['IGNORED_WORDS']) {  ?> <p><?php echo ((isset($this->_rootref['L_IGNORED_TERMS'])) ? $this->_rootref['L_IGNORED_TERMS'] : ((isset($user->lang['IGNORED_TERMS'])) ? $user->lang['IGNORED_TERMS'] : '{ IGNORED_TERMS }')); ?>: <strong><?php echo (isset($this->_rootref['IGNORED_WORDS'])) ? $this->_rootref['IGNORED_WORDS'] : ''; ?></strong></p><?php } if ($this->_rootref['SEARCH_TOPIC']) {  ?>
