...
<?php if ($this->_rootref['S_VERSION_CHECK']) {  ?>
	...
	<?php if ($this->_rootref['S_UP_TO_DATE'] && $this->_rootref['S_UP_TO_DATE_AUTO']) {  ?>
		...
		<div class="successbox">
			<p><?php echo ((isset($this->_rootref['L_VERSION_UP_TO_DATE_ACP'])) ? $this->_rootref['L_VERSION_UP_TO_DATE_ACP'] : ((isset($user->lang['VERSION_UP_TO_DATE_ACP'])) ? $user->lang['VERSION_UP_TO_DATE_ACP'] : '{ VERSION_UP_TO_DATE_ACP }')); ?> - <a href="<?php echo (isset($this->_rootref['U_VERSIONCHECK_FORCE'])) ? $this->_rootref['U_VERSIONCHECK_FORCE'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VERSIONCHECK_FORCE_UPDATE'])) ? $this->_rootref['L_VERSIONCHECK_FORCE_UPDATE'] : ((isset($user->lang['VERSIONCHECK_FORCE_UPDATE'])) ? $user->lang['VERSIONCHECK_FORCE_UPDATE'] : '{ VERSIONCHECK_FORCE_UPDATE }')); ?></a></p>
		</div>
	<?php } else { ?>

		<div class="errorbox">
			<p><?php echo ((isset($this->_rootref['L_VERSION_NOT_UP_TO_DATE_ACP'])) ? $this->_rootref['L_VERSION_NOT_UP_TO_DATE_ACP'] : ((isset($user->lang['VERSION_NOT_UP_TO_DATE_ACP'])) ? $user->lang['VERSION_NOT_UP_TO_DATE_ACP'] : '{ VERSION_NOT_UP_TO_DATE_ACP }')); ?> - <a href="<?php echo (isset($this->_rootref['U_VERSIONCHECK_FORCE'])) ? $this->_rootref['U_VERSIONCHECK_FORCE'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VERSIONCHECK_FORCE_UPDATE'])) ? $this->_rootref['L_VERSIONCHECK_FORCE_UPDATE'] : ((isset($user->lang['VERSIONCHECK_FORCE_UPDATE'])) ? $user->lang['VERSIONCHECK_FORCE_UPDATE'] : '{ VERSIONCHECK_FORCE_UPDATE }')); ?></a></p>
		</div>
	<?php } if ($this->_rootref['NEXT_FEATURE_VERSION']) {  ?>

		<div class="errorbox">
			<p><?php echo (isset($this->_rootref['UPGRADE_INSTRUCTIONS'])) ? $this->_rootref['UPGRADE_INSTRUCTIONS'] : ''; ?></p>
		</div>
	<?php } ?>
