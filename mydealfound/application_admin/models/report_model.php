...
class Report_model extends MY_Model implements InfModel
{
    private $conf;
    ...
    */
    public function fetch_multi($s_where=null,$i_start=null,$i_limit=null)
    {
        try
        {
          	$s_qry="SELECT * FROM cd_report as r LEFT JOIN cd_coupon c ON c.i_id=r.i_coupon_id";
	...
	public function fetch_multi_sorted_list($s_where=null,$order_name,$order_by,$i_start=null,$i_limit=null)
	{
        ...
        {
          	$ret_=array();
			$s_qry="SELECT r.i_id as id,r.i_ip as i_ip,r.i_no_of_hit,r.i_coupon_id as i_coupon_id,c.* 
			FROM cd_report as r 
			LEFT JOIN cd_coupon c ON c.i_id=r.i_coupon_id ".
			($s_where!=""?$s_where:"" ).
			" ORDER BY r.{$order_name} {$order_by}".
			(is_numeric($i_start) && is_numeric($i_limit)?
    ...
    public function gettotal_info($s_where=null)
    {
        try
        {
          ...
          $s_qry="Select count(*) as i_total "
                ."From cd_report as r LEFT JOIN cd_coupon c ON c.i_id=r.i_coupon_id"
                .($s_where!=""?$s_where:"" );
