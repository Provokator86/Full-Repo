...
class brand_model extends MY_Model implements InfModel
{
    private $conf;
    ...
    public function __construct()
    {
        ...
        {
          parent::__construct();
          $this->tbl = $this->db->BRAND; 
		  $this->tbl_cpn_brand=$this->db->COUPONBRAND;	         
...
public function update_hot_coupon_status($current_coupon_id, $status = 0)
 ...
 public function fetch_this_with_url($url)
  ...
  public function check_in_cpn_brand($id)
    {
        try
        {
          $s_qry="SELECT COUNT(*) AS TOTAL 
				 FROM ".$this->tbl_cpn_brand."
				 WHERE i_brand_id='".my_receive($id)."'";
