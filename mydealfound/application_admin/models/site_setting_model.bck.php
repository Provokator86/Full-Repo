        ...
        try
        {
            ...
            if(!empty($info))
            {
                ...
                $i_ret_= $this->db->query($s_qry,array(		
												...
												//trim($info["i_num_category"]),
												//trim($info["i_discount_rate2"]),
												//trim($info["i_num_story"]),
												//trim($info["i_default_language"]),
												//trim($info["i_default_currency"]),
												intval($i_id)
                                              ));
                ...
                if($i_ret_)
                {
					...
					*/
                    ...
                    $logi["sql"]= serialize(array($s_qry,array(		
												...
												get_formatted_string($info["s_site_address"]),
												trim($info["i_records_per_page"]),
												trim($info["i_discount_rate1"]),
												trim($info["i_num_category"]),
												trim($info["i_discount_rate2"]),
												trim($info["i_num_story"]),
												//trim($info["i_default_language"]),
