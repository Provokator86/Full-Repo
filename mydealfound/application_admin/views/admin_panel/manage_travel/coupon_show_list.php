        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <select name="s_is_active">
            		...
            		<option value="0" <?php if($s_is_active=='0') echo 'selected=selected'?>>Inactive</option>
            </select>
            </td>
            <td colspan="4">
            </td>
          ...
          <tr>
            ...
            <td>Store</td>
            <td><input type="text" name="s_store" id="s_store" size="28" value="<?php echo $s_store;?>"/></td>
          </tr>
        </table>
      </form>  
      </div>
