    ...
    <div>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
		  ...
		  <?php echo get_cat_result('', '', '', '1', encrypt($posted["i_cat_id"]),0);?>
		  </select></td>
          <td>&nbsp;</td>
        </tr> 
		...
		<tr>
			...
			<td><input id="i_cashback" name="i_cashback" value="<?php echo my_showtext($posted["i_cashback"]); ?>" type="text" size="50" /><br />[Give only percentage value like 2,4, 10 etc.]</td>
			<td>&nbsp;</td>
		</tr> 
