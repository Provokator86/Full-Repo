...
<title>###SITE_NAME_UC### Admin Panel :: <?php echo $title;?></title>
...
$(document).ready(function(){
       ...
       $("ul[class='select'] a,ul[class='link'] a,ul[id='login_info'] a,ul[class=sub2] a,div[class=view_all] a,li[class=quick_links] a, span[class='view_more'] a").each(function(i){
       ...
       $("#left_panel .link li").each(function(i){
           ...
           var controllers_access=JSON.parse('<?php echo makeArrayJs(isset($controllers_access)?$controllers_access:'');?>');
...
<div id="header">
  ...
  <?php
...

    {
        ...
        $s_str.='<li><a id="mnu_0"  href="'.admin_base_url().'my_account/modify_information">My Account</a></li>';
...

        {
            ...
            //$s_str.='<li><a href="'.admin_base_url().'menu_setting/show_list"><img src="images/admin/icon_setting.png" alt="setting" title="menu setting"/></a></li>';
  ...
  <div id="logo"><img src="images/logo_deal.png" alt="###SITE_NAME_UC###" title="###SITE_NAME_UC###" /></div> 

  <div id="logo" style="float: right"><img src="images/logo_coupon.png" alt="###SITE_NAME_UC###" title="###SITE_NAME_UC###" /></div> 
...
<div id="footer">
  ...
  <p>&copy; 2013 Copyright ###SITE_NAME_LC###</p>
