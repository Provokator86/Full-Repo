...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view details.</div>
	<div class="clr"></div>
    ...
    <div id="tabbar">
      <ul><?php //javascript:void(0)?>
        ...
        <li><a href="#div2" <?php echo ($h_search=="advanced"?'class="select"':'') ?> id="2"><span>Report</span></a></li>
      </ul>   
    </div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="23%">
            <input id="s_category" name="s_category" value="<?php echo $s_category;?>" type="text" size="28" />
            </td>
            <td colspan="4">
            </td>
          </tr>
