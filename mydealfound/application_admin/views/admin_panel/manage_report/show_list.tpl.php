...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view the report.</div>
	<div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td>Store</td>
            <td><select name="s_store"><option value="">Select</option>
          ...
          <td>Category</td>
            <td><select name="s_category"><option value="">Select</option>
            <?php echo makeOptionNoEncrypt($category,$s_category);?>
            </select></td>
            
            <td>Offer type</td>
            <td><select name="s_offer"><option value="">Select</option>
            <?php echo makeOptionNoEncrypt($offer,$s_offer);?>
            </select></td>
            
          <tr>
          	<td>Brand type</td>
            <td><select name="s_brand"><option value="">Select</option>
            <?php echo makeOptionNoEncrypt($brand,$s_brand);?>
            </select></td>
            <td >Created On:</td>
