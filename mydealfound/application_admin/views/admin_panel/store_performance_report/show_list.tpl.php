...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can view the Store Performance Report.</div>
	<div class="clr"></div>
    <div id="tab_search">
    <div id="tabbar">
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="10%">
					<select name="s_merchant_name" id="s_merchant_name">
						<option value="">All</option>					
						<?php echo makeOptionReportStore($s_merchant_name) ?>
					</select>
				</td>   
			...
			<tr>
				<td width="20%">Required Output: </td>
				<td width="10%">
				<select name="i_output" id="i_output" >
					<option value="count" <?php if($i_output=="count"){ echo 'selected="selected"'; } ?>>Count</option>
					<option value="sum" <?php if($i_output=="sum"){ echo 'selected="selected"'; } ?>>Sum</option>
				</select>
				</td>   
				<td colspan="4">&nbsp;</td>
			</tr>
