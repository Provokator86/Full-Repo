...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can manage the Banner Ad.</div>
	<div class="clr"></div>
    ...
    <div id="tabcontent">
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15%">Banner Title :</td>
            <td width="23%">
            <input id="s_banner" name="s_banner" value="<?php echo $s_banner;?>" type="text" size="28" />
            </td>
            <td colspan="4">
            </td>
          </tr>
