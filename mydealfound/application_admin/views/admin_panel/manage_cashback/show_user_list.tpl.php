...
function view_user_detail(userId)
{
	var pop_w="width=700";
    var pop_h="height=400";
	$.prettyPhoto.open(g_controller+'user_detail/'+userId+'/iframe'
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can manage user.</div>
    ...
    <div id="tabcontent">
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="25%">User Name/Email/UID: </td>
            <td width="10%">
