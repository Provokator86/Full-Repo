...
<input type="hidden" id="IMAGE_ALREADY_UPLOADED" name="IMAGE_ALREADY_UPLOADED" value="<?php echo $IMAGE_ALREADY_UPLOADED;?>"  />
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
						<td>Banner Url * :</td>
						<td><!--<input id="s_url" name="s_url" value="<?php //echo my_showtext($posted["s_url"]); ?>"  type="text" size="50" autocomplete="off" />-->
                        <textarea id="s_url" name="s_url" rows="4" cols="50"><?php echo my_showtext($posted["s_url"]); ?></textarea>
                        </td>
						<td>&nbsp;</td>
				</tr>
