...
<?php /*?><script type="text/javascript" src="js/jquery/colorpicker/js/colorpicker.js"></script>
...
<link rel="stylesheet" href="js/jquery/colorpicker/css/colorpicker.css" type="text/css" /><?php */?>
<script>
...
jQuery(function($) {
	...
	//////////////////// AJAX CALL TO GET CONTENT/////////////////////////
		...
		$("#opt_language").change(function(){	
			...
			call_ajax_to_get_content("ajax_get_content",type_id);	
		})  ; 
...
{
	var lang_id	= 'en'; /*jQuery('#opt_language').val();*/ // FOR MULTILINGUAL JUST OPEN THIS COMMENT AS OPTION VALUE	
...
<input type="hidden" id="h_id" name="h_id" value="<?php echo $posted["h_id"];?>"> 
	...
	<div class="info_box">From here Admin must select the page name to enter description of that particular page .</div>
	<div class="clr"></div>
    <p>&nbsp;</p>
        <div id="div_err">
            <?php
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  <select id="opt_title" name="opt_title" onchange='call_ajax_to_get_content("ajax_get_content",this.value);'>
            ...
            <?php  echo makeOptionContentType('', $posted["h_content_type"])?>
		  </select>                                                         
