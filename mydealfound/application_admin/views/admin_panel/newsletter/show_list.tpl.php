...
*  View For newsletter List Showing
...
/*$("#frm_search_1").submit(function(){
    ...
    if($.trim($("#frm_search_1 #txt_subject").val())=="")
    {
        s_err +='Please provide Newsletter Title.<br />';
        b_valid=false;
    }
...
<div id="right_panel">
    ...
    <div class="info_box">From here Admin can view the newsletters to be sent to the subscribers of the newsletter.</div>
      ...
      <form id="frm_search_1" name="frm_search_1" method="post" action="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="15%">Newsletter Title *:</td>
