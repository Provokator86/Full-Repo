      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		 ...
		 <tr>
			...
			<td>
			<input type="text" name="s_title" id="s_title" value="<?php echo $posted["s_title"] ?>" size="30" />
			</td>	
			<td>&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<td>
			<select name="i_store_id" id="i_store_id" style="min-width:200px;">
				<option value="">Select Store</option>
				<?php echo makeOptionStoreForAds($posted["i_store_id"]) ?>
			</select>
			</td>	
			<td>&nbsp;</td>
		</tr>
        ...
        <tr>
			...
			<td><textarea id="s_html" name="s_html" type="text" size="50" autocomplete="off" style="vertical-align:top"  class="" cols="50" rows="4" ><?php echo my_showtext($posted["s_html"]); ?></textarea></td>	
			<td>&nbsp;</td>
		</tr>
