...
<div id="right_panel">
	...
	<div class="info_box">From here Admin Manage Bank Offers.</div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="s_bank" name="s_bank" value="<?php echo $s_bank;?>" type="text" size="28" />
