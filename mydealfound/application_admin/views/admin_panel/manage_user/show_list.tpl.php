...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can manage the users.</div>
	<div class="clr"></div>
    <div id="tab_search">
    <div id="tabbar">
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15%">Name :</td>
            <td width="23%">
            <input id="s_name" name="s_name" value="<?php echo $s_name;?>" type="text" size="28" />
            </td>
            <td width="15%">Email :</td>
            <td width="23%">
            <input id="s_email" name="s_email" value="<?php echo $s_email;?>" type="text" size="28" />
            </td>
          </tr>
