...
/*********
* Author: Jagananth Samanta
* Date  : 19 July 2011
* Modified By: 
* Modified Date:
* 
* Purpose:
* View For blog category List Showing
*
* @package Content Management
* @subpackage blomng_category
* 
* @link InfController.php 
* @link My_Controller.php
* @link views/admin/blomng_category/
*/
...
/*$("#frm_search_1").submit(function(){
    ...
    if($.trim($("#frm_search_1 #txt_name").val())=="")
    {
...
$("#frm_search_2").submit(function(){
   ...
   /* if($.trim($("#frm_search_2 #txt_name").val())=="") 
...
<div id="right_panel">
    ...
    <h2>Total Subscriber :<?php echo $total_count;?></h2>
    <h2>Total Store Subscriber :<?php echo $total_subscriber_stored;?></h2>
    <?php if($total_count && $h_search && $s_store!='') { ?>
    <h2>Total Subscriber for this particular store :<?php echo $total_count;?></h2>
    <?php } ?>
    <div class="info_box">From here Admin can view the newsletter subscribers of the site.</div>
 ...
 <td width="12%">Store :</td>

            <td colspan="3">
<select name="s_store">
<option value="">Select</option>
             <?php echo makeOptionNoEncrypt($store,$s_store);?></select>
