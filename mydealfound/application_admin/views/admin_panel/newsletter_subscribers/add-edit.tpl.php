    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<!--<tr>
          <td>User Type *:</td>
          <td>
		  <select name="i_user_type" id="i_user_type">
		  <option value="1" <?php //if($posted["s_user_type"] == 1){echo "selected";}?>>User</option>
		  <option value="2" <?php //if($posted["s_user_type"] == 2){echo "selected";}?>>General</option>
		  </select>
		  </td>
          <td>&nbsp;</td>
        </tr>-->        
