...
add_info_link       = "<?php echo isset($this->add_info_link)?$this->add_info_link:'';  ?>";
edit_info_link      = "<?php echo isset($this->edit_info_link)?$this->edit_info_link:'';  ?>";
remove_info_link    = "<?php echo isset($this->remove_info_link)?$this->remove_info_link:'';  ?>";
...
$("input[id^='btn_del_']").each(function(i){
   $(this).click(function(){
       ////////Confirm///// 
       $("#dialog-confirm #dialog_msg").html('These items will be permanently removed and cannot be recovered. Are you sure?');
       $("#dialog-confirm").dialog({
            ...
            buttons: {
                'Delete': function() {
					...
					//alert($("#dd_list_"+i).find("option:selected").attr("value"));					
                    ...
                    //console.log(remove_info_link); return false;
					$("#frm_list").submit();
                },
                Cancel: function() {
                    $("#h_list").attr("value","");
						...
						$(this).dialog('close');
						 $.ajax({
								...
								success: function(msg){
								   ...
								   if($.trim(msg)=="ok") 
								   {
									   ...
									   if(i_status)
										{   
											...
											$("a[id='"+temp_id+"'] > img").attr({'src':'images/admin/active.png','title':'Inactive','alt':'Inactive'});
										...
										{    
											...
											$("a[id='"+temp_id+"'] > img").attr({'src':'images/admin/inactive.png','title':'Active','title':'Active'}); 
								   ...
								   else if(msg=='cpn_exist_error')
								   {
									 $('#div_err').addClass('error_massage').html('There is a coupon under this item.').show(500).delay(1000).hide(500);
								   }
								   else
								   {
...
$(function() {
        ...
        $('.admin_listing tr').hover(function() {
...
//pr($action_allowed,1);
    ...
    $i_action_add=isset($action_allowed["Add"])?$action_allowed["Add"]:'';
    $i_action_edit=isset($action_allowed["Edit"])?$action_allowed["Edit"]:'';
    $i_action_delete=isset($action_allowed["Delete"])?$action_allowed["Delete"]:'';
    /////end Removing Add////
...
?> 
       ...
       <?php if(isset($status_update)&&($status_update!=NULL)) { ?>
       ...
       <?php /*?> <h2><?php echo $caption;?> List</h2><?php */?>
        ...
        <?php
           ...
           if(isset($status_update)&&($status_update!=NULL)) // Access Control for status update
            {
        ...
        <div class="mid">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="admin_listing">
              <tr>
                <?php  if($i_action_delete)///Access Control for delete
					 	{
				 ?>        
              ...
              ?>
                ...
                <th  width="<?php echo isset($head["width"])?$head["width"]:'';?>" align="<?php echo (isset($head["align"])?$head["align"]:"left");?>">
              ...
              */
              ...
              {
                echo '<th width="8%" align="left" >'.(isset($action_header)?$action_header:"Action").'</th>';  
              }                    
                  ...
                  {    
                      ...
                      {    
                          switch($c)
                          {
                              ...
                              case 1:
                                  $view = (isset($detail_view)===FALSE)?FALSE:TRUE;
                                  if($view)
                                {
                              ...
                              default:
                                $s_temp.= '<td align="'.(isset($headers[$c-1]["align"])?$headers[$c-1]["align"]:"left").'" >'.$col.'</td>';
        ...
        <div class="bot">
            ...
            if(isset($status_update)) // Access Control for status update
            {
