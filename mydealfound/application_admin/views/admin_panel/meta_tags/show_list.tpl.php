...
*  View For meta tag List Showing

* @package SEO

* @subpackage meta tag
* @Controller meta_tag.php
* @model meta_tag_model.php
*/
?>
...
/*    if($.trim($("#frm_search_2 #txt_page_title").val())=="") 
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can manage the meta tags and title for SEO purpose.</div>
	<div class="clr"></div>
      ...
      <form id="frm_search_2" name="frm_search_2" method="post" action="" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <input id="txt_page_title" name="txt_page_title" value="<?php echo $txt_page_title;?>" type="text" size="28" />
