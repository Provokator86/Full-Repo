	...
	jQuery.ajax({
...

					{
...

						{
							...
							alert('Inactive coupon cannot be check as Top Coupon');
...

						{
...

							{
...

								{
									...
									alert ('The Coupon is no more a TOP COUPON');
...

								{
									...
									alert('You have make this coupon as TOP COUPON');
							...
							{	
								...
								alert ('Maximum 12 coupon can be marked as TOP COUPON');
...

{
	...
	jQuery.ajax({
            ...
            url: "<?php echo base_url().'admin_panel/manage_deal/get_coupon_popular_status/'?>",
...

{
	...
	jQuery.ajax({
		...
		url: "<?php echo base_url().'admin_panel/manage_deal/change_hot_status/'?>",
...
function change_status(deal_id,current_deal_status,status_type){
    ...
    jQuery.ajax({
		...
		url: "<?php echo base_url().'admin_panel/manage_deals/change_status/'?>",

		data: {current_deal_id:escape(deal_id),current_deal_status:current_deal_status,status_type:status_type},
...
<div id="right_panel">
	...
	<div class="info_box">From here Admin can manage the coupons,offer,store offer.</div>
    ...
    <div id="tabbar">
      ...
      <ul><?php //javascript:void(0)?>
        ...
        <li><a href="#div2" <?php echo ($h_search=="advanced"?'class="select"':'') ?> id="2">
		  ...
		  <tr>
            ...
            <td>
                ...
                <select name="deal_type" id="deal_type">
                    ...
                    <option value="i_is_popular">Popular</option>

                    <option value="i_is_featured">Featured</option>

                    <option value="i_is_daily">Daily</option>

                    <option value="i_is_hot">Top</option>
