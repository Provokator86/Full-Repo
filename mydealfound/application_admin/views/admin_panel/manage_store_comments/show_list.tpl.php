...
function change_status(store_id, status)
{
	jQuery.ajax({
		type: "POST",
		url: "<?php echo base_url().'storedesh_controlpanel/manage_store/change_hot_status/'?>",
		data: "current_store_id="+escape(store_id)+"&current_store_status="+status,
	...
	<div class="info_box">From here Admin can manage the comments of the store.</div>
	<div class="clr"></div>
        <?php /**** this section is commented for further used ////
	<div id="tab_search">
	<div id="tabbar">
	  <ul>
