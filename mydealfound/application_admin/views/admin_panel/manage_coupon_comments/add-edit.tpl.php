...
<input id="i_coupon_id" name="i_coupon_id" value="<?php echo $posted["i_coupon_id"];?>" type="hidden" size="50" />
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td>Coupon Name:</td>
          <td><?php echo $posted['coupon_name'][0]['s_title'];?></td>
          <td>&nbsp;</td>
        </tr>
                 
		<tr>
          <td>commented by:</td><?php // pr($category); ?>
