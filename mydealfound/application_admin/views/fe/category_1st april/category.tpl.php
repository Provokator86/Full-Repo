        	...
        	<div class="f_body">
                ...
                <div class="left_part">
                    ...
                    <div class="active_coupons no-top-margin">
                    	<h2><?php echo $brand_iname;?><span></span></h2>
						...
						?>
                        	...
                        	<div class="det_offer">
                            	<div class="float_left">
                                	<a href="<?php echo base_url()?><?php echo $val['store_url']?>-coupons"><img src="<?php echo base_url().'uploaded/store/thumb/thumb_'.$val['s_store_logo']?>" alt="logo" class="border1px" title="<?php  echo $val['s_store_title']?>"/></a>
                                </div>
                                <div class="offer">
                                   ...
                                   <?php /*?> <span class="image_like"><iframe src="//www.facebook.com/plugins/like.php?href=<?php echo rawurlencode(base_url().'product_land/index/'.$val["store_url"].'/'.$val['s_seo_url']);?>&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=false&amp;font&amp;colorscheme=light&amp;action=like&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:72px; height:21px;" allowTransparency="true"></iframe></span><?php */?><div class="clear"></div>
                                    ...
                                    <span class="coupon_code" id="coupon_code<?php echo $val['i_id']?>" onclick="open_coupn_details_page('<?php echo $val['i_id']?>','<?php echo base64_encode($val['store_url'])?>','<?php echo base64_encode($val['s_seo_url'])?>','<?php echo base64_encode($val['s_url'])?>');">
								<?php if($val['i_coupon_type']==1){echo "Activate Deal";}else {echo "View Code";} ?>
									</span>
                                    
                                    </div>
                                    <a class="offer_code"  id="code_paste<?php echo $val['i_id'] ?>" title="Click here to copy code"></a>
                         	...
                         	<?php }?>  
                                    <p><?php echo exclusive_strip_tags($val['s_summary'])?></p>
                                    <a href="<?php echo base_url()?><?php echo $val['store_url']?>-coupons" class="spcl_land">View more from this store</a>
                            ...
                            <div class="shared_comment">
                            	<div class="comnt">
                                    ...
                                    <span class="image_like"><iframe src="//www.facebook.com/plugins/like.php?href=<?php echo rawurlencode(base_url().'product_land/index/'.$val["store_url"].'/'.$val['s_seo_url']);?>&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=false&amp;font&amp;colorscheme=light&amp;action=like&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:72px; height:21px;" allowTransparency="true"></iframe></span>
                        ...
                        <?php 
								...
								echo "<p><b class='error_massage'>Sorry!!.Currently there is no coupon under this category</b></p>";
						?>
                       </div>
                </div>
