<script src='<?php echo base_url()?>js/star/jquery.MetaData.js' type="text/javascript" language="javascript"></script>
                ...
                <div class="left_part">
                    <div class="coupon_codes">
                    	<div class="about_comp">
                            ...
                            <p><?php echo $store[0]['s_about_us'];?>.</p>
                        ...
                        <div class="comp_logo">
                        	<a href="<?php echo base_url()?>product-detail/<?php echo $store[0]['s_url']?>"><img class="border1px" src="<?php echo base_url().'uploaded/store/main_thumb/thumb_'.$store[0]['s_store_logo']?>" alt="product_logo"></a>	
