                        ...
                        <div class="product_active_coupon">
                        	<div class="det_offer">
                            	<div class="float_left">
                                	<a href="<?php echo base_url()?><?php echo $val['s_url']?>-coupons"><img src="<?php echo $top_coupons_store_image_path.$val['s_store_logo']?>" alt="logo" class="border1px" title="<?php  echo $val['s_store_title']?>"/></a>
                                </div>
                                <div class="offer">
                                	<h3><a href="javascript:void(0)"><?php echo $val['s_title']?></a></h3>
                                     <div class="clear"></div>
                                    <div class="get_code">
                                    <?php /*?><a id="copy_<?php echo $val['i_id']?>" target="_blank" href="<?php echo make_valid_url($val['coupon_url'])?>" onclick="open_coupn_details_page('<?php echo $val['i_id']?>','<?php echo $val['s_url']?>','<?php echo $val['s_seo_url']?>','<?php echo $val['coupon_url']?>');">
									<?php if($val['i_coupon_type']==2) { echo 'Click here to view code';}else 
									{echo 'Click to activate Deal';}?>
                                    </a><?php */?>
                                    <?php /*?><input type="button" onclick="open_coupn_details_page('<?php echo $val['i_id']?>','<?php echo $val['s_url']?>','<?php echo $val['s_seo_url']?>','<?php echo $val['coupon_url']?>');"  value="<?php if($val['i_coupon_type']==2) { echo 'Click here to view code';}else 
									{echo 'Click to activate Deal';}?>" id="coupon_code_<?php echo $val['i_id']?>"/><?php */?>
                   ...
                   <?php      if($val['i_coupon_type']==1)
                            ...
                            <div class="shared_comment">
                            	<div class="comnt">
                                    ...
                                    <span class="image_like"><iframe src="//www.facebook.com/plugins/like.php?href=<?php echo rawurlencode(base_url().'product_land/index/'.$val["s_url"].'/'.$val['s_seo_url']);?>&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=false&amp;font&amp;colorscheme=light&amp;action=like&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:77px; height:21px;" allowTransparency="true"></iframe></span>
