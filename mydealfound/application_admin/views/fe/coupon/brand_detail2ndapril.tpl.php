        	...
        	<div class="f_body">
                ...
                <div class="left_part">
                    ...
                    <div class="active_coupons no-top-margin">
                    	<h2><?php echo $brand_name;?><span></span></h2>
                        <?php //pr($brand_coupons_list);
							if(!empty($brand_coupons_list))
							{
								foreach($brand_coupons_list as $key=>$val)
								{
						?>
                        	...
                        	<div class="det_offer">
                                ...
                                <div class="offer">
                                    ...
                                    <div class="get_code">
                                    <?php /*?><a id="copy" target="_blank" href="<?php echo make_valid_url($val['cpn_url'])?>" onclick="open_coupn_details_page('<?php echo $val['i_id']?>','<?php echo $val['s_url']?>','<?php echo $val['s_seo_url']?>');"><?php if($val['i_coupon_type']==2) { echo 'Click here to view code';}else 
									{echo 'Click to activate Deal';}?>
                                    </a><?php */?>
                                    
                                    <span class="coupon_code" id="coupon_code<?php echo $val['i_id']?>" onclick="open_coupn_details_page('<?php echo $val['i_id']?>','<?php echo base64_encode($val['s_url'])?>','<?php echo base64_encode($val['s_seo_url'])?>','<?php echo base64_encode($val['cpn_url'])?>');">
                        ...
                        <?php 
							...
							{
								echo "<b class='error_massage'>Sorry No Coupon For this Brand</b>";
							}
						?>
                       </div>
                </div>
