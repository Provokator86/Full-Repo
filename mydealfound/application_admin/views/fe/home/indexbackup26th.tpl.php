                    	...
                    	<div class="slider-wrapper theme-default">
                            ...
                            <?php 
								if(!empty($home_banner))
								{
									...
									{
										echo '<a href="'.make_valid_url($val['s_url']).'" target="_blank"><img style="width:592px; height:317px;" src="'.$home_banner_image_path.$val['s_image'].'" /></a>';
									}
								}
							?>
                ...
                <div class="coupons_add">
                	<div class="left_panel">
						...
						?>
							...
							<div>			
								<span class="coupon_code" id="coupon_code<?php echo $val['i_id']?>" onclick="open_coupn_details_page('<?php echo $val['i_id']?>','<?php echo $val['s_url']?>','<?php echo $val['s_seo_url']?>','<?php echo $val['coupon_url']?>');">
...
?>          
						...
						?>
                           ...
                           <!-- <a href="javascript:void(0)" <?php /*?>href="<?php echo make_valid_url($val['coupon_url'])?>"  target="_blank"<?php */?> >-->
                            <span onclick="open_coupn_details_page('<?php echo $val['i_id']?>','<?php echo $val['s_url']?>','<?php echo $val['s_seo_url']?>','<?php echo $val['coupon_url']?>');" class="coupon_code" id="coupon_code<?php echo $val['i_id']?>"><?php if($val['i_coupon_type']==1){echo "Activate Deal";}else {echo "View Code";} ?></span>
                            <!--</a>-->
                            </div>
                         <?php    if($val['i_coupon_type']==2)
                             {
...
<div class="let_fav_coup">
 ...
 function get_store_id(cat_id)
 {
	 ...
	 $("#loading").html('<img src="images/fe/loading_small.gif" style="padding-top:20px;" />');
