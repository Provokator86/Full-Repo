    ...
    public function show_list($order_name='',$order_by='asc',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            if($s_search=="advanced")
            {
                ...
                $this->data["txt_page_title"]=get_unformatted_string($s_page_title);                
			...
			$table_view["detail_view"]=false;
             ...
             $table_view["headers"][0]["val"]      ="Meta Title";
             $table_view["headers"][1]["val"]      ="Description";
			 $table_view["headers"][2]["val"]      ="Keyword";
            ...
            for($i=0; $i<$table_view["total_rows"]; $i++)
            {
				...
				$table_view["tablerows"][$i][$i_col++]	=$info[$i]["s_keywords"];
