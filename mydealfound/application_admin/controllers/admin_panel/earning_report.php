...
* 
* Purpose:
* Controller For Manage Earning Report
* 
* @package Report
* @subpackage Earning Report
* 
...
class Earning_report extends My_Controller implements InfController
{
	...
	public function __construct()
    {
      try
      {
			...
			parent::__construct();
			$this->data['title']	= "Earning Report Management"; // Browser Title
    ...
    */
	...
	public function show_list($order_name = '', $order_by = 'desc', $start = NULL, $limit = NULL)
    {
        ...
        {           
			...
			$this->data['heading']="Earning Report";////Package Name[@package] Panel Heading
           ...
           $arr_session_data    =    $this->session->userdata("arr_session");
			...
			$search_variable["s_network"] = ($this->input->post("h_search")?$this->input->post("s_network"):$arr_session_data["s_network"]);
            ...
            if($s_search=="basic")
            {
				...
				if(trim($search_variable["s_network"])!="")
				{
					$s_where.=" AND e.s_network = '".my_receive_text($search_variable["s_network"])."' ";
				}
                ...
                $arr_session["s_network"]		= $search_variable["s_network"] ;
                ...
                $this->data["s_network"]	 	= $search_variable["s_network"];            
           ...
           unset($s_search,$arr_session,$search_variable);
            ...
            $table_view["caption"]     		=	"Earning Report";
