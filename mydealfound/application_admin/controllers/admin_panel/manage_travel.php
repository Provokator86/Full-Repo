...
class Manage_travel extends My_Controller implements InfController
{
    ...
    public function __construct()
    {
        try
        {
		  ...
		  $this->pathtoclass 						= admin_base_url().$this->router->fetch_class()."/";
			...
			$this->data['offer']	= $this->travel_model->get_offer();
			$this->data['store']	= $this->travel_model->get_store();
    ...
    */
    ...
    public function add_information()   
    {
		try
        {
          	$this->data['title']				= "Travel Management";////Browser Title
            $this->data['heading']				= "Add Travel ";
			...
			if($_POST)
        	{
				...
				*/
			    ...
			    {		
					...
					$coupon_url	= getSeoUrl_for_coupon($this->db->TRAVEL,$this->input->post("s_title"));
					...
					$info	= array(										
						...
						$inserted_user_id	= $this->travel_model->add_info($info);							
            ...
            ////////////end Submitted Form///////////
            $this->render("manage_travel/add-edit");
        }
        catch(Exception $err_obj)
        {
            show_error($err_obj->getMessage());
        ...
        { 
            ...
            {	
                ...
                {	
					...
					$coupon_url	= getSeoUrl_for_coupon($this->db->TRAVEL,$posted["s_title"],$posted["h_id"]);					
                    ...
                    $i_aff=$this->travel_model->edit_info($info, decrypt($posted["h_id"]));
            ...
            switch($s_del_these)
			{
				...
				default: 		///Deleting selected,page ///
							...
							if(is_array($id) && !empty($id))///Deleting Multi Records
							{
								...
								while($tot>=0)
								{
									$i_ret_=$this->travel_model->delete_info(decrypt($id[$tot]));
							...
							{
								$i_ret_=$this->travel_model->delete_info(decrypt($id));
								//$del_cpn_brnd=$this->travel_model->del_cpn_brand(decrypt($id[$tot]));
							} 
							break;
    ...
    */
	...
	public function show_list($order_name='',$order_by='desc',$start=NULL,$limit=NULL)
	{
        ...
        {           
			...
			$this->data['heading']="Manage Travel";////Package Name[@package] Panel Heading
			...
			$info	= $this->travel_model->fetch_multi_sorted_list($s_where,$s_order_name,$order_by,intval($start),$limit);
			//print_r ($info);
			...
			$table_view["total_db_records"]	=	$this->travel_model->gettotal_info($s_where);
           ...
           // $table_view["detail_view"]		=   FALSE;         
			...
			$table_view["headers"][5]["val"]	="Deal code";
			$table_view["headers"][5]["align"]	="center";
			$table_view["headers"][6]["val"]	="Expiry date";
            ...
            {	
				$store=$this->travel_model->fetch_this_store($info[$i]["i_store_id"]);
    ...
    */
	...
	public function ajax_change_status()
    {
        try
        {
                ...
                $i_rect=$this->travel_model->change_status($info,$posted["id"]); /*don't change*/	
