    ...
    */
    public function show_list($order_name='',$order_by='asc',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            {
                $s_where.=" AND c.s_country LIKE '%".my_receive_text($s_country)."%' ";
            ...
            for($i=0; $i<$table_view["total_rows"]; $i++)
            {
                ...
                $table_view["tablerows"][$i][$i_col++]	= my_show_text($info[$i]["s_country"]);
        ...
        try
        {
            ...
            if($posted["duplicate_value"]!="")
            {
                $qry=" WHERE ".(intval($posted["id"])>0 ? " c.i_id!=".intval($posted["id"])." And " : "" )
                    ." c.s_country='".my_receive_text($posted["duplicate_value"])."'" ;
