...
class Cashback_report extends My_Controller implements InfController
{
	...
	public function __construct()
    {
      try
      {
			...
			parent::__construct();
			$this->data['title']	= "Cashback Report Management"; // Browser Title
    ...
    */
	...
	public function show_list($order_name = '', $order_by = 'desc', $start = NULL, $limit = NULL)
    {
        ...
        {           
			...
			$this->data['heading']="Cashback Report";////Package Name[@package] Panel Heading
           ...
           unset($s_search,$arr_session,$search_variable);
            ...
            $table_view["caption"]     		=	"Cashback Report";
