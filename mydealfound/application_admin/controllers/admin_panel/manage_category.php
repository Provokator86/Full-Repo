...
* @subpackage Category Management
* @link InfController.php 
* @link My_Controller.php
* @link model/category_model.php
* @link views/admin/manage_category/
*/
...
class Manage_category extends My_Controller implements InfController
{
    ...
    public function __construct()
    {
        try
        {
			...
			$this->cls_msg["save_succ"]			= "Category saved successfully.";
			$this->cls_msg["delete_err"]		= "Category failed to remove.";
			$this->cls_msg["delete_succ"]		= "Category removed successfully.";
				...
				else
				{
					...
					else
					{
					 ...
					 $info	= array(	
						...
						"i_parent_id"		=> decrypt($this->input->post("i_parent_id")),
           ...
           $this->data['category']		= $this->list_category(decrypt($i_id));		
            ...
            {	
                ...
                else///validated, now save into DB
                {
					...
					$info["i_parent_id"]		= decrypt($posted["i_parent_id"]);
    ...
    */
	...
	public function show_list($order_name='',$order_by='desc',$start=NULL,$limit=NULL)
	{
		try
        {
            ...
            $s_category	= ($this->input->post("h_search")?$this->input->post("s_category"):$this->session->userdata("s_category"));             ////////end Getting Posted or session values for search///	
            ...
            for($i=0; $i<$table_view["total_rows"]; $i++)
            {
				...
				$table_view["tablerows"][$i][$i_col++]	= get_category_breadcrumb($info[$i]["i_id"]);
