...
class Travel_model extends MY_Model
{
    ...
    */
    ...
    public function fetch_multi($s_where=null,$i_start=null,$i_limit=null)
    {
        try
        {  
			$s_qry="SELECT p.*,s.s_store_title,s.s_store_logo,s.s_store_url,of.s_offer FROM ".$this->tbl_travel." AS p " 
					."LEFT JOIN ".$this->tbl_travel_store." AS s ON s.i_id = p.i_store_id "
					."LEFT JOIN ".$this->tbl_travel_offer." AS of ON of.i_id = p.i_type "
				    .($s_where!=""?$s_where:"" )." ORDER BY p.i_id DESC ".(is_numeric($i_start) && is_numeric($i_limit)?" Limit ".intval($i_start).",".intval($i_limit):"" );
    ...
    */
	...
	public function get_travel_category($s_where=null,$i_start=null,$i_limit=null) 
	{
		$ret_=array();
		$s_qry="SELECT * FROM ".$this->tbl_cat." ".
