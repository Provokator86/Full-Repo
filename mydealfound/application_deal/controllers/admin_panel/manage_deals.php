    ...
    { //echo $i_id;
        ...
        { //echo "12"."$i_td";
            ...
            {	
				...
				//$dt_exp_date = $this->input->post("dt_exp_date").' '.$this->input->post("exp_date_hr").':'.$this->input->post("exp_date_min").':'.$this->input->post("exp_date_sec");
				$dt_exp_date = $this->input->post("dt_exp_date");
...
//                                        }
   ...
   public function upload_csv()
    ...
    public function change_status(){
        $current_deal_id = $this->input->post('current_deal_id');
        $current_deal_status = $this->input->post('current_deal_status');
        $status_type = $this->input->post('status_type');
        $data[$status_type] = $current_deal_status?0:1;
        $this->db->update('cd_coupon', $data, array('i_id' => $current_deal_id));
