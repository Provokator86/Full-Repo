    ...
    */
    public function show_list($order_name='',$order_by='asc',$start=NULL,$limit=NULL)
    {
        try
        {
            ...
            $search_variable["s_state"]	=($this->input->post("h_search")?$this->input->post("txt_state"):$arr_session_data["txt_state"]); 
            ...
            {
				if(!empty($search_variable["s_state"]))
				{
                	$s_where.=" AND n.s_state LIKE '%".my_receive_text($search_variable["s_state"])."%' ";
				}
				if(decrypt($search_variable["s_country"]))
				{
					$s_where.=" AND n.i_country_id = ".decrypt($search_variable["s_country"])." ";
				}
                ...
                $arr_session["txt_state"] 		= $search_variable["s_state"] ;
                ...
                $this->data["txt_state"]	= $search_variable["s_state"]; 
