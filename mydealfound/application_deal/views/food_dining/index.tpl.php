...
<?php /*?><script type="text/javascript" src="<?php echo base_url() ?>js/fe/lazy_loading_testing.js"></script><?php */?>
...
$(document).ready(function(){
   ...
   {    
       ...
       $.ajax({
                type: "POST",
                async: false,
                url: base_url+'food_dining/ajax_pagination_food_list/',
                data: "arr_store="+store_checkboxes+"&discount_checkboxes="+discount_checkboxes+"&str_zone="+zone_checkboxes+"&type=where",
                success: function(data){
				
							hideBusyScreen();
							
							var wrapper_div_part = '<div id="food_ajax_list">'+ data +'</div>';
							$("#div_search_food_list").html(wrapper_div_part);
							$('.product').show();
							//console.log(data);
   ...
   {    
       $.ajax({
                type: "POST",
                async: false,
                url: base_url+'food_dining/ajax_clear_srch_store_session/',
                data: "type=where",
                success: function(data){
    ...
    <div class="prodct1">
		...
		<div class="mid_panel">
			...
			<?php /*?><div class="product_box"><?php */?>
            	<div id="div_search_food_list" class="top_offer_srch">
                    <div id="food_ajax_list">
						<?php echo $food_list; ?>
                    </div>
                </div>
