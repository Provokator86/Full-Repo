...
$(document).ready(function(){
   ...
   {    
       ...
       $.ajax({
                ...
                data: "str_cat="+cat_checkboxes+"&arr_store="+store_checkboxes+"&d_discount="+d_discount+"&discount_checkboxes="+discount_checkboxes+"&str_zone="+zone_checkboxes+"&str_bank="+bank_checkboxes+"&type=where",
    ...
    <div class="prodct1">
		...
		<div class="mid_panel">
			...
			<div class="product_box">
                ...
                <?php /*?> <span id="loading_container_offers" style="padding:10px;">
