...
<div class="product">
	<div class="pro_extend">
		...
		<li><a href="<?php echo base_url().'top-offers/details/'.$val['s_seo_url']  ?>"  target="_blank" class="plus">Details</a></li>
		<li>
...
onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=400,width=600');return false"><img src="<?php echo base_url().'images/google_hover.png' ?>" alt=""/></a>
						...
						<?php /*?><div class="tw" style="margin:2px;"><a id="ref_tw" href="http://twitter.com/home?status=<?php echo urlencode($val['s_title']) ?>+<?php echo urlencode($val['s_url']) ?>"  onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=400,width=600');return false;"><img src="<?php echo base_url().'images/twshare.jpg' ?>" alt=""/></a></div>
						<div class="gp" style="margin:2px;"><a id="ref_gp" href="https://plus.google.com/share?url=<?php echo urlencode($val['s_url']) ?>"
onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=400,width=600');return false"><img src="<?php echo base_url().'images/gpshare.jpg' ?>" alt=""/></a></div>							
					</div><?php */?>
		...
		<?php /*?><a href="<?php echo $val['s_url']  ?>" target="_blank" class="product_the_offer_butt">Grab the offer</a>
		<a href="<?php echo base_url().'top-offers/details/'.$val['s_seo_url']  ?>" target="_blank" class="product_the_offer_butt">View Details</a><?php */?>
