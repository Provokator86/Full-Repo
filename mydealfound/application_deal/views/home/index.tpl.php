...
<script type="text/javascript" src="js/fe/jquery.tabslet.js"></script>
        ...
        <div class="content">
                ...
                <div class="slider1">
					...
					<div class="slide">
						...
						<a href="<?php echo base_url().'products/'.make_my_url($val["s_brand_title"]) ?>"><img src="<?php echo base_url().'uploaded/brand/'.$val['s_brand_logo'] ?>"></a></td>
						</tr>
						</table>				
					</div>
...
<div class="right_pan6">
    <div>
        <div class="prodct_heading_rght">Just added <img src="<?php echo base_url().'images/just_add.png' ?>" />
		<?php /*?><span class="just_more"><a href="<?php echo base_url().'top-offers' ?>">More</a></span><?php */?>
		</div>
			...
			<div class="right_product_box">
				...
				<a target="_blank" href="<?php echo base_url().'top-offers/details/'.$value['s_seo_url']  ?>"><?php echo $value["s_title"] ?></a><br />
				<span><a target="_blank" href="<?php echo base_url().getStoreUrls($value["i_store_id"]); ?>"><?php echo $value["i_store_id"]>0?'@'.getStoreTitles($value["i_store_id"]):""; ?></a></span>
				</div>    
				<div class="clear"></div>
				</div>
				<div class="clear"></div>
