...
onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=400,width=600');return false"><img src="<?php echo base_url().'images/gpshare.jpg' ?>" alt=""/></a></div>							
		...
		<a href="<?php echo base_url().'thankyou/index/'.$val['i_id']  ?>" target="_blank" class="product_the_offer_butt">Grab the offer</a>
...
<div class="product">
	<?php /*?><div class="pro_extend">		
		<div class="product_info">
			<div class="product_info_head"> No product found.</div>						
		</div>
	</div><?php */?>
...
<div id="page-nav-index" class="page-nav">
    <a href="<?= base_url() ?>home/ajax_pagination_search_list/page/<?= $next_record_pointer ?>">Older</a>
</div>
<div class="clear"></div>
