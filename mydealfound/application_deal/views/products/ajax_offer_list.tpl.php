...
<div class="product">
	<div class="pro_extend">
		...
		<strong><?php echo $val["i_cashback"]?$val["i_cashback"].' Cash Back':"No Cash Back" ?> <!--4.0% Cash Back--></strong>
		</div>
...
<div id="page-nav-index" class="page-nav">
    <a href="<?= base_url() ?>products/ajax_pagination_product_list/page/<?= $next_record_pointer ?>">Older</a>
</div>
<div class="clear"></div>
