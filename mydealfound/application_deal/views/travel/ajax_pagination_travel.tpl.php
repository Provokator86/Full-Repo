	...
	<div class="pro_extend">
		<div class="in_pro">			
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				...
				<a target="blank" href="<?php echo base_url().'travel/details/'.$val['s_seo_url']  ?>"><img src="<?php echo base_url(); ?>uploaded/deal/<?php echo $val['s_image_url']?$val['s_image_url']:"no-image.png";?> " alt="Image" /></a>
		...
		<li><a href="<?php echo base_url().'travel/details/'.$val['s_seo_url']  ?>" target="blank" class="plus">Details</a></li>
		<li>
...
<div id="page-nav-index" class="page-nav">
    <a href="<?= base_url() ?>travel/ajax_pagination_travel/page/<?= $next_record_pointer ?>">Older</a>
</div>
<div class="clear"></div>
<?php
	endif;
