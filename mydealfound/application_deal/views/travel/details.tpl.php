            ...
            <div class="p_deatils_box">
                ...
                <div class="de_in">
						...
						<div class="p_de_left prod_details">
								...
								<a target="_blank" href="<?php echo base_url().'thankyou/shoptravel/'.$details["i_id"] ?>"><img src="<?= base_url() ?>images/grab.png" onmouseover="this.src='<?= base_url() ?>images/grabhover.png';" onmouseout="this.src='<?= base_url() ?>images/grab.png';" /></a>						
