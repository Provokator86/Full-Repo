...

{
	...
	?>
    		...
    		<div class="store_list_al"><span class="store_alp"><a href="#"><?php echo $val['alpha'];?></a></span>
            ...
            <li><a href="<?php echo base_url()?><?php echo $val['s_url']?>"><?php echo $val['s_store_title']; ?></a></li>
