...
<body>
	...
	<div class="wrapper">
        ...
        <ul>
          ...
          <li class="parent_cat">
            <div class="categories_button"> <a href="javascript:void(0)" class="" id="categories">Categories</a>
                <div class="category_dropbox" id="categorylist" style="display: none;">
                  <ul>                  	
                      ...
                      <li  id="activecategory_dropbox<?=($k+1)?>"  onmouseover="$('#submerchant<?=($k+1)?>').show();"    onmouseout="$('#submerchant<?=($k+1)?>').hide();">
                        ...
                        <div class="dropchild  dropwidth" id="submerchant<?=($k+1)?>" style="display: none;"  onmouseover="$('#submerchant<?=($k+1)?>').show();">
                            <ul>
                                <? foreach ($categoryMeta['store'] as $store_count=> $store_data):?>
                                    <? if(($store_count+1)%12==0):?>
                            </ul>
                            <ul>
                                 	<? endif;?>      
                                <li><a href="<?=  base_url().$store_data['s_url']?>" ><?=$store_data['s_store_title']?></a> </li>
                               
                                	<? endforeach;?>
                                <li><a href="<?php echo base_url()?>store" class="all_cat">See all stores</a></li>
                           </ul> 
                           
                            <div style="position:absolute; bottom: 0; right: 0; height:300px;"><img src="<?=base_url()?>uploaded/category/right_image/right_image_<?=$categoryMeta['s_image']?>" style="width:350px;" alt="" /></div>
