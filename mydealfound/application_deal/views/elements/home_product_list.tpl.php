	...
	<tr>
		<td height="100%" width="100%" align="center" valign="middle"><img src="<?= $dealMeta['s_image_url'] ?>" alt="<?= $dealMeta['s_image_url'] ?>" /><?php /*?><img src="<?= base_url() ?>uploaded/deal/<?= $dealMeta['s_image_url'] ?>" alt="<?= $dealMeta['s_image_url'] ?>" />  <?php */?> </td>
						...
						<div class="product_info">
							<div class="product_info_head"><?php echo strlen($dealMeta['s_title'])>40?string_part($dealMeta['s_title'],40):$dealMeta['s_title']; ?></div>
							...
							<img src="<?= base_url() ?>images/cashback.png" class="" /><strong>
							<?php echo $dealMeta["i_cashback"]?$dealMeta["i_cashback"].' Cash Back':"No Cash Back" ?> <!--4.0% Cash Back--></strong>
							</div>
						...
						<div class="product_icon_wrapper">
							<ul>
								...
								<li><a href="javascript:void(0);" onclick="$('#shim_<?php echo $dealMeta['i_id'];?>').toggle();" class="share">Share</a>
									...
									<?php /*?><div class="shim" id="shim_<?php echo $dealMeta['i_id'];?>" style=" display:none;position:absolute; background-color:#f8f8f8; width:175px; height:auto; left:2px; top:-130px;">
			...
			onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=400,width=600');return false"><img src="<?php echo base_url().'images/gpshare.jpg' ?>" alt=""/></a></div>							
									...
									<div class="shim" id="shim_<?php echo $dealMeta['i_id'];?>" style=" display:none;position:absolute; background-color:#f8f8f8; width:175px; height:auto; left:2px; top:-45px;">
										<div class="share-opts">
											<div class="hd" style="margin:2px; color:#F07317; font-size:12px;">Share<span class="close" style="font-size:12px;"><a href="javascript:void(0);" onclick="$('#shim_<?php echo $dealMeta['i_id'];?>').hide();">X</a></span></div>
											<div class="fb">
											<a id="ref_fb" target="_blank"  href="http://www.facebook.com/sharer.php?u=<?php echo urlencode($dealMeta['s_url']) ?>&t=<?php echo urlencode($dealMeta['s_title']) ?>" onclick="javascript:window.open(this.href, 'sharer', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=400,width=600'); return false;">
			<img src="<?php echo base_url().'images/facebook_hover.png' ?>" alt=""/></a>
			
											<a id="ref_tw" href="http://twitter.com/home?status=<?php echo urlencode($dealMeta['s_title']) ?>+<?php echo urlencode($dealMeta['s_url']) ?>"  onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=400,width=600');return false;"><img src="<?php echo base_url().'images/twitter_whte_hover.png' ?>" alt=""/></a>
											
											<a id="ref_gp" href="https://plus.google.com/share?url=<?php echo urlencode($dealMeta['s_url']) ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=400,width=600');return false"><img src="<?php echo base_url().'images/google_hover.png' ?>" alt=""/></a>
											
											<a id="ref_pin" href="https://pinterest.com/pin/create/button/?url=<?php echo urlencode($dealMeta['s_url']) ?>&media=<?php echo urlencode($dealMeta['s_image_url']) ?>&description=<?php echo urlencode($dealMeta['s_title']) ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=400,width=600');return false"><img src="<?php echo base_url().'images/p_hover.png' ?>" alt=""/></a>
											
											</div>
											<?php /*?>
											<div class="tw"><a id="ref_tw" href="http://twitter.com/home?status=<?php echo urlencode($dealMeta['s_title']) ?>+<?php echo urlencode($dealMeta['s_url']) ?>"  onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=400,width=600');return false;"><img src="<?php echo base_url().'images/twitter.png' ?>" alt=""/></a></div>
											
											<div class="gp"><a id="ref_gp" href="https://plus.google.com/share?url=<?php echo urlencode($dealMeta['s_url']) ?>"
			onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=400,width=600');return false"><img src="<?php echo base_url().'images/google.png' ?>" alt=""/></a></div>	
				<?php */?>
...
<a href="<?php echo base_url().'thankyou/index/'.$dealMeta['i_id']  ?>" target="_blank" class="product_the_offer_butt"><img src="<?php echo base_url().'images/cart.png'?>" />SHOP NOW</a>
					...
					<?php /*?><? if (intval($dealMeta['i_cashback'])): ?>
