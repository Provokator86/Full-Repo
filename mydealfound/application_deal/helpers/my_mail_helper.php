...
function sendMail($to, $subject, $message , $formmalid = 'info@mydealfound.com', $formname = 'Mydealfound',$attachment='', $cc='', $bcc='')
{
	global $CI;
	$formmalid 			= 'info@mydealfound.com';
	$formname 			= 'Mydealfound';
	...
	//$config['smtp_user'] =  'info@mydealfound.com';
