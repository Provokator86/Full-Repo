	...
	$.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				closeBtn : '<a title="Close" id="fancy_close" class="fancybox-item fancybox-close" href="javascript:void(0);"></a>',
				next     : '<a title="Next" class="fancybox-nav fancybox-next" href="javascript:void(0);"><span></span></a>',
				prev     : '<a title="Previous" class="fancybox-nav fancybox-prev" href="javascript:void(0);"><span></span></a>'
			},
