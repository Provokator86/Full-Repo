...
// Simple modal dialog. Requires $. Treats IE 6 as special, and uses an iframe layer for it to inhibit
...
function ModalDialog (boxSpec) {
	...
	if ($.browser.msie && ($.browser.version < 7)) {
		sizeSpec = "width:" + (vp.x + vp.w) + "px;height:" +  Math.max(vp.y + vp.h,$(document.body).height()) + "px;";
    ...
    var overlayElt = $("#" + OVERLAY_ELEMENT_ID);
    if ($.browser.msie && ($.browser.version < 7)) {
