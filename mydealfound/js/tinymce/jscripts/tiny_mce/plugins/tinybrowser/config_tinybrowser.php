...
$tinybrowser['path']['image'] = '/deal_aggregator/uploaded/content_images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails

$tinybrowser['path']['media'] = '/deal_aggregator/uploaded/content_files/'; // Media files location

$tinybrowser['path']['file']  = '/deal_aggregator/uploaded/content_files/'; // Other files location
